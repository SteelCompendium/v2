...
<template class="sc-src" data-fmt="md" data-src="When you gain essence at the start of each of your [turns](../../../rule/combat/turn.md) during combat, you gain 4 essence instead of 3."></template>
