...
<div class="sc-ability__section-body"><p>Choose one of the following effects:</p><ul><li>You use the <a href="../../../common/maneuvers/knockback/">Knockback</a> maneuver (see Chapter 10: <a href="../../../../../Read/heroes/combat/">Combat</a>), but its distance becomes the range of your <a href="../../../ability/elementalist/level-1/hurl-element/">Hurl Element</a> ability, and you use Reason instead of Might for the power roll.</li><li>You choose a creature within the distance of your <a href="../../../ability/elementalist/level-1/hurl-element/">Hurl Element</a> ability and one of the following damage types: acid, cold, corruption, fire, lightning, poison, or sonic. That creature takes damage of the chosen type equal to your Reason score.</li><li>You <a href="../../../../movement/teleport/">teleport</a> up to a number of squares equal to your Reason score. If you choose this option, you can spend essence to <a href="../../../../movement/teleport/">teleport</a> 1 additional square for each essence spent.</li></ul></div>
</div>
</article>
</div>
</div>
