...
level: "7"
name: Feral Heart
scc: mcdm.beastheart.v1/feature.beastheart.level-7/feral-heart
type: feature
---
...
<template class="sc-src" data-fmt="md" data-src="At the start of each of your turns in combat, you gain 1d3 + 1 ferocity instead of 1d3."></template>
