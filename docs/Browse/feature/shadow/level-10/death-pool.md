...
<template class="sc-src" data-fmt="md" data-src="The first time each [combat round](../../../rule/combat/combat-round.md) that you deal damage incorporating 1 or more [surges](../../../rule/resource/surge.md), you gain 3 insight instead of 2."></template>
