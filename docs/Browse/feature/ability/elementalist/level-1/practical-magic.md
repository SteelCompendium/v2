...
- You use the Knockback maneuver (see Chapter 10: [Combat](../../../../../Read/chapter/combat.md)), but its distance becomes the range of your [Hurl Element](hurl-element.md) ability, and you use Reason instead of Might for the power roll.
