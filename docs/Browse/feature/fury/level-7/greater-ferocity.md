...
<template class="sc-src" data-fmt="md" data-src="When you gain ferocity at the start of each of your [turns](../../../rule/combat/turn.md) during combat, you gain 1d3 + 1 ferocity instead of 1d3."></template>
