...
<p class="sc-trait__leadin"><span class="sc-trait__dia"></span>Choose one <a href="../../../../rule/general/heroic-ability/">heroic ability</a> from the following options, each of which costs 5 focus to use. (<em>Quick Build:</em> <a href="../../../ability/tactician/level-1/hammer-and-anvil/">Hammer and Anvil</a>.)</p>
