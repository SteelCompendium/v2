...
<p>Choose one of your domains. You gain a domain feature for that domain, as shown on the 1st-Level <a href="../../../../class/conduit/">Conduit</a> Domain Features table. Additionally, you gain a skill from the chosen domain, selected from the skill group indicated on the table. (<em>Quick Build:</em> <a href="../../../censor/level-1/revitalizing-ritual/">Revitalizing Ritual</a> and the <a href="../../../../skill/heal/">Heal</a> skill from the Life domain.)</p>
...
<div class="sc-trait__body">
<p>The gods favor your thievery with magic. Whenever you make a test that uses a skill you have from the intrigue skill group, you can use Intuition on the test instead of another characteristic.</p>
</div>
</section>
<section class="sc-trait" data-action="trait">
<header class="sc-trait__head">
