...
<template class="sc-src" data-fmt="md" data-src="You gain the 1st-level domain feature and ability to choose a skill for the domain you selected at 1st level but whose domain feature you didn&#39;t take at that level (see 1st-Level Domain Feature)."></template>
