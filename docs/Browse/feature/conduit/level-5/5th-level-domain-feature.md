...
scc: mcdm.heroes.v1/feature.conduit.level-5/5th-level-domain-feature
type: feature
---
...
<template class="sc-src" data-fmt="md" data-src="You gain the 4th-level domain feature for the domain whose feature you didn&#39;t select at that level (see 4th-Level Domain Feature)."></template>
