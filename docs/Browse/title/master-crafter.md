...
- *Skilled Hands:* You have a skill from the [crafting skill group](../skill/crafting/index.md) that would have been used during the creation of the prerequisite item. If you already have that skill, you instead gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made using the skill. Additionally, you gain a second skill of your choice from the [crafting skill group](../skill/crafting/index.md).
