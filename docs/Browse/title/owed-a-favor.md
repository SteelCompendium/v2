...
Additionally, the faction is a good source of information. The Director chooses a skill from the [crafting](../skill/crafting/index.md) or [lore](../skill/lore/index.md) skill groups appropriate to the faction, such as the Criminal Underworld skill for an outlaw gang, the Blacksmithing skill for a blacksmith's guild, or the Society skill for a [noble](noble.md) house. While in a settlement where the faction has a presence, you gain this skill if you don't already have it. If you already have the skill, you instead gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made using the skill.
