...
- *Easy Marks:* You gain an [edge](../rule/dice/edge.md) on [tests](../rule/test/test.md) made using skills from the [interpersonal](../skill/interpersonal/index.md) and [intrigue](../skill/intrigue/index.md) skill groups when influencing members of a community that you have saved.
