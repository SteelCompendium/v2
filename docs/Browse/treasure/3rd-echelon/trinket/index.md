...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__flavor">Although you see nothing before you, your hands can discern an invisible scrap of cloth.</div>
...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__flavor">Each of these metallic blue bracers is oversized.</div>
  <div class="sc-card__stats" style="grid-template-columns:repeat(2,1fr)">
    <div class="sc-card__stat"><div class="v">450</div><div class="l">Project Goal</div></div>
...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__flavor">This angular electrum mask is set with an excess of eye holes and a horrifying maw.</div>
  <div class="sc-card__stats" style="grid-template-columns:repeat(2,1fr)">
    <div class="sc-card__stat"><div class="v">450</div><div class="l">Project Goal</div></div>
    <div class="sc-card__stat"><div class="v" style="font-size:.72rem">Reason or Intuition</div><div class="l">Roll Characteristic</div></div>
  </div>
...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__flavor">A sable blue circlet shimmers with finely woven threads of sparkling white.</div>
  <div class="sc-card__stats" style="grid-template-columns:repeat(2,1fr)">
    <div class="sc-card__stat"><div class="v">450</div><div class="l">Project Goal</div></div>
    <div class="sc-card__stat"><div class="v" style="font-size:.72rem">Reason or Intuition</div><div class="l">Roll Characteristic</div></div>
  </div>
...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__flavor">This simple band of copper vibrates slightly when handled.</div>
  <div class="sc-card__stats" style="grid-template-columns:repeat(2,1fr)">
    <div class="sc-card__stat"><div class="v">450</div><div class="l">Project Goal</div></div>
    <div class="sc-card__stat"><div class="v" style="font-size:.72rem">Reason or Intuition</div><div class="l">Roll Characteristic</div></div>
  </div>
...
<div class="sc-card sc-fil">
  ...
  <div class="sc-card__tags"><span class="sc-tag">Psionic</span><span class="sc-tag">Ring</span></div>
  <div class="sc-card__flavor">This silvery metal ring seems to momentarily vanish when observed from certain angles.</div>
  <div class="sc-card__stats" style="grid-template-columns:repeat(2,1fr)">
    <div class="sc-card__stat"><div class="v">450</div><div class="l">Project Goal</div></div>
