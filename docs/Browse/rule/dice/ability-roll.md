...
If an ability requires a power roll, it has a "Power Roll" entry that tells you which characteristic to add to the 2d10 roll you make when you use the ability. (Chapter 1: [The Basics](../../../Read/heroes/the-basics.md) talks about power rolls.)
