---
benefit: You have one skill of your choice from the [crafting skill group](../skill/crafting/crafting.md). Additionally, choose one of your skills from the crafting group. You gain an [edge](../rule/dice/edge.md) on any [test](../rule/test/test.md) that uses that skill.
