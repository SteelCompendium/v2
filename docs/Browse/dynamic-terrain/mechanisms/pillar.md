...
<div class="fb__feat-trailing">The pillar is destroyed, or a <a href="../pressure-plate/">pressure plate</a>, <a href="../switch/">switch</a>, or other linked trigger is activated.</div>
...
<article class="sc-ability fb__feat" data-action="triggered">
<div class="fb__feat-head"><header class="sc-head"><div class="sc-head__stack"><span class="fb__feat-icon">❗️</span><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line" id="sc-feat-toppling-pillar">Toppling Pillar</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-deck sc-head__slot--chip">Free triggered action</div></div></header></div>
...
<div class="fb__feat-trailing"><b>Metal Pillar (+1 EV)</b> The pillar is made of metal, has 9 <a href="../../../rule/health/stamina/">Stamina</a>, and deals 1d6 extra damage.</div>
