...
<div class="fb__feat-body">As a maneuver, a creature adjacent to a dart trap can make an <b>Agility test</b>.</div>
</article>
...
<div class="fb__feat-body"><b>Poison Darts (+2 EV)</b> The darts are tipped with poison. Any creature who takes damage from a dart also takes 1d6 poison damage at the start of each of their turns (save ends).
