...
You can also make free strikes on your turn to represent using weapons your hero isn't otherwise themed to use. A [wode elf](../../Browse/ancestry/wode-elf.md) master archer can stab a too-close enemy with a dagger as a free strike, and a greataxe-wielding [orc](../../Browse/ancestry/orc.md) [fury](../../Browse/class/fury.md) can use a free strike to hurl a handaxe at a flying enemy staying annoyingly out of melee range.
