...
**Alyssa (playing Jorn, a [tactician](../../Browse/class/tactician.md)):** *I'm going to hang out at the back of the group with my warhammer drawn. I want to be ready in case any of those skeletons we snuck by on the lower levels make their way up the stairs.*

**Matt (playing Linn, a [talent](../../Browse/class/talent.md)):** *Linn uses her [Minor Telekinesis](../../Browse/feature/ability/talent/level-1/minor-telekinesis.md) ability to sweep up the glass on the floor and form a path free of glass that goes from the door to the dais.*

**James (playing Korvo, a [shadow](../../Browse/class/shadow.md)):** *I'll light a torch as I step into the room. Is there anything new we can see now?*
...
**Director:** *The whole tower starts to sway as the sarcophagus lids crash to the floor and clawed undead hands emerge from within. Six decaying [devils](../../Browse/ancestry/devil.md), each tattooed with glowing green runes, rise. They're eager for violence.*
...
- If you have an [edge](../../Browse/rule/dice/edge.md) and a [bane](../../Browse/rule/dice/bane.md), or if you have a double [edge](../../Browse/rule/dice/edge.md) and a double [bane](../../Browse/rule/dice/bane.md), the roll is made as usual without any [edges](../../Browse/rule/dice/edge.md) or [banes](../../Browse/rule/dice/bane.md).
...
> **Why Cap?**
>
> We capped [edges](../../Browse/rule/dice/edge.md) and [banes](../../Browse/rule/dice/bane.md) at a maximum of two each for several reasons, including thinking about the narrative of those [penalties](../../Browse/rule/dice/bonuses-and-penalties.md). Every little advantage or disadvantage in a heroic story has diminishing returns, acknowledging that a creature can benefit or be hindered by short-term circumstances only so much. For example, a character who is [prone](../../Browse/condition/prone.md) and [weakened](../../Browse/condition/weakened.md) by poison already finds it difficult to attack—so that becoming [restrained](../../Browse/condition/restrained.md) by a net can't really make it harder.
...
- You can spend 2 [hero tokens](../../Browse/rule/resource/hero-token.md) on your [turn](../../Browse/rule/combat/turn.md) or when you take [damage](../../Browse/rule/damage/damage.md) (no action required) to regain [Stamina](../../Browse/rule/health/stamina.md) equal to your [recovery value](../../Browse/rule/health/recoveries.md) before taking the [damage](../../Browse/rule/damage/damage.md).

You can use only one [hero token](../../Browse/rule/resource/hero-token.md) benefit per [turn](../../Browse/rule/combat/turn.md) or per [test](../../Browse/rule/test/test.md). Unless the Director decides otherwise, unused [hero tokens](../../Browse/rule/resource/hero-token.md) disappear at the end of a session.
...
When you spend a [Recovery](../../Browse/rule/health/recoveries.md), you regain [Stamina](../../Browse/rule/health/stamina.md) equal to your **[recovery value](../../Browse/rule/health/recoveries.md)**, which is one-third your [Stamina](../../Browse/rule/health/stamina.md) maximum. You can spend your [Recoveries](../../Browse/rule/health/recoveries.md) with a special maneuver (see below), or you might do so with a little [supernatural](../../Browse/rule/general/supernatural.md) help from a [conduit](../../Browse/class/conduit.md), a boost of adrenaline from an allied [tactician](../../Browse/class/tactician.md), or inspiration from your party's [troubadour](../../Browse/class/troubadour.md).
...
Omund was betrayed and his castle fell to Ajax the Invincible, now called the Iron [Saint](../../Browse/rule/world/saint.md). His wizard Mortum unlocked the secret of the ancient sky elf flying cities, and raised the Chrysopolis, Ajax's city-fortress in the sky.

It was Mortum who used the secrets of the synliroi body banks, granting immortality to those nobles who voluntarily submit to Ajax. Those same body banks produce Ajax's war dogs, his brutal, patchwork—soldiers who owe their new lives to the Iron [Saint](../../Browse/rule/world/saint.md) and fight for him fanatically.

Ajax abolished all faiths and temples. He executed the dukes who organized and united the barons, leaving the far-flung baronies to try and hold [human](../../Browse/ancestry/human.md) civilization together. Once, these people were loose allies. There was trade between [humans](../../Browse/ancestry/human.md), elves, [dwarves](../../Browse/ancestry/dwarf.md) and [orcs](../../Browse/ancestry/orc.md).

Now there is only suspicion.

**The [high elves](../../Browse/ancestry/high-elf.md) of the fallen city** pay tribute with ancient artifacts they plunder from the fallen celestial city of Irranys. **The [wode elves](../../Browse/ancestry/wode-elf.md) of the Orchid Court**, lacking any centralized government or cities, refuse to bow to Ajax.

**The [dwarves](../../Browse/ancestry/dwarf.md) of Kal Kalavar** pay tribute in prisoners they abduct from those foolish enough to travel the roads unescorted. These prisoners serve Ajax as forced labor or are fed into the body banks. Brooding under the mountains in their fabled Hanging City, the stone [dwarves](../../Browse/ancestry/dwarf.md) do not like this deal with the Overlord but lack the power—or the will—to rebel.
...
On Axiom, the Plane of Uttermost Law, the [memonek](../../Browse/ancestry/memonek.md) live on a world teeming with complex, inorganic life. UNISOL, the Universal Solar League, ensures and protects trade across the upper worlds, defending the starfreighters from the [time raiders](../../Browse/ancestry/time-raider.md) and the infamous pirate band the Starslayers on their legendary ship the K.R.A.D.1 *Fearless*.
...
Traveling downward from Quintessence one arrives on [Orden](../../Browse/rule/world/orden.md), the Plane of Gods and Sorcery, highest of the lower worlds where magic rules. The gods, forbidden from interfering directly in a world with such a low energy state, rely on [saints](../../Browse/rule/world/saint.md) to enact their will. Technology from the upper worlds does not function down here, unless powered by a strong psionic mind or the miracle mineral iridoss, also known as prismacore.
...
In [Capital](../../Browse/rule/world/capital.md), for instance, people use flying tapestries to get around the city quickly, but these are a luxury available only to the rich. The vast majority of [Capital](../../Browse/rule/world/capital.md)'s citizens live a life basically the same as your average Londoner in Shakespeare's time. Less plague and fire, though.
