...
An **edge** represents a situational advantage a hero or an enemy has when making a power roll. For example, a standing hero who makes a melee [strike](../../Browse/rule/combat/strike.md) against a [prone](../../Browse/condition/prone.md) creature gains an edge on the power roll for their [strike](../../Browse/rule/combat/strike.md). A pair of magic gloves that makes your hands sticky might grant you an edge when making a power roll to climb walls!
