...
In *Draw Steel*, ancestry describes how you were born. Culture (part of Chapter 4: [Background](background.md)) describes how you grew up. If you want to be a [wode elf](../../Browse/ancestry/wode-elf.md) who was raised in a forest among other [wode elves](../../Browse/ancestry/wode-elf.md), you can do that! If you want to play a [wode elf](../../Browse/ancestry/wode-elf.md) who was raised in an underground city of [dwarves](../../Browse/ancestry/dwarf.md), [humans](../../Browse/ancestry/human.md), and [orcs](../../Browse/ancestry/orc.md), you can do that too!

This chapter details twelve ancestries for the game:

**[Devil](../../Browse/ancestry/devil.md):** [Devils](../../Browse/ancestry/devil.md) originated in the Seven Cities of Hell and have a [supernatural](../../Browse/rule/general/supernatural.md) charisma that helps them persuade others. They are similar in stature to [humans](../../Browse/ancestry/human.md), and their skin tones include deep blues, purples, and reds. They sport horns, eyes of all shades (including gold and red), and tails, and some have feathered or leathery wings.
...
**[Dwarf](../../Browse/ancestry/dwarf.md):** Humanoids with stony skin, [dwarves](../../Browse/ancestry/dwarf.md) have short and stout bodies. Many carve [supernatural](../../Browse/rule/general/supernatural.md) runes into their flesh, and some have beards made of crystals.

**[Wode Elf](../../Browse/ancestry/wode-elf.md):** Lithe humanoids with finely furred skin in all shades of blue, [wode elves](../../Browse/ancestry/wode-elf.md) have angular features and large, pointed ears akin to a bat's. They possess a [supernatural](../../Browse/rule/general/supernatural.md) glamor that allows them to blend in with their surroundings when they wish to hide.

**[High Elf](../../Browse/ancestry/high-elf.md):** Stately and graceful, [high elves](../../Browse/ancestry/high-elf.md) have tall, willowy bodies, pointed ears, and smoother skin than most other humanoids. Rare metal inlays such as gold, platinum, palladium, and iridium act as organic components within their skin. The truest form of any [high elf](../../Browse/ancestry/high-elf.md) is hidden from most—sometimes even from themself—thanks to a [supernatural](../../Browse/rule/general/supernatural.md) glamor that makes them more attractive to others, whatever that might mean to an individual. This glamor transcends physical appearance, also slightly altering a [high elf's](../../Browse/ancestry/high-elf.md) tone and smell.
...
**[Orc](../../Browse/ancestry/orc.md):** [Orcs](../../Browse/ancestry/orc.md) have skin in green tones and stand slightly taller and wider than [humans](../../Browse/ancestry/human.md). A [supernatural](../../Browse/rule/general/supernatural.md) energy they call "the blood fire" flows through their veins, igniting colorful lines in an [orc's](../../Browse/ancestry/orc.md) skin during life-or-death battles.

**[Polder](../../Browse/ancestry/polder.md):** The smallest of the ancestries in this book, [polders](../../Browse/ancestry/polder.md) stand no taller than 3-1/2 feet. They look like smaller [humans](../../Browse/ancestry/human.md), and they have the ability to blend in with the shadows.

**[Revenant](../../Browse/ancestry/revenant.md):** No hero starts their life as a [revenant](../../Browse/ancestry/revenant.md). Rather, these undead creatures return to the world of the living because they have dire business that must be finished. A character of any ancestry can become a [revenant](../../Browse/ancestry/revenant.md).

**[Time Raider](../../Browse/ancestry/time-raider.md):** Travelers of the timescape, the [time raiders](../../Browse/ancestry/time-raider.md) (or kuran'zoi as they call themselves) have four arms and a single ocular sensor instead of a pair of eyes. Many have innate psionic abilities that make them capable warriors.
...
>
> Abilities, [conditions](../../Browse/rule/combat/condition.md), [potencies](../../Browse/rule/character/potency.md), [saving throws](../../Browse/rule/general/saving-throw.md), [surges](../../Browse/rule/resource/surge.md): Chapter 5: [Classes](classes.md)
>
...
In every instance in recorded history, attempts by mortals to make obedient servitor species backfired. The steel [dwarves](../../Browse/ancestry/dwarf.md) worked marvels with valiar, the truemetal, and the miracle mineral iridoss, known as prismacore, that grants objects a semblance of life. Eventually their science and magics produced the omnivok—machines that were self-aware. Perhaps uniquely, when the [dwarves](../../Browse/ancestry/dwarf.md) realized they had created beings equal to themselves they stopped their work and gave their creations full rights and independence, preferring to work with them rather than attempt, and inevitably fail, to be their masters.

Normally, it doesn't work out that nicely. Even with the best of intentions, things go awry. The Dragon Phalanx were created by Good King Omund's wizard Vitae to be the perfect knights, dispensing justice throughout the lands. But the same sorceries that grant self-awareness also grant independence. Agency. And though they enjoyed 30 years of peace and justice, eventually the [dragon knights](../../Browse/ancestry/dragon-knight.md) were betrayed by one of their own, seduced by the power offered by Ajax.

The law of unintended consequences applies to the just and the unjust alike.

Usually when some powerful being tries to create an intelligent species, it's for less-than-virtuous reasons. The synliroi are responsible for several intelligent species in the timescape, each an attempt to create a perfectly obedient servitor species. The most notorious example are the kuran'zoi—the [time raiders](../../Browse/ancestry/time-raider.md) who rebelled almost immediately and who carry a burning hate for the voiceless talkers to this day.
...
A byname might refer to your profession. Clyde the Cartwright is a perfectly normal byname. But no one you met would assume "Cartwright" was your 'family name.' People who live permanently in a very large city like [Capital](../../Browse/rule/world/capital.md) use family names, because almost no first name is sufficiently unique to identify you, and "Marissa the Cartwright's Daughter" quickly evolves into Marissa Cartwright.
...
[High elf](../../Browse/ancestry/high-elf.md) names are poetic. They are an attempt to capture a fleeting, often contradictory, impulse, or emotion. They sometimes contain references to the natural world. They are never meant to be taken literally and they are not an attempt to make a character feel heroic.
...
[Revenants](../../Browse/ancestry/revenant.md) most often keep whatever names they had in life. They may have any number of reasons to adopt a new name in which case that name would reflect their reasons for doing so. Perhaps they adopt a moniker like many [talents](../../Browse/class/talent.md) do, or they choose a new name from their original culture, or something completely different!

##### Time Raider Names

Kuran'zoi names typically end with an epithet, given when the young [time raider](../../Browse/ancestry/time-raider.md) comes of age, that reflects their uniquely rebellious nature.
...
How tall is a [polder](../../Browse/ancestry/polder.md)? How long does a [dwarf](../../Browse/ancestry/dwarf.md) live? The Ancestry Measurements table provides the average adult height and weight ranges and life expectancy for each of the ancestries in this chapter. These measurements are only averages, and many folks in the world exist outside of them, so your hero can too!
...
|---------------|---------------------------|---------------------|-----------------------------|
| [Devil](../../Browse/ancestry/devil.md)         | 5'0''-6'0''               | 120-250             | 70-120                      |
| [Dragon Knight](../../Browse/ancestry/dragon-knight.md) | 6'0''-7'0''               | 200-350             | 50-90                       |
| [Dwarf](../../Browse/ancestry/dwarf.md)         | 4'0''-4'6''               | 500-1,000           | 700-1,500                   |
| [Wode Elf](../../Browse/ancestry/wode-elf.md)      | 5'6''-6'6''               | 100-150             | 1,200-3,000                 |
| [High Elf](../../Browse/ancestry/high-elf.md)      | 5'6''-6'6''               | 100-150             | 1,200-3,000                 |
| [Hakaan](../../Browse/ancestry/hakaan.md)        | 9'0''-10'0''              | 1,000-2,000         | 300-500                     |
| [Human](../../Browse/ancestry/human.md)         | 5'0''-6'0''               | 100-300             | 70-120                      |
| [Memonek](../../Browse/ancestry/memonek.md)       | 5'0''-6'0''               | 50-100              | 70-120                      |
| [Orc](../../Browse/ancestry/orc.md)           | 5'6''-6'6''               | 150-300             | 50-90                       |
...
Moments later, the candles flared, there was a burst of flame, and acrid brimstone filled his nostrils. When the smoke cleared... there was a [devil](../../Browse/ancestry/devil.md) standing in his basement—dark purple skin, horns, even a twitching tail.
...
"Uh-oh," the [devil](../../Browse/ancestry/devil.md) said, genuinely worried.

"HNNG!" Adelard grunted. Then he collapsed to the ground, curled into a fetal position, obviously in immense pain.

"Nono. Nurse!" the [devil](../../Browse/ancestry/devil.md) called out. "Doctor?! Is anyone... you should lie down. Well, you are lying down. Do some... some deep-breathing exercises. Have a cup of tea! That always..."

Adelard gasped one last time and uncurled, muscles relaxed. Eyes open but unseeing.

"... calms me down," the [devil](../../Browse/ancestry/devil.md) said quietly.

Suddenly, the candles were extinguished as one, plunging the room into pitch blackness. The [devil's](../../Browse/ancestry/devil.md) hellsight meant this was only a minor inconvenience for him. "Um," he said to the empty room. "Uh-oh."
...
A few moments later, the door to a small home, little more than a wooden shack, on the outskirts of a small village opened. A well-dressed [devil](../../Browse/ancestry/devil.md) peeked out and then slowly emerged, stepping onto the dirt road that led through the center of the village. A keep stood atop a hill in the [distance](../../Browse/rule/combat/distance.md).

"Ah," the [devil](../../Browse/ancestry/devil.md) said.
...
"Have at you, [devil](../../Browse/ancestry/devil.md)!" he said, assuming something like a dueling pose. "I say! Steady on!" The [devil](../../Browse/ancestry/devil.md) raised his hands.

The two of them stood there, frozen in the middle of the street for a few moments.

Then the [devil](../../Browse/ancestry/devil.md) turned and ran away as quickly as he could.
...
"Simply playing my part, darling. People expect a certain amount of vanity in a [troubadour](../../Browse/class/troubadour.md), don't they?"
...
"Well then, you must be very vain indeed," the [devil](../../Browse/ancestry/devil.md) said. "Anyway, does that answer your question?"
...
"Well, I was an accountant here in [Capital](../../Browse/rule/world/capital.md) for several years in between." "An accountant!"

Riyalkin shrugged. "It's what I did before. I'm moderately good at it." "And how does one go from being an alien accountant to a famous [troubadour](../../Browse/class/troubadour.md)?"
...
The three [human](../../Browse/ancestry/human.md) bandits took a step back. One of the [dwarves](../../Browse/ancestry/dwarf.md) just sneered—then, sensing his [human](../../Browse/ancestry/human.md) compatriots' reluctance, turned to look at them. "What's this?" the lead [dwarf](../../Browse/ancestry/dwarf.md) growled.

Looking at the [dragon knight](../../Browse/ancestry/dragon-knight.md), another bandit added quickly, "We didn't know there was one of you here."

The draconian didn't move. Didn't give any indication he heard the man. Just stared unblinking at the lead [dwarf](../../Browse/ancestry/dwarf.md). "Think of the *bounty*," the [dwarf](../../Browse/ancestry/dwarf.md) hissed to the [humans](../../Browse/ancestry/human.md), but he kept his eye on the draconian. "We'll all be *rich*."

The two [dwarves](../../Browse/ancestry/dwarf.md) surveyed the tavern. The people were now all facing them. A few had stood up. They weren't afraid anymore.

"We'll be *back*," the lead [dwarf](../../Browse/ancestry/dwarf.md) said, and the group of them backed out of the inn, sheathing their shortswords before they turned and left.

As one, the people in the tavern turned to look with undisguised awe at the [dragon knight](../../Browse/ancestry/dragon-knight.md). He noticed this, ducked his head to avoid their gaze. "Show's over," he growled, then he turned to go back to his seat in the rear.

A short, doughty, middle-aged man stood up, and two equally doughty women at the same table stood up with him. "Excuse me, sir knight," the man said as the [dragon knight](../../Browse/ancestry/dragon-knight.md) walked past their table.
...
The [dragon knight](../../Browse/ancestry/dragon-knight.md) sneered and bared a set of sharp teeth. "*Look for someone else*," he growled as he pulled his arm away.
...
The [dragon knight](../../Browse/ancestry/dragon-knight.md) turned sharply to look at the man who'd spoken. His back was to the draconian, but the voice gave him away.
...
The man held out his hand. The [dragon knight](../../Browse/ancestry/dragon-knight.md) looked at it for a moment before reaching out slowly to grasp it. "What are you doing out here?" he asked.
...
The inn had mostly gone back to its business but the three peasants watched intently. Eventually the [dragon knight](../../Browse/ancestry/dragon-knight.md) spoke again, his voice low.
...
"John," the [dragon knight](../../Browse/ancestry/dragon-knight.md) said, his voice suddenly sad. Exasperated. "You don't want to quote my oath to me. You really don't. I liked serving with you. I have fond memories of that time—of you. Don't spoil it." He looked at his friend, the three peasants, then shook his head and turned to leave the inn.

"Vaant," Sir John said, following. "Sir Vaantikalisax, by your *oath*!" The [dragon knight](../../Browse/ancestry/dragon-knight.md) stopped and spun around. Everyone in the inn was watching the show again. Act two.

"The people need leadership," John said.

Vaantikalisax's reptile eyes flashed in anger. "They *had it*! Thirty years, and what did it amount to?! I watched Ajax... I watched him..." The [dragon knight's](../../Browse/ancestry/dragon-knight.md) eyes flinched. His clawed hands tightened on his mace and shield. "I watched the oath... fail."
...
The [dragon knight](../../Browse/ancestry/dragon-knight.md) looked at the people around him, at the three peasants desperate for someone, anyone, to help them. Then he looked back to his friend.
...
<div class="sc-ability__cell"><div class="l">Distance</div><div class="v">1 <a href="../../../Browse/rule/combat/burst/">burst</a></div></div>
<div class="sc-ability__cell"><div class="l">Targets</div><div class="v">Each enemy in the area</div></div>
</div>
<div class="sc-ability__pr">
<div class="sc-ability__pr-head"><span class="sc-ability__dia"></span><span class="pre">Power Roll +</span><span class="chars"><a href="../../../Browse/rule/character/might/">Might</a> or <a href="../../../Browse/rule/character/presence/">Presence</a></span></div>
<div class="sc-ability__pr-rows">
<div class="sc-ability__tier" data-tier="low"><span class="badge">!</span><span class="res">2 damage</span></div>
<div class="sc-ability__tier" data-tier="mid"><span class="badge">@</span><span class="res">5 damage; <a href="../../../Browse/movement/forced-movement/">push</a> 1</span></div>
<div class="sc-ability__tier" data-tier="high"><span class="badge">#</span><span class="res">7 damage; <a href="../../../Browse/movement/forced-movement/">push</a> 2</span></div>
</div>
</div>
</article>
</div>
...
<div class="sc-ability__kw"><span class="sc-ability__chip">Area</span><span class="sc-ability__chip">Magic</span></div>
<div class="sc-ability__rail">
<div class="sc-ability__cell"><div class="l">Distance</div><div class="v">3 <a href="../../../Browse/rule/combat/cube/">cube</a> within 1</div></div>
<div class="sc-ability__cell"><div class="l">Targets</div><div class="v">Each enemy in the area</div></div>
</div>
<div class="sc-ability__pr">
<div class="sc-ability__pr-head"><span class="sc-ability__dia"></span><span class="pre">Power Roll +</span><span class="chars"><a href="../../../Browse/rule/character/might/">Might</a> or <a href="../../../Browse/rule/character/presence/">Presence</a></span></div>
...
<div class="sc-ability__section-body"><p>You choose the ability&#39;s <a href="../../../Browse/rule/damage/damage-type/">damage type</a> from acid, cold, corruption, fire, lightning, or poison.</p></div>
</div>
</article>
</div>
</div>
...
John smiled and gave her a look as they walked around the barn. "Yeah not like elves and [humans](../../Browse/ancestry/human.md), right?"
...
They found the [dwarf](../../Browse/ancestry/dwarf.md) at the edge of the old quarry outside of town cutting blocks of stone with a long copper saw. It normally took two people a quarter hour, but the [dwarf](../../Browse/ancestry/dwarf.md) sawed an entire block in two with a single stroke. The stones smoked as they fell, and the copper saw glowed with heat.

John and Embers watched silently as the [dwarf](../../Browse/ancestry/dwarf.md) hefted another massive stone onto the cutting block.

The [dwarf](../../Browse/ancestry/dwarf.md) spit into his hands and noticed the two out of the corner of his eye. He paused, walked over to grab his battle staff with the hourglass symbol of Zarok, Law-Giver at the tip. He walked back to the stone and leaned his staff against a tree stump within easy reach should he need to use it.

He went back to work.

"Good morning," John said.

The [dwarf](../../Browse/ancestry/dwarf.md) ignored them.
...
The [dwarf](../../Browse/ancestry/dwarf.md) paused. "High theochron?" he said. "A lofty title. Far too lofty for a job such as this," he went back to work and a moment later there were two more smoking blocks. He cleared them away.
...
"Mm. I have heard of this one," the [dwarf](../../Browse/ancestry/dwarf.md) said, seemingly uninterested. He hurled the smaller blocks into a pile and went to heft a new stone to cut. "A foul tyrant. Well-suited to these times. Perhaps the people deserve him."

"No people *deserve* tyranny," Embers said, an edge in her voice. The [dwarf](../../Browse/ancestry/dwarf.md) appeared to notice her for the first time, peered at her, took in her raiment, and went back to work. "Nine against Saxton." The [dwarf](../../Browse/ancestry/dwarf.md) carried the massive block over his head to the cutting stone. He shook his head in disbelief at what was being asked. "How great the opposition?"

John told him.

The [dwarf](../../Browse/ancestry/dwarf.md) dropped the stone in astonishment and stared at the [human](../../Browse/ancestry/human.md) and elf. Then he smiled. "Hah. You know our traditions well, sir knight. You seek to grant me a glorious death leading desperate soldiers against impossible odds."

"Not that desperate," John said modestly.

"Yes." The [dwarf](../../Browse/ancestry/dwarf.md) looked at Embers again. "By garb and reputation, I make you A Mist Curls Around Dying Embers, mistress of the Tower of Translation. You are no stranger to power. But your tower is fallen lady," he said. "Seek you revenge? Or justice?"
...
The [dwarf's](../../Browse/ancestry/dwarf.md) head snapped to look at Sir John. "She speaks my language as well it seems. You are of a kind, you two."

"Three," John dared.

The [dwarf](../../Browse/ancestry/dwarf.md) failed to stifle a smile. "And what is your stake in this?" John shrugged. "I've already been paid," he said. He fished around in a pouch on his belt. "Here, I'll split it with you, fair and square."

John flicked a coin off his finger with his thumb. It spun and glinted as it arced across the space between them. The [dwarf](../../Browse/ancestry/dwarf.md) snatched it from the air, opened his palm and stared at it. Something in his face changed. Softened. He looked at the nearby town that had adopted him. Peasants doing labor in the fields.
...
The [dwarf](../../Browse/ancestry/dwarf.md) said nothing. He looked at the coin in his hand.

"You left your people," Embers said quietly.

"My people left me!" Dazar barked. "When they embraced Ajax!" Embers just watched the [dwarf](../../Browse/ancestry/dwarf.md). His rage subsided as quickly as it came.
...
The [dwarf](../../Browse/ancestry/dwarf.md) looked up at Embers, "Her I know by reputation." He turned to look at John.
...
"Hmm," Dazar grunted. He opened a pouch on his chest armor and inserted the coin. "We must find a [troubadour](../../Browse/class/troubadour.md), to tell the tale of Saxton's fall. I cannot wait to hear how it ends!" He walked between them, carrying his staff over his shoulder.
...
<p><b>Light:</b> Your skin sheds light for 10 squares. You can <a href="../../../Browse/rule/combat/turn/">turn</a> this light on and off as a maneuver.</p>
...
Meliora gasped. Credan frowned, and Wenna hushed her. Dade was ushered back toward them by two more [wode elves](../../Browse/ancestry/wode-elf.md), his bow in hand. The children huddled together, Credan's hand on the symbol of Saint Gryffyn around his neck, and Jeremy's hand on the hilt of his sword.

The elves were tall, taller than an adult [human](../../Browse/ancestry/human.md), but seemed always to crouch as soon as they stopped moving. Their eyes were unsettling, widely spaced and huge. But it was their ears, long and tall and twisting and set with great scoops to catch all sound, that marked them as elves of the wode.

"Admittedly, though, most terrans regret the experience." The voice they had heard called out again—from above. The children looked up and now saw a [wode elf](../../Browse/ancestry/wode-elf.md) with long, furry, twisting ears and nut-brown skin smiling down at them. They wore a brightly colored outfit. The children watched the elf leap lightly from branch to lower branch until finally landing with a flourish on the forest floor before them.
...
Rhythylthin rolled his eyes. Llyander noticed this and winked at him. "Fashions change. My cousin here wears the new trends." They gestured at the other [wode elf's](../../Browse/ancestry/wode-elf.md) garb and masculine appearance. "Me? I'm old fashioned." They gestured to their own outfit and appearance. "*Grace* never goes out of style."

Llyander turned to Rhythylthin and the rest of the [wode elf](../../Browse/ancestry/wode-elf.md) band. "Their gift goes to Lord Tear, methinks. I will escort them." Then, suddenly imperious, they added, "You may go."
...
"I enjoy the favor of Lord Tear," Llyander said. "We are old friends. With me as your [guide](../../Browse/rule/downtime/guide.md), he will treat you well—likely bestow favor upon you! You should be in anticipation of great treasure." They smiled.

The elf stopped suddenly and spun toward them, serious but kindly. They pointed to each of the children in [turn](../../Browse/rule/combat/turn.md).
...
<div class="sc-ability__pr-rows">
<div class="sc-ability__tier" data-tier="low"><span class="badge">!</span><span class="res">2 + M or A damage; A &lt; WEAK, <a href="../../../Browse/condition/slowed/">slowed</a> (save ends)</span></div>
<div class="sc-ability__tier" data-tier="mid"><span class="badge">@</span><span class="res">3 + M or A damage; A &lt; AVERAGE, <a href="../../../Browse/condition/slowed/">slowed</a> (save ends)</span></div>
<div class="sc-ability__tier" data-tier="high"><span class="badge">#</span><span class="res">5 + M or A damage; A &lt; STRONG, <a href="../../../Browse/condition/restrained/">restrained</a> (save ends)</span></div>
</div>
</div>
</article>
</div>
...
"Who are you kidding?" Dade said. "Everyone knows how much elves hate [humans](../../Browse/ancestry/human.md)."
...
"You have returned something not only of enormous worldpower, but at the same time, a work of art my ancient relative labored over for many of your centuries. It is something of a miracle that it is returned to me now. I will not forget this. You have made an ally of the lord of the [high elves](../../Browse/ancestry/high-elf.md). And though you lead brief lives, while you live, you shall have the favor of the elves." He turned to hand the scroll over to a sage and confer with his herald.
...
Descended from a tribe of giants in upper Vanigar, the original Haka'an tribe made a bargain with Holkatya the Vanigar trickster god. They traded some of their gigantic [size](../../Browse/rule/character/size.md) and strength for the ability to see the future.
...
But the only [hakaan](../../Browse/ancestry/hakaan.md) the average [human](../../Browse/ancestry/human.md) meets is one trying to fulfill their doom. The [human](../../Browse/ancestry/human.md) superstition—that the arrival of one or more [hakaan](../../Browse/ancestry/hakaan.md) in [human](../../Browse/ancestry/human.md) lands is a sign of great forces acting in the world, auspicious times—is literally true. In dark times, many [hakaan](../../Browse/ancestry/hakaan.md) experience the Doomsight and leave their communities to venture out into the mundane world, in search of their destiny.
...
But the arrival of the giant changed the equation. John saw a new solution. The [hakaan](../../Browse/ancestry/hakaan.md) risked his life to buy them options, and Sir John of Tor would not let the giant risk his life in vain.
...
The [hakaan](../../Browse/ancestry/hakaan.md) struggled against the living gateway to that blasted world. One leg buckled and the stone warrior fell to one knee. The door would take him just as it took their [dwarf](../../Browse/ancestry/dwarf.md) [conduit](../../Browse/class/conduit.md).

Then, rising behind the egress demon, the high theocron, his battlestaff glowing.

"Back!" Dazar [conduit](../../Browse/class/conduit.md) of Zarok, Law-Giver shouted, smashing at the flesh of the living doorway with his battlestaff. "To hell!" He swung again.
...
They only had a moment before the demons swarmed them, but a moment was all it took before the [hakaan](../../Browse/ancestry/hakaan.md) shouted and finally ripped the bloody egress demon apart with his bare hands.
...
"Ajax," Dazar said. And the [hakaan](../../Browse/ancestry/hakaan.md) could hear the darkness in his voice.
...
"No armor, no sword or staff," Dazar noticed. "[Hakaan](../../Browse/ancestry/hakaan.md) do not use weapons?"
...
"He's a [null](../../Browse/class/null.md)," Embers explained. "They eschew all weapons and [implements](../../Browse/rule/treasure/implement.md) of war. It is part of their creed, as I understand it."

"Strength alone might serve," Dazar nodded, "when the strength is such as yours."

Ardashir grinned. "Strength alone is not enough." He assumed a fighting pose, hands clenched, arms in a guarding position before him. "Discipline, training, focus. These are my [implements](../../Browse/rule/treasure/implement.md)."
...
<p>Additionally, when your <a href="../../../Browse/rule/health/stamina/">Stamina</a> reaches the negative of your <a href="../../../Browse/rule/health/winded/">winded</a> value and you are not doomed, you turn to rubble instead of experiencing death. You are unaware of your surroundings in this state, and you can&#39;t regain <a href="../../../Browse/rule/health/stamina/">Stamina</a> or have this effect undone in any way. After 12 hours, you regain <a href="../../../Browse/rule/health/stamina/">Stamina</a> equal to your <a href="../../../Browse/rule/health/recoveries/">recovery value</a>.</p>
</div>
</section>
<section class="sc-trait" data-action="trait">
...
I will now answer the one question I am asked most often, and which I save answering until the last day of class. What do I think of [humans](../../Browse/ancestry/human.md)?

I am a [high elf](../../Browse/ancestry/high-elf.md), as you deem it in your tongue. A child of the solar celestials. And I have taught this class, mostly to young [humans](../../Browse/ancestry/human.md), for thirteen centuries. I have seen generations of your people come through this classroom, and that alone would well qualify me to answer this question.

What do I think of [humans](../../Browse/ancestry/human.md)? Well, I will tell you.
...
We studied [human](../../Browse/ancestry/human.md) history in this room. Did you feel that those great ancestors of yours were perhaps made of finer stuff than you? Do not think thus. I knew them, and I know you, and your future is greater. I sometimes think each [human](../../Browse/ancestry/human.md) generation greater than the last—more courageous, more generous. Quicker to forgive.
...
Each of these great evils was defeated by a coalition. The armies and heroes of many speaking peoples. And all of them—all of them—were led... by [humans](../../Browse/ancestry/human.md). That's a fact. That's history. You can look it up.
...
Stopping Ajax will require you to become something else. You must become heroes. [Conduits](../../Browse/class/conduit.md) of [saints](../../Browse/rule/world/saint.md), warmasters of great armies. [Censors](../../Browse/class/censor.md) and [shadows](../../Browse/class/shadow.md). That may seem unlikely now, but the future has a way of surprising us.
...
Revile stopped and turned to look at the rest of the party, recovering from their wounds. The [memonek's](../../Browse/ancestry/memonek.md) white porcelain chest heaved as he tried to calm himself. His ceramic skin looked as strong as plate, but John knew it was brittle, fragile.
...
The [memonek](../../Browse/ancestry/memonek.md) smiled ruefully. "It feels that way sometimes. I spent an hour this morning staring at an insect that landed on my finger. A *grasshopper* the [dwarf](../../Browse/ancestry/dwarf.md) called it. I thought I had never seen a thing so perfect and beautiful. That was awe. As powerful as I have ever felt. In the battle today, anger. Just as powerful.
...
The [orc](../../Browse/ancestry/orc.md) hopped down from the corpse of the defeated. "Elg was a ruin ogre," she said. "Infected with a troll disease. An inconvenience for troll-kin but to an ogre..." She indicated the mutated ogre. "You weren't to know."

"Oh, good," Sir John said with obvious relief. "You speak Caelian." "Yes." The [orc](../../Browse/ancestry/orc.md) said. She seemed distant. She gave John a look. "I speak the language of your conquerors."

John smiled. He liked this [orc](../../Browse/ancestry/orc.md) already.
...
"If you couldn't hold your own," the [orc](../../Browse/ancestry/orc.md) said, "there'd be no point helping you." Her eyes rested on Sir John.

"John," he said.

"Khorva," the [orc](../../Browse/ancestry/orc.md) said.
...
Khorva nodded without looking at the [dwarf](../../Browse/ancestry/dwarf.md).
...
John saw the broken swords on her belt. "Five swords," he said. "Five broken swords." He looked at Khorva anew. "I don't think I've ever seen an [orc](../../Browse/ancestry/orc.md) survived three challenges."
...
"Because we are not fools," Embers said, and Khorva locked eyes with her, standing a little straighter. The [orc's](../../Browse/ancestry/orc.md) brown eyes burned and it seemed the group rose somewhat in her estimation. She nodded once. "The folk of farm and field go to war," Dazar said, using the orcish term for [humans](../../Browse/ancestry/human.md). "A war against Lord Saxton and his priest."
...
"Saxton has no regulars. Just some knights, we can take care of them. But he has the Whitewater. Led by Bonebreaker Dorokor. That's three companies of elite light [orc](../../Browse/ancestry/orc.md) foot against a handful of peasant levies. We need the Howling."

"Perhaps," Khorva said, and turned away from the crows to look out over the heroes. "I know Dorokor, she is not like my brother. A head of meat and muscle. Dorokor is a thinker. You seek the Howling because you seek a counter to the Whitewater." She looked at John. "But even better, *talk* to Dorokor. Deny Saxton his pet [orc](../../Browse/ancestry/orc.md) clan, and *earn* the allegiance of the Whitewater."
...
Khorva shook her head. "[Orcs](../../Browse/ancestry/orc.md) have no great love for battle. We love trees and green things. We love an unspoiled land. For this reason did Kul place us in the world. The last of the original speaking peoples."
...
"This kind of shit doesn't work if it's just a bunch of ratcatchers like us," the [polder](../../Browse/ancestry/polder.md) said. "You need the people to rise up. Been fifteen years since Omund died—fifteen years of fighting wolves and bandits and worse. The people welcome a tyrant after that. They like order, you know? They adapt."

"If you stand on the grass long enough, it learns to lie flat," A Mist Curls Around Dying Embers said. "But what do *you* say?"

"Eh?" the [polder](../../Browse/ancestry/polder.md) asked her. But he glanced at Sir John staring at him. "You say the people have no stomach for rebellion," Embers said. "But what about you?"

"Oh," the [polder](../../Browse/ancestry/polder.md) said, "I say it doesn't matter much what I say. Why's he looking at me like that?" he asked the [high elf](../../Browse/ancestry/high-elf.md) and pointed at Sir John. Realizing he was being rude, John shook his head to clear it. "Sorry, I just... I never met a [polder](../../Browse/ancestry/polder.md) before," he said.

"Are you kidding me?" Jackson said.

"No! Sorry, I just..."

"What are you, from the moon? Where you from that you never met a [polder](../../Browse/ancestry/polder.md) before? There's [polder](../../Browse/ancestry/polder.md) in every fucking village and town from here to the sea."

"Really? That's weird. I'm from Tor, I've been all over—just never met a [polder](../../Browse/ancestry/polder.md) before."

Jackson looked at his friend, the [high elf](../../Browse/ancestry/high-elf.md) void mage. "Am I crazy?" "You're not crazy." Embers smiled. She was enjoying watching two of her friends get to know each other. "John's just never run into one, it seems."

"Well, we're adorable," the [polder](../../Browse/ancestry/polder.md) said, and drank some ale. "They must have been around I guess," John said. "I probably just never noticed."

The [polder](../../Browse/ancestry/polder.md) put his drink down. "Oh, thank you. Thank you very much. You know, it's funny. I never have any problem noticing you big assholes. One of you makes about as much noise as a cow, which... I don't even know how you manage that."
...
"[Humans](../../Browse/ancestry/human.md) are loud, yes," Embers agreed.

"Do we have to... can we talk about something else, please?" John said.

"I just..." The [polder](../../Browse/ancestry/polder.md) wouldn't let it go. "You seriously never... you never been to an inn? [Cavall](../../Browse/religion/god/cavall.md)'s teeth, I can't count how many inns and taverns I've been to run by [polders](../../Browse/ancestry/polder.md), got [polders](../../Browse/ancestry/polder.md) in the kitchen or waiting tables. One of the only two things we're good at, I think."
...
"Yeah, okay. To business: How to rally the people." The [polder](../../Browse/ancestry/polder.md) took the question seriously. "It's not hard. First, we need someone they'll rally around. I could make someone up, invent a local folk hero, but if we can find the real thing? They just need to look the part, that's all. I'll take care of the rest."
...
"What do you mean?" Now it was the [polder's](../../Browse/ancestry/polder.md) turn to be confused. "What do you mean, 'What do I mean?'" John said.
...
"I..." Jackson looked with incredulity at the [high elf](../../Browse/ancestry/high-elf.md) void mage, then back at the [human](../../Browse/ancestry/human.md). "Yes, I do mean that. Does he know what I do?" he asked the elf.

"He'll learn." Embers smiled.

The [polder](../../Browse/ancestry/polder.md) turned back to Sir John. "Hello. I lie for a living. And I'm *really good at it*. Sometimes also kill people, but only if lying or running away doesn't work."

John turned to Embers. "I thought he was a thief."

"I was a thief," the [polder](../../Browse/ancestry/polder.md) said.
...
"Depends on who you ask. I don't like being told what to do. It's sort of a [polder](../../Browse/ancestry/polder.md) thing. Hereditary or ancestral or whatever. Everybody wants a [polder](../../Browse/ancestry/polder.md) chef until they start trying to tell us what to cook."

"So what are you now?"

"I'm annoying."

The elf smiled. "He's a [troubadour](../../Browse/class/troubadour.md)—one of the best."

Sir John looked at him, nodded. "No lute, I notice. And you don't seem the type to sit by the hearth telling stories."

The [polder](../../Browse/ancestry/polder.md) grinned. "I ain't that kind of [troubadour](../../Browse/class/troubadour.md). I'm the other kind. I think the best story is the one people tell each other."

"Propaganda," Sir John said, a grin spreading across his face. The [polder](../../Browse/ancestry/polder.md) pointed a finger at him and smiled. John heard the door to the inn open behind him. This wasn't notable, but the gasp from the customers was.

"Hey," the [polder](../../Browse/ancestry/polder.md) said, looking past John to the doorway. "Hey, I think our folk hero just showed up. Damn, he looks the part all right. Or she, I can never tell with these guys."
...
The [dragon knight](../../Browse/ancestry/dragon-knight.md) stared at them for a moment, then turned back to his friend.
...
<div class="sc-trait__nest">
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Signature Trait: Shadowmeld</h3></div></div><div class="sc-head__rail sc-head__col--right"></div></header>
<div class="sc-trait__body">
<p class="sc-trait__leadin"><span class="sc-trait__dia"></span>You have the following ability.</p>
<div class="sc-trait__nest">
<article class="sc-ability sc-fil" data-action="maneuver">
<header class="sc-head"><div class="sc-head__stack"><span class="sc-crest sc-ability__crest"><span class="sc-ability__glyph">f</span></span><div class="sc-head__col sc-head__col--left"><div class="sc-head__slot sc-head__left-eyebrow sc-head__slot--line">Ability</div><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Shadowmeld</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-deck sc-head__slot--chip">Maneuver</div></div></header>
...
<div class="sc-ability__section">
<div class="sc-ability__section-head"><span class="sc-ability__dia"></span><span class="tag">Effect</span></div>
<div class="sc-ability__section-body"><p>You flatten yourself into a shadow against a wall or floor you are touching, and become hidden from any creature you have <a href="../../../Browse/rule/combat/cover/">cover</a> or <a href="../../../Browse/rule/combat/concealment/">concealment</a> from or who isn&#39;t observing you. While in shadow form, you have full awareness of your surroundings, and <a href="../../../Browse/rule/combat/strike/">strikes</a> made against you and <a href="../../../Browse/rule/test/test/">tests</a> made to search for you take a <a href="../../../Browse/rule/dice/bane/">bane</a>. You can&#39;t move or be <a href="../../../Browse/movement/forced-movement/">force moved</a>, and you can&#39;t take main actions or maneuvers except to exit this form or to direct creatures under your control, such as one you summon using an ability. Any ability or effect that targets more than 1 square affects you in this form only if it explicitly affects the surface you are flattened against. You can exit this form as a maneuver.</p><p>If the surface you are flattened against is destroyed, this ability ends and you take 1d6 damage that can&#39;t be reduced in any way.</p></div>
</div>
</article>
</div>
</div>
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Signature Trait: Small!</h3></div></div><div class="sc-head__rail sc-head__col--right"></div></header>
<div class="sc-trait__body">
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Purchased Polder Traits</h3></div></div><div class="sc-head__rail sc-head__col--right"></div></header>
<div class="sc-trait__body">
<p class="sc-trait__leadin"><span class="sc-trait__dia"></span>You have 4 ancestry points to spend on the following traits. (<em>Quick Build:</em> Corruption Immunity, Fearless, Graceful Retreat.)</p>
<div class="sc-trait__nest">
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Corruption Immunity</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-primary sc-head__slot--mini">1 Point</div></div></header>
<div class="sc-trait__body">
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Fearless</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-primary sc-head__slot--mini">2 Points</div></div></header>
<div class="sc-trait__body">
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Nimblestep</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-primary sc-head__slot--mini">2 Points</div></div></header>
<div class="sc-trait__body">
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Polder Geist</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-primary sc-head__slot--mini">1 Point</div></div></header>
<div class="sc-trait__body">
...
<section class="sc-trait" data-action="trait">
<header class="sc-head"><div class="sc-head__stack"><div class="sc-head__col sc-head__col--left"><h3 class="sc-head__slot sc-head__left-primary sc-head__slot--line">Reactive Tumble</h3></div></div><div class="sc-head__rail sc-head__col--right"><div class="sc-head__slot sc-head__right-primary sc-head__slot--mini">1 Point</div></div></header>
<div class="sc-trait__body">
...
Unlike the necromantic rituals that produce wights and wraiths and zombies, [revenants](../../Browse/ancestry/revenant.md) rise from the grave through a combination of an unjust death and a burning desire for vengeance. Creatures sustained on pure will, they have no need of food or water or air—and, unlike their zombified cousins, they retain all their memories and personality from life.
...
"I dunno, uh... uh, [Capital](../../Browse/rule/world/capital.md) I think."
...
"Nonono! How could she... [Capital](../../Browse/rule/world/capital.md) was *nine months ago!*"

"She's a [revenant](../../Browse/ancestry/revenant.md), idiot! She doesn't even need air. She could have walked here! Just... into the water and across the bottom of the sea! Why didn't you say anything?"
...
"You marked us. Back in [Capital](../../Browse/rule/world/capital.md). You marked one of us and just... just *walked* here."

"Don't be stupid. I marked you in Blackbottom. [Capital](../../Browse/rule/world/capital.md) was just normal detective work. I came here by *ship*." She smiled—black lips on pale gray skin.
...
"Hang on, you can't arrest us," one of the thieves, unarmed and still holding his hands up, said. "This isn't [Capital](../../Browse/rule/world/capital.md). You don't have jurisdiction!"
...
<div class="sc-ability__pr">
<div class="sc-ability__pr-head"><span class="sc-ability__dia"></span><span class="pre">Power Roll +</span><span class="chars"><a href="../../../Browse/rule/character/reason/">Reason</a>, <a href="../../../Browse/rule/character/intuition/">Intuition</a>, or <a href="../../../Browse/rule/character/presence/">Presence</a></span></div>
<div class="sc-ability__pr-rows">
<div class="sc-ability__tier" data-tier="low"><span class="badge">!</span><span class="res">3 + R, I, or P damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 1</span></div>
<div class="sc-ability__tier" data-tier="mid"><span class="badge">@</span><span class="res">5 + R, I, or P damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 2</span></div>
<div class="sc-ability__tier" data-tier="high"><span class="badge">#</span><span class="res">7 + R, I, or P damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 3</span></div>
</div>
</div>
<div class="sc-ability__section">
<div class="sc-ability__section-head"><span class="sc-ability__dia"></span><span class="tag">Effect</span></div>
...
There was something about the war dogs. They loved Ajax's cruelty—reveled in it. John had crossed swords with other commanders in Ajax's army before. Ground Commander Vordokov was a professional—could be reasoned with, but he was an [orc](../../Browse/ancestry/orc.md).
...
"Allies of all those who suffer, and seek justice," the [dwarf](../../Browse/ancestry/dwarf.md) announced. Sir John ignored the war dog, tilted his head toward the alien. "Embers?"

"A kuran'zoi," the [high elf](../../Browse/ancestry/high-elf.md) said, and the alien held her head up with pride. "A [time raider](../../Browse/ancestry/time-raider.md) from the upper worlds. What the truth is I cannot say, and no people are all one thing. But by reputation? They're intractable, ungovernable, they loathe authority, hate tyranny and are totally, utterly without fear."
...
Lycaon cocked his head at Sir John and took a few foolish steps toward the [tactician](../../Browse/class/tactician.md). He was just out of reach. But close enough.

"I see you are a man, like Ajax. Why do you lower yourself with these... creatures?" The war dog taxiarch looked at the elf, giant, [polder](../../Browse/ancestry/polder.md), [dwarf](../../Browse/ancestry/dwarf.md), and [dragon knight](../../Browse/ancestry/dragon-knight.md). "Little more than slimy things crawled out of the sea? Join us. Join me. Join Ajax. It'll be nice for you..."-his voice lowered almost to a whisper-"... to be on the winning side for a change."
...
Ember's eyes flashed into a starfield. The [time raider's](../../Browse/ancestry/time-raider.md) chains dissolved into starspace and reappeared around Flight Captain Lyria pinning her arms to her side. She was giving the hawklord an excuse to sit this one out. Gods, John was glad she was with them.

The [time raider's](../../Browse/ancestry/time-raider.md) right upper hand shot out, as though she'd been waiting for the void mage to do exactly what she just did, and her meson blaster leapt out of the hands of the war dog who'd chained her. The pistol made of glass and bronze slammed into her hand and its tip flared with prismatic light.
...
At the sound, the [orc](../../Browse/ancestry/orc.md) dashed forward into a knot of war dog commandos, her axe already hewing about her.
...
<div class="sc-ability__tier" data-tier="mid"><span class="badge">@</span><span class="res">5 + R, I, or P damage; <a href="../../../Browse/movement/forced-movement/">push</a> 1</span></div>
<div class="sc-ability__tier" data-tier="high"><span class="badge">#</span><span class="res">7 + R, I, or P damage; <a href="../../../Browse/movement/forced-movement/">push</a> 2; M &lt; STRONG, <a href="../../../Browse/condition/prone/">prone</a></span></div>
</div>
</div>
</article>
<article class="sc-ability sc-fil" data-action="main">
...
<div class="sc-ability__pr-head"><span class="sc-ability__dia"></span><span class="pre">Power Roll +</span><span class="chars"><a href="../../../Browse/rule/character/reason/">Reason</a>, <a href="../../../Browse/rule/character/intuition/">Intuition</a>, or <a href="../../../Browse/rule/character/presence/">Presence</a></span></div>
<div class="sc-ability__pr-rows">
<div class="sc-ability__tier" data-tier="low"><span class="badge">!</span><span class="res">2 + R, I, or P psychic damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 1</span></div>
<div class="sc-ability__tier" data-tier="mid"><span class="badge">@</span><span class="res">5 + R, I, or P psychic damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 2</span></div>
<div class="sc-ability__tier" data-tier="high"><span class="badge">#</span><span class="res">7 + R, I, or P psychic damage; <a href="../../../Browse/movement/forced-movement/">slide</a> 3</span></div>
</div>
</div>
</article>
<article class="sc-ability sc-fil" data-action="maneuver">
...
<div class="sc-ability__section">
<div class="sc-ability__section-head"><span class="sc-ability__dia"></span><span class="tag">Effect</span></div>
<div class="sc-ability__section-body"><p>The target gains a <a href="../../../Browse/rule/dice/bonuses-and-penalties/">bonus</a> to <a href="../../../Browse/rule/character/speed/">speed</a> equal to your <a href="../../../Browse/rule/character/reason/">Reason</a>, <a href="../../../Browse/rule/character/intuition/">Intuition</a>, or <a href="../../../Browse/rule/character/presence/">Presence</a> score (your choice) until the start of your next <a href="../../../Browse/rule/combat/turn/">turn</a>.</p></div>
</div>
</article>
</div>
</div>
