...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Wind Crystal of Quintessence

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Low Rhyvian
...
When you start this project, you hire a crew of carpenters, mages, and shipwrights who work in the area where the project is undertaken, with these artisans building the ship for you. You can make a [project roll](../../Browse/rule/downtime/project-roll.md) whenever you are overseeing the project, which you might be able to do remotely through the use of magic or psionics.
...
| Length              | [Renown](../../Browse/rule/resource/renown.md) Earned |
|---------------------|---------------|
| 50 miles or less    | 1             |
| 51-100 miles        | 2             |
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Three writs of approval, from an engineers' guild, a masons' guild, and a guards' guild
...
When you start this project, you hire a crew of masons, engineers, and guards who start work at the location where the project begins and build or repair the road for you. You can make a [project roll](../../Browse/rule/downtime/project-roll.md) whenever you are overseeing the project, whether you do so in person or remotely through the use of magic or psionics.

The number of [project points](../../Browse/rule/downtime/project-points.md) required to complete work on the road equals 10 x the road's length in miles. The goal is cut in half if you are repairing an existing road, or if someone else starts work on a second road project that connects to your project.

When you complete the project, you earn [Renown](../../Browse/rule/resource/renown.md) among people in the area where the road is built, depending on the length of the road.

Time spent traveling between locations on the road is cut in half. Access to resources and knowledge is improved in locations along the road, giving you and your allies an [edge](../../Browse/rule/dice/edge.md) on [project rolls](../../Browse/rule/downtime/project-roll.md) to discover lore while you are in those areas.
...
| 2   | After the roll, the local population grows in excitement with each completed portion of the road. The name of the hero making the [project roll](../../Browse/rule/downtime/project-roll.md) spreads as a builder of bridges both literal and social. If the [project roll](../../Browse/rule/downtime/project-roll.md) is 12 or higher, the local community comes together to complete the project alongside the hero's hired crew. The hero doubles the [renown](../../Browse/rule/resource/renown.md) earned at the end of the project.                                                    |
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One spatial navigator
...
You can craft the items found in Treasures in Chapter 13: [Rewards](rewards.md). Each treasure notes its [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md), [project source](../../Browse/rule/downtime/project-source.md), [project roll](../../Browse/rule/downtime/project-roll.md) [characteristic](../../Browse/rule/character/characteristic.md), and project goal.

#### Find a Cure {data-scc="mcdm.heroes.v1/project/find-a-cure"}

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Varies (see description)

**[Project Source](../../Browse/rule/downtime/project-source.md):** None
...
**Absorption:** Whenever you are targeted by a magic or psionic ability that targets only one creature, you can use a free [triggered action](../../Browse/rule/combat/triggered-action.md) to cause this armor to absorb the ability after the ability's effects resolve. While the armor has an ability absorbed, you can't absorb another.

You can use an absorbed ability as if you knew it, making [power rolls](../../Browse/rule/dice/power-roll.md) for the ability using your choice of [Reason](../../Browse/rule/character/reason.md), [Intuition](../../Browse/rule/character/intuition.md), or [Presence](../../Browse/rule/character/presence.md). You don't need to spend any [Heroic Resource](../../Browse/rule/resource/heroic-resource.md) to activate the ability. Once you use the ability, the armor loses it, and you can absorb another.
...
**Dragon Soul:** When another creature causes you to be [winded](../../Browse/rule/health/winded.md) or [dying](../../Browse/rule/health/dying.md), you can use a free [triggered action](../../Browse/rule/combat/triggered-action.md) to cause the soul of a dragon to emerge from this armor and hurtle toward the creature. Make the following [power roll](../../Browse/rule/dice/power-roll.md) against the creature.
...
**Blood Bargain:** As a maneuver, you can harm yourself with the weapon, taking 1d6 damage that can't be reduced in any way. An ally within 5 squares can then spend a [Recovery](../../Browse/rule/health/recoveries.md).
...
>
> | **[Melee](../../Browse/rule/combat/melee.md), [Strike](../../Browse/rule/combat/strike.md), Weapon** | **Free [triggered](../../Browse/rule/combat/triggered-action.md)** |
> |---------------------------|-------------------:|
...
| Enchantment   | [Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md)                                               | [Project Source](../../Browse/rule/downtime/project-source.md) Language |
|---------------|-----------------------------------------------------------------|-------------------------|
...
**Chilling III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 9 cold damage and is [slowed](../../Browse/condition/slowed.md) (save ends). This replaces the benefit of Chilling II.

**Disrupting III:** Whenever you damage an undead using this weapon and leave that undead with 50 [Stamina](../../Browse/rule/health/stamina.md) or less, they immediately drop to 0 [Stamina](../../Browse/rule/health/stamina.md). If you instead leave the undead with 100 [Stamina](../../Browse/rule/health/stamina.md) or less, they are [frightened](../../Browse/condition/frightened.md) (save ends). This replaces the benefit of Disrupting II.

**Draining:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [weakened](../../Browse/condition/weakened.md) (save ends). Each time you weaken a creature with this weapon, you gain 1 [surge](../../Browse/rule/resource/surge.md).
...
**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or knowledge related to the subject you wish to research

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md)

**Project Goal:** Varies (see the table)

If you want to track the location of a lost treasure, decipher a ritual, or trace the lineage of a royal family to find the next heir to the throne, you can start a downtime project to delve into whatever mysteries you seek to unravel. You might start a project to discover lore because the information can't be discovered through a single [test](../../Browse/rule/test/test.md), or you could do so because you failed a [test](../../Browse/rule/test/test.md) to recall information and now want to learn it through research.

When you start a downtime project to discover lore, you choose the lore you want investigated and the questions you want answered. The Director tells you if the lore you seek amounts to common, obscure, lost, or forbidden knowledge. The more esoteric the knowledge, the more [project points](../../Browse/rule/downtime/project-points.md) are required to find the answers you seek.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Special
...
| d10 | Event                                                                                                                                                                                                                                                                                                                                                                                                                 |
|-----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | Before the roll, an old colleague from the hero's past asks the hero to give up adventuring and come back to their former career. A hero who reaffirms their intent to remain a hero gains a [hero token](../../Browse/rule/resource/hero-token.md). However, if they do so—or if they lie to say they will return to their old career—the project goal increases by 50 points as their old colleague refuses to help them.                                       |
| 2   | After the roll, the hero is hurt on the job. They end the [respite](../../Browse/rule/resource/respite.md) with 1 fewer [Recoveries](../../Browse/rule/health/recoveries.md) than usual.                                                                                                                                                                                                                                                                                                                 |
| 3   | Before the roll, the hero stumbles upon an individual seeking guidance about entering the same career as the hero. If the hero forgoes their [project roll](../../Browse/rule/downtime/project-roll.md) to help this [NPC](../../Browse/rule/general/npc.md), the individual becomes one of the hero's [followers](../../Browse/rule/general/follower.md), which they gain in addition to any [followers](../../Browse/rule/general/follower.md) acquired through [Renown](../../Browse/rule/resource/renown.md) or other means. The [follower](../../Browse/rule/general/follower.md) is an artisan or a sage depending on the hero's career, as the Director determines. |
| 4   | After the roll, the hero finds inspiration from their old life that helps out with a different project they or another hero are currently working on. The hero working on the second project can immediately make a [project roll](../../Browse/rule/downtime/project-roll.md) for that project.                                                                                                                                                                    |
| 5   | Before the roll, the hero stumbles into a negative aspect of their career that they forgot was particularly grueling. If the [project roll](../../Browse/rule/downtime/project-roll.md) is 11 or lower, it is halved.                                                                                                                                                                                                                                               |
...
| 7   | Before the roll, a vaguely familiar stranger in the same career asks if they can work with the hero on their project. If the hero accepts their help, the stranger makes one [project roll](../../Browse/rule/downtime/project-roll.md) for the project with a +2 modifier. Only afterward does the hero learn whether the stranger supports their motivation for working on the project or whether they work for the campaign's villain.                           |
...
| 9   | Before the roll, the hero stumbles upon an old memento from when they worked their former career. They can choose between gaining an automatic breakthrough on the [project roll](../../Browse/rule/downtime/project-roll.md) or gaining a [hero token](../../Browse/rule/resource/hero-token.md).                                                                                                                                                                                                              |
| 10  | After the roll, the hero gets back into the rhythm of their former career. They can make two additional [project rolls](../../Browse/rule/downtime/project-roll.md).                                                                                                                                                                                                                                                                                                |
...
**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 240 if your career granted you two skills, or 360 if your career granted you three skills

You revisit your previous life to freshen up on the experience it provided you. When this project is complete, you gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made using the skills provided by your career.

#### Learn From a Master {data-scc="mcdm.heroes.v1/project/learn-from-a-master"}

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** None

**[Project Source](../../Browse/rule/downtime/project-source.md):** An [NPC](../../Browse/rule/general/npc.md) of a higher level, or records of such an [NPC](../../Browse/rule/general/npc.md)'s teachings in a language you know

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** Your highest [characteristic](../../Browse/rule/character/characteristic.md)
...
| d10 | Event                                                                                                                                                                                                                                                                                                                                                           |
|-----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | After the roll, the hero experiences a revelation and all their training snaps into place. The hero makes two additional [project rolls](../../Browse/rule/downtime/project-roll.md) for this project.                                                                                                                                                                                                        |
...
| 3   | they are less adept at the teaching of that knowledge. The project requires an additional 50 [project points](../../Browse/rule/downtime/project-points.md) to complete.                                                                                                                                                                                                                                        |
| 4   | Before the roll, the master requires the hero's aid with manual labor before their training can begin. The hero must spend this [respite](../../Browse/rule/resource/respite.md) completing that labor, earning a [hero token](../../Browse/rule/resource/hero-token.md) for their efforts instead of making a [project roll](../../Browse/rule/downtime/project-roll.md).                                                                                                                         |
| 5   | Before the roll, the hero must undertake the master's grueling training regimen. The hero rolls an additional d10 for the [project roll](../../Browse/rule/downtime/project-roll.md) during this [respite](../../Browse/rule/resource/respite.md), but at the end of the [respite](../../Browse/rule/resource/respite.md), they regain 1 fewer [Recoveries](../../Browse/rule/health/recoveries.md) than usual.                                                                                                                           |
...
| 8   | After the roll, an accident, fire, or other natural disaster disrupts the hero's training. The [project points](../../Browse/rule/downtime/project-points.md) rolled for this [respite](../../Browse/rule/resource/respite.md) are halved, but if the hero acts to stop the disaster, their heroism sees them earn 1 [Renown](../../Browse/rule/resource/renown.md).                                                                                                                             |
| 9   | After the roll, the master gifts the hero with an [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md) for a [crafting project](../../Browse/rule/downtime/crafting-project.md).                                                                                                                                                                                                                                                                     |
...
You gain one [signature ability](../../Browse/rule/combat/signature-ability.md) of your choice from the master's class (gaining a second [signature ability](../../Browse/rule/combat/signature-ability.md) if the master is of the same class as you). If the master is a [tactician](../../Browse/class/tactician.md), you can gain the [Strike Now](../../Browse/feature/ability/tactician/level-1/strike-now.md) ability instead. You can't gain this benefit again for the same class.
...
You learn to use one of your [heroic abilities](../../Browse/rule/general/heroic-ability.md) more efficiently, reducing its baseline [Heroic Resource](../../Browse/rule/resource/heroic-resource.md) cost by 1 (to a minimum of 1). An ability can only be improved this way once.

#### Learn New Language {data-scc="mcdm.heroes.v1/project/learn-new-language"}

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** None

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or instruction that teaches the language you want to learn

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 120

When you start this project, choose a language taught by the [project source](../../Browse/rule/downtime/project-source.md). When the project is complete, you understand the language.

#### Learn New Skill {data-scc="mcdm.heroes.v1/project/learn-new-skill"}

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** None

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or instruction that teaches the skill you want to learn

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 120

When you start this project, choose a skill taught by the [project source](../../Browse/rule/downtime/project-source.md). When the project is complete, you have that skill.

#### Perfect New Recipe {data-scc="mcdm.heroes.v1/project/perfect-new-recipe"}

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Varies

**[Project Source](../../Browse/rule/downtime/project-source.md):** A recipe in a language you know, or someone who can tutor you in that recipe
...
A creature who eats a serving of food from a particular type of recipe gains one of the following benefits, which lasts until the creature takes another [respite](../../Browse/rule/resource/respite.md).
...
| Type of Recipe  | [Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md)                                                     | Benefits           |
|-----------------|-----------------------------------------------------------------------|--------------------|
...
**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** Varies

**Project Goal:** 75

When you start this project, you must be in a settlement or other location where people gather, and you must be in that same place each time you make a [project roll](../../Browse/rule/downtime/project-roll.md) for the project. You can undertake several Community Service projects at the same time, but each one must be in a different community.

While undertaking this project, you provide help to people in need, doing odd jobs, tutoring life skills, cleaning streets or public spaces, finding lost valuables, and the like. The Director determines the [characteristic](../../Browse/rule/character/characteristic.md) that applies to the [project roll](../../Browse/rule/downtime/project-roll.md) based on the activities you undertake. When you complete this project, you receive a random [consumable](../../Browse/rule/treasure/consumable.md) treasure of the Director's choice from someone in the community as thanks for your hard work.
...
Whether for sustenance, relaxation, or bragging rights, you've gone fishing, provided you are near a body of water. The [project roll](../../Browse/rule/downtime/project-roll.md) for this project has the following changes:

- The [project points](../../Browse/rule/downtime/project-points.md) earned by your roll represent the relative size of the fish (or some other fishlike creature) you catch.
- During each [respite](../../Browse/rule/resource/respite.md) when you undertake this activity, you continue making [project rolls](../../Browse/rule/downtime/project-roll.md) until you obtain a tier 1 outcome (indicating that a fish got away, earning you no points) or a breakthrough.
- When you obtain a breakthrough, the Director rolls on the Fishing Events table rather than you gaining points from the roll and making another [project roll](../../Browse/rule/downtime/project-roll.md).
- When you've made your last Fishing [project roll](../../Browse/rule/downtime/project-roll.md) for the [respite](../../Browse/rule/resource/respite.md), you can spend the [project points](../../Browse/rule/downtime/project-points.md) you accrued on a reward from the Tackle table. Any points you don't spend during the current [respite](../../Browse/rule/resource/respite.md) are lost.

##### Tackle Table

| Reward                  | Cost | Effect                                                                                                                                                                                                                                                                                                                                                                                                    |
|-------------------------|------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Hearty meal (1 serving) | 50   | A creature who eats a serving of a meal prepared with the fish caught during the project increases their [Recoveries](../../Browse/rule/health/recoveries.md) by 1 until the end of their next [respite](../../Browse/rule/resource/respite.md). A creature can benefit from only one serving of this meal or another like it (such as from the Perfect New Recipe project) at a time.                                                                                                       |
| Great meal (1 serving)  | 100  | A creature who eats a serving of a meal prepared with the fish caught during the project increases their [Recoveries](../../Browse/rule/health/recoveries.md) by 1 until the end of their next [respite](../../Browse/rule/resource/respite.md), and gains 10 [temporary Stamina](../../Browse/rule/health/temporary-stamina.md) that lasts until the end of their next [respite](../../Browse/rule/resource/respite.md) if it isn't lost first. A creature can benefit only from one serving of this meal or another like it (such as from the Perfect New Recipe project) at a time. |
| Better tackle           | 120  | You gain the following title and benefit. <br/>**Angler:** You gain an [edge](../../Browse/rule/dice/edge.md) on Fishing [project rolls](../../Browse/rule/downtime/project-roll.md).                                                                                                                                                                                                                                                                                                     |
| Fishing event           | 200  | You roll on the Fishing Events table.                                                                                                                                                                                                                                                                                                                                                                     |
| Legendary fisher        | 300  | You gain the following title and benefit. <br/>**Goldenrod:** Each time you undertake the Fishing project, you can reroll one [project roll](../../Browse/rule/downtime/project-roll.md).                                                                                                                                                                                                                                                               |
...
| 2   | While fishing, the hero reels in a note in a bottle. The note is written in Anjali and binds the reader into a deal with a powerful [devil](../../Browse/ancestry/devil.md) if read out loud. This gives the [devil](../../Browse/ancestry/devil.md) ownership of the reader's soul in exchange for rolling an additional d10 on all future Fishing [project rolls](../../Browse/rule/downtime/project-roll.md).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
You revitalize your spirit by spending time with people you love who you haven't seen in a long while. You must be able to communicate with those people to undertake this project or make [project rolls](../../Browse/rule/downtime/project-roll.md) for it. When you complete this project, your [Stamina](../../Browse/rule/health/stamina.md) maximum increases by 12 + your level until the end of your next [respite](../../Browse/rule/resource/respite.md), and you can't start another Spend Time With Loved Ones project for a month.

###### Spend Time With Loved Ones Events Table

| d10 | Event                                                                                                                                                                                                                                                                                                                                                                           |
|-----|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1   | Before the roll, the hero is presented with an heirloom, artifact, or secret that aids another project they've undertaken or want to undertake. They can immediately make a [project roll](../../Browse/rule/downtime/project-roll.md) for that project as well as for this one.                                                                                                                                              |
| 2   | Before the roll, the hero's people embrace their loved one's companions as their own. Additional party members can make one [project roll](../../Browse/rule/downtime/project-roll.md) each for this project without doing so as a [respite](../../Browse/rule/resource/respite.md) activity. When the project is completed, each character who contributed a [project roll](../../Browse/rule/downtime/project-roll.md) gains the benefit of completion.                                                            |
...
| 5   | After the roll, a loved one gives the hero a [consumable](../../Browse/rule/treasure/consumable.md) treasure to aid them in their travels.                                                                                                                                                                                                                                                                                  |
...
| 7   | Before the roll, the hero meets an old friend who is a more experienced adventurer. They offer to mentor the hero in exchange for a treasure or favor. If the hero accepts, they also complete the Learn From a Master project when this project is complete, with the Director choosing the [NPC](../../Browse/rule/general/npc.md)'s class.                                                                       |
...
| 9   | After the roll, the hero learns that spending time with loved ones isn't always as rejuvenating as one hopes. Completing the project requires an additional 20 [project points](../../Browse/rule/downtime/project-points.md) thanks to difficult friends or relatives.                                                                                                                                                         |
| 10  | Before the roll, the hero's loved ones ask if the hero would like to cook with them. If the hero accepts, they can apply their [project roll](../../Browse/rule/downtime/project-roll.md) both to this project and to the Perfect New Recipe project. If the hero is not currently undertaking the Perfect New Recipe project, they start that project and their loved ones provide the [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md) and [project source](../../Browse/rule/downtime/project-source.md). |
