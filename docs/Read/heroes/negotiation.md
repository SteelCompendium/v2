...
The Director typically assumes that the underlying potential for events to [turn](../../Browse/rule/combat/turn.md) violent is already factored into every negotiation. However, if the heroes decide to bring that threat to the forefront, then they've exited the realm of negotiation and have entered into a different type of relationship—and it's probably time to draw steel.
...
Pitfalls and [motivations](../../Browse/rule/negotiation/motivation.md) are two sides of the same concept. They're presented below as a single list, because what might be a [motivation](../../Browse/rule/negotiation/motivation.md) for one [NPC](../../Browse/rule/general/npc.md) is a pitfall for another. Whenever the heroes make an argument, they risk stumbling into one of an [NPC](../../Browse/rule/general/npc.md)'s pitfalls unless they do their research beforehand or read the [NPC](../../Browse/rule/general/npc.md) well.
...
An [NPC](../../Browse/rule/general/npc.md) with the [benevolence](../../Browse/negotiation/benevolence.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) has a cynical view of the world, believing that no creature has a right to anything just by being alive. The idea of helping others because it's the right thing to do is a preposterous, immature, or inexperienced idea to be laughed off or snuffed out.

Arguments that appeal to a [benevolence](../../Browse/negotiation/benevolence.md) [motivation](../../Browse/rule/negotiation/motivation.md) contend that if the [NPC](../../Browse/rule/general/npc.md) strikes a deal with the heroes, the people the [NPC](../../Browse/rule/general/npc.md) cares about will benefit from the deal. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [discovery](../../Browse/negotiation/discovery.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) has no [interest](../../Browse/rule/negotiation/interest.md) in finding new places, peoples, or ideas. It might be that the unknown scares them or makes them so uncomfortable that they'd rather remain ignorant. Alternatively, a previous pursuit of discovery might have turned out poorly for them.

Arguments that appeal to a [discovery](../../Browse/negotiation/discovery.md) [motivation](../../Browse/rule/negotiation/motivation.md) contend that striking a deal with the heroes will allow the [NPC](../../Browse/rule/general/npc.md) to gain new knowledge or acquire unique property. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [freedom](../../Browse/negotiation/freedom.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) believes that a world without authority is one in turmoil and chaos. They might even believe that they are the right person to rule, and that their ideals should be the ones that become the law of the land.

Arguments that appeal to a freedom [motivation](../../Browse/rule/negotiation/motivation.md) contend that by helping the heroes, an [NPC](../../Browse/rule/general/npc.md) will maintain or grant freedom to themself or other people. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [greed](../../Browse/negotiation/greed.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) has no [interest](../../Browse/rule/negotiation/interest.md) in accumulating wealth or other resources, and becomes offended if anyone tries to buy their partnership. They hold their ideals above material desires.

Arguments that appeal to a greed [motivation](../../Browse/rule/negotiation/motivation.md) contend that helping the heroes will increase the [NPC](../../Browse/rule/general/npc.md)'s wealth or assets. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [justice](../../Browse/negotiation/justice.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) doesn't believe that the timescape is an inherently just place, and has no [interest](../../Browse/rule/negotiation/interest.md) in making it one. The world is eternal conflict, there is no such thing as justice, and anyone who thinks otherwise is a naive fool.

Arguments that appeal to a justice [motivation](../../Browse/rule/negotiation/motivation.md) position the heroes on the good side of an [NPC](../../Browse/rule/general/npc.md)'s sense of right and wrong. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with a [legacy](../../Browse/negotiation/legacy.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) cares nothing about leaving a personal mark on the world. To them, such vain thinking is nothing but a waste of time.

Arguments that appeal to a [legacy](../../Browse/negotiation/legacy.md) [motivation](../../Browse/rule/negotiation/motivation.md) contend that striking a deal with the heroes increases the likelihood that people will talk about the [NPC](../../Browse/rule/general/npc.md) for centuries to come. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [peace](../../Browse/negotiation/peace.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) hates being bored. They want excitement, drama, and danger in their life. For them, there's nothing worse than the status quo.

Arguments that appeal to a peace [motivation](../../Browse/rule/negotiation/motivation.md) contend that helping the heroes will earn the [NPC](../../Browse/rule/general/npc.md) some peace, at least for a little while. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [power](../../Browse/negotiation/power.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) has no [interest](../../Browse/rule/negotiation/interest.md) in authority for themself. They might respect the authority of others, but they hate the thought of ruling over other people and roundly reject any suggestion of the idea.

Arguments that appeal to a power [motivation](../../Browse/rule/negotiation/motivation.md) contend that working with the heroes will increase or protect the [NPC](../../Browse/rule/general/npc.md)'s power. Example arguments include the following:
...
their charge safe is a duty they hold dear, and aiding in that protection earns their favor. Most people have friends or family they wish to protect, but an [NPC](../../Browse/rule/general/npc.md) with the [protection](../../Browse/negotiation/protection.md) [motivation](../../Browse/rule/negotiation/motivation.md) believes in doing so at any cost.

An [NPC](../../Browse/rule/general/npc.md) with the [protection](../../Browse/negotiation/protection.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) is happy to leave others to fend for themselves. They don't believe it's their responsibility to protect anyone other than themself, and might be outright disgusted at the thought of risking their life or their property to protect others.

Arguments that appeal to a protection [motivation](../../Browse/rule/negotiation/motivation.md) contend that helping the heroes allows an [NPC](../../Browse/rule/general/npc.md) to better protect their charge. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [revelry](../../Browse/negotiation/revelry.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) sees social encounters and hedonism as a waste of time. They take pleasure only in work or in building their own skills and character. Others who suggest immature debauchery are not worth their time.

Arguments that appeal to the [revelry](../../Browse/negotiation/revelry.md) [motivation](../../Browse/rule/negotiation/motivation.md) contend that striking a deal with the heroes will allow the [NPC](../../Browse/rule/general/npc.md) to get back to reveling sooner, longer, or harder. Example arguments include the following:
...
An [NPC](../../Browse/rule/general/npc.md) with the [vengeance](../../Browse/negotiation/vengeance.md) [pitfall](../../Browse/rule/negotiation/pitfall.md) believes that revenge solves nothing. They might have gained this belief firsthand, or they might simply not have the ambition to seek revenge—and they take a dim view of others who do.

Arguments that appeal to the [vengeance](../../Browse/negotiation/vengeance.md) [motivation](../../Browse/rule/negotiation/motivation.md) contend that the [NPC](../../Browse/rule/general/npc.md) can gain payback for their pain by helping the heroes. Example arguments include the following:
...
- **≤11:** The hero learns no information regarding the [NPC](../../Browse/rule/general/npc.md)'s [motivations](../../Browse/rule/negotiation/motivation.md) or [pitfalls](../../Browse/rule/negotiation/pitfall.md), and the [NPC](../../Browse/rule/general/npc.md) realizes the hero is trying to read them and becomes annoyed. As a consequence, the [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) is reduced by 1.
- **12-16:** The hero learns no information regarding the [NPC](../../Browse/rule/general/npc.md)'s [motivations](../../Browse/rule/negotiation/motivation.md) or [pitfalls](../../Browse/rule/negotiation/pitfall.md).
- **17+:** The hero learns one of the [NPC](../../Browse/rule/general/npc.md)'s [motivations](../../Browse/rule/negotiation/motivation.md) or [pitfalls](../../Browse/rule/negotiation/pitfall.md) (their choice).

After this [test](../../Browse/rule/test/test.md) is made, the heroes can't make another [test](../../Browse/rule/test/test.md) to determine the same [NPC](../../Browse/rule/general/npc.md)'s [motivations](../../Browse/rule/negotiation/motivation.md) or [pitfalls](../../Browse/rule/negotiation/pitfall.md) until they make an argument to the [NPC](../../Browse/rule/general/npc.md) or the negotiation ends.
...
- **≤11:** The [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) decreases by 1.
- **12-16:** The [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) increases by 1, and their [patience](../../Browse/rule/negotiation/patience.md) decreases by 1.
- **17+:** The [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) increases by 1, and their [patience](../../Browse/rule/negotiation/patience.md) doesn't change.
...
If the heroes attempt to appeal to a [motivation](../../Browse/rule/negotiation/motivation.md) that's already been appealed to, the [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) remains the same and their [patience](../../Browse/rule/negotiation/patience.md) decreases by 1.

> **Appealing to Multiple [Motivations](../../Browse/rule/negotiation/motivation.md)**
>
...
- **≤11:** The [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) decreases by 1, and their [interest](../../Browse/rule/negotiation/interest.md) decreases by 1.
- **12-16:** The [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) decreases by 1.
- **17+:** The [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) increases by 1, and their [patience](../../Browse/rule/negotiation/patience.md) decreases by 1.

**Effect:** On a [natural 19 or 20](../../Browse/rule/dice/natural-19-20.md), the [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) remains the same.
...
- An [NPC](../../Browse/rule/general/npc.md) responds positively if the heroes increase the [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md). "That's an excellent point." "You've given me much to consider." "Fair enough." "Makes sense to me."
- An [NPC](../../Browse/rule/general/npc.md) responds negatively if the heroes decrease their [interest](../../Browse/rule/negotiation/interest.md). "I don't buy that." "Poppycock!" "I hear you, but I disagree." "That's not going to sway me."
- An [NPC](../../Browse/rule/general/npc.md) responds with im[patience](../../Browse/rule/negotiation/patience.md) if the heroes fail to increase or decrease their [interest](../../Browse/rule/negotiation/interest.md). "I've heard that before." "Are you going to offer me anything real?" "This debate is tiresome." "BORING!"
...
It is impossible to continue a negotiation when an [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) drops to 0.

### Keep Going or Stop

If an [NPC](../../Browse/rule/general/npc.md) still has [patience](../../Browse/rule/negotiation/patience.md) after making an offer and their [interest](../../Browse/rule/negotiation/interest.md) is between 1 and 4, the heroes can make another argument to attempt to improve the deal. Alternatively, they can accept the offer and end the negotiation. Let the players drive this decision. You can always have an [NPC](../../Browse/rule/general/npc.md) show they have [patience](../../Browse/rule/negotiation/patience.md) remaining by asking, "Is there anything else?"

If the [NPC](../../Browse/rule/general/npc.md)'s [patience](../../Browse/rule/negotiation/patience.md) is 0 or their [interest](../../Browse/rule/negotiation/interest.md) is 5, then the offer the [NPC](../../Browse/rule/general/npc.md) makes is their final offer to the characters. The heroes can accept the offer or not, but either way, the negotiation ends.

If the [NPC](../../Browse/rule/general/npc.md)'s [interest](../../Browse/rule/negotiation/interest.md) is 0, the [NPC](../../Browse/rule/general/npc.md) ends the negotiation without accepting a deal. The heroes can walk away from a negotiation without accepting a deal at any time.
...
>
> - **[Interest](../../Browse/rule/negotiation/interest.md): 2**
> - **[Patience](../../Browse/rule/negotiation/patience.md): 4**
> - **Impression: 3**
>
...
>
> **Higher Authority:** Zola has no [interest](../../Browse/rule/negotiation/interest.md) in serving anyone other than herself, and she scoffs at the suggestion of taking orders.
>
...
Before making an argument, Alyssa is attempting to learn what Zola's [motivations](../../Browse/rule/negotiation/motivation.md) are by simply asking. The Director decides to reveal one of Zola's [motivations](../../Browse/rule/negotiation/motivation.md): protection.
...
Korvo inadvertently made an argument using a [pitfall](../../Browse/rule/negotiation/pitfall.md) by appealing to a higher authority. The Director notes that Zola's [interest](../../Browse/rule/negotiation/interest.md) drops to 1 and her [patience](../../Browse/rule/negotiation/patience.md) drops to 3. Zola gave a pretty firm "No" response here, which is what an [NPC](../../Browse/rule/general/npc.md) with an [interest](../../Browse/rule/negotiation/interest.md) of 1 would say. However, the Director phrased Zola's response in such a way that the heroes know they can keep making arguments if they wish, since her [patience](../../Browse/rule/negotiation/patience.md) hasn't run out.

**James:** *Sorry! I thought that'd work. Seems like higher authority is a [pitfall](../../Browse/rule/negotiation/pitfall.md) for her*.

**Grace:** *Let's try to avoid any others. Val says, "We're sorry, Zola. We don't want to do anything else to offend you." I'd like to make an [Intuition](../../Browse/rule/character/intuition.md) [test](../../Browse/rule/test/test.md) and use my Read Person skill to gauge her reaction and try to discern any other [pitfalls](../../Browse/rule/negotiation/pitfall.md).*
...
The heroes now know both of Zola's [pitfalls](../../Browse/rule/negotiation/pitfall.md): higher authority and revelry.
...
**Director:** *I think that's a [Reason](../../Browse/rule/character/reason.md) [test](../../Browse/rule/test/test.md), since you're using logic to point out that you have a better chance together than on your own. It's easy too, since you're appealing to one of her [motivations](../../Browse/rule/negotiation/motivation.md).*
...
Because Linn appealed to a [motivation](../../Browse/rule/negotiation/motivation.md), Zola's [interest](../../Browse/rule/negotiation/interest.md) increases to 2, and her [patience](../../Browse/rule/negotiation/patience.md) drops to 2. The Director gives a "No, but..." response based on Zola's [interest](../../Browse/rule/negotiation/interest.md). At this point, the heroes haven't promised anything, so she offers them something for free.
...
**Alyssa:** *I wonder if we can try to figure out another one of her [motivations](../../Browse/rule/negotiation/motivation.md).*
...
Korvo's success has revealed Zola's benevolence [motivation](../../Browse/rule/negotiation/motivation.md).
...
**Director:** *Zola's [interest](../../Browse/rule/negotiation/interest.md) is piqued. "What makes you say that?"*
...
**Director:** *You're appealing to one of her [motivations](../../Browse/rule/negotiation/motivation.md), so make a [Presence](../../Browse/rule/character/presence.md) [test](../../Browse/rule/test/test.md).*
...
Because Jorn appealed to a [motivation](../../Browse/rule/negotiation/motivation.md), Zola's [interest](../../Browse/rule/negotiation/interest.md) increases to 3, and her [patience](../../Browse/rule/negotiation/patience.md) is reduced to 1. The Director gives a "Yes, but..." response while making it clear that the negotiation can still continue.
