...
**5th Level:** The weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, when you make an [opportunity attack](../../Browse/rule/combat/opportunity-attack.md) against an enemy of your [size](../../Browse/rule/character/size.md) or smaller, you can use [fancy footwork](../../Browse/feature/ability/Kits/swashbuckler-fancy-footwork.md) to knock them [prone](../../Browse/condition/prone.md). You also earn 1 [Renown](../../Browse/rule/resource/renown.md).
...
- *Easy Marks:* You gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made using skills from the [interpersonal](../../Browse/skill/interpersonal/index.md) and [intrigue](../../Browse/skill/intrigue/index.md) skill groups when influencing members of a community that you have saved.
...
- *Gift of Charm:* You have a skill of your choice from the [interpersonal skill group](../../Browse/skill/interpersonal/index.md).
...
When you recruit a sage, choose four skills from the [lore skill group](../../Browse/skill/lore/index.md) that they know. A sage has a [Reason](../../Browse/rule/character/reason.md) and [Intuition](../../Browse/rule/character/intuition.md) score of 1, and a 0 in all other [characteristics](../../Browse/rule/character/characteristic.md). They know Caelian and two other languages of your choice.
