...
Treasures are the [supernatural](../../Browse/rule/general/supernatural.md) items that heroes find on their adventures, or that they craft themselves to help with their heroics. You might claim a magic whip from a bandit captain or create a psionic necklace that will help you take down a dread cult.

Treasures come in all shapes and sizes, and are broken down into four types.

**[Consumables](../../Browse/rule/treasure/consumable.md)** are the most numerous treasures. These include potions, dusts, and other items that are consumed by you when you activate them. Most [consumables](../../Browse/rule/treasure/consumable.md) can be used only once!

**[Trinkets](../../Browse/rule/treasure/trinket.md)** are treasures with [supernatural](../../Browse/rule/general/supernatural.md) properties that never fade. These include magic bags, boots, cloaks, gloves, jewelry, and other oddities.

**[Leveled treasures](../../Browse/rule/treasure/leveled-treasure.md)** are treasures that become even more powerful in the hands of a higher-level hero. They connect with their user, building a bond that fuels the item's [supernatural](../../Browse/rule/general/supernatural.md) power. Armor, [implements](../../Browse/rule/treasure/implement.md), and weapons are the most common types of [leveled treasure](../../Browse/rule/treasure/leveled-treasure.md).
...
Heroes can also craft their own treasures, forging the tools they need to get the job done using the rules in Chapter 12: [Downtime Projects](downtime-projects.md). Items that can be crafted have their [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md), [project source](../../Browse/rule/downtime/project-source.md), [project roll](../../Browse/rule/downtime/project-roll.md) [characteristic](../../Browse/rule/character/characteristic.md), and project goal (the number of [project points](../../Browse/rule/downtime/project-points.md) needed to complete the project) noted in their descriptions.
...
> **Treasure [Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md)**
>
> Each treasure has an [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md) necessary for crafting it. The exact nature of many of the materials used as an item's prerequisite is left nebulous so that the Director can more easily work those materials into a campaign. What's a mindspider, and how rare is their silk? That's for the Director to decide, whether they want to drop prerequisite items into their planned adventures or craft an entire side quest around finding them.

#### Wearing Treasures

Many treasures, such as cloaks, jewelry, hats, and boots, must be worn. Unless the Director deems otherwise, these items [supernatural](../../Browse/rule/general/supernatural.md)ly resize themselves to fit the creature using them.

Wearable treasures have keywords that indicate which part of the body they are meant to adorn—Arms, Feet, Hands, Head, Neck, or Waist. The Ring keyword marks treasures typically worn on the finger. You can wear any number of treasures that have the same body keyword as long as the Director deems it reasonable. For example, it might be fine for a four-armed [time raider](../../Browse/ancestry/time-raider.md) to wear two pairs of bracers, but the Director might decide that the same hero can't benefit from wearing two magic cloaks at once. If the Director decides you're wearing too many treasures with the same body keyword, none of those treasures function.
...
Some treasures are wielded in the form of weapons or [implements](../../Browse/rule/treasure/implement.md). A weapon might have the Light Weapon, Medium Weapon, or Heavy Weapon keywords, or might have a keyword denoting a specific category of weapon (Bow, Polearm, and so forth). An [implement](../../Browse/rule/treasure/implement.md) might have the [Implement](../../Browse/rule/treasure/implement.md) keyword or a keyword denoting the type of [implement](../../Browse/rule/treasure/implement.md) (Orb, Wand, and so forth). Armor is also considered a wielded treasure, with the Light Armor, Medium Armor, or Heavy Armor keywords, or the Shield keyword.

A hero can wield as many weapons, [implements](../../Browse/rule/treasure/implement.md), suits of armor, or shields as they can feasibly hold or wear. However, an ability can benefit only from one weapon or [implement](../../Browse/rule/treasure/implement.md) at a time.

##### Treasures and Kits

To gain the benefits of a weapon or armor treasure, the treasure must have keywords that match the equipment of your kit. For instance, a hero using the [Warrior Priest](../../Browse/kit/warrior-priest.md) kit can benefit from wearing a heavy armor treasure and wielding light weapon treasures, since those are part of that kit.

If your hero doesn't use a kit, they can't gain benefits from using armor or weapon treasures unless they have a feature that says otherwise, such as the [conduit's](../../Browse/class/conduit.md) Prayer of Soldier's Skill.

A weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) only adds to [melee](../../Browse/rule/combat/melee.md) abilities if your kit has a [melee](../../Browse/rule/combat/melee.md) damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). A weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) only adds to [ranged](../../Browse/rule/combat/ranged.md) abilities if your kit has a [ranged](../../Browse/rule/combat/ranged.md) damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md).

#### Magic and Psionic Treasures

The Magic and Psionic keywords for treasures refer to how those treasures are created, not how they are used. Just as magic potions and swords aren't limited only to characters who wield magic themselves, the Magic and Psionic keywords don't restrict the use of treasures to only certain types of characters, so that an [implement](../../Browse/rule/treasure/implement.md) with the Magic keyword can be used to enhance abilities with the Psionic keyword, and vice versa. Treasures that have the Magic or Psionic keyword and are used to enhance an ability don't add those keywords to the ability.
...
>
> [Recoveries](../../Browse/rule/health/recoveries.md), [respites](../../Browse/rule/resource/respite.md), [Victories](../../Browse/rule/resource/victories.md): Chapter 1: [The Basics](the-basics.md)
>
> Languages: Chapter 4: [Background](background.md)
>
> Abilities, [conditions](../../Browse/rule/combat/condition.md), [potencies](../../Browse/rule/character/potency.md), [surges](../../Browse/rule/resource/surge.md): Chapter 5: [Classes](classes.md)
>
> Skills, [tests](../../Browse/rule/test/test.md): Chapter 9: [Tests](tests.md)
>
> Item creation rules, crafting and [research projects](../../Browse/rule/downtime/research-project.md): Chapter 12: [Downtime Projects](downtime-projects.md)
>
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Three vials of black ash from the College of Black Ash

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Szetch

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Agility](../../Browse/rule/character/agility.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 45 (yields 1d3 darts, or three darts if crafted by a shadow)

**Effect:** As a maneuver, you make a [ranged](../../Browse/rule/combat/ranged.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) using a black ash dart. The [strike](../../Browse/rule/combat/strike.md) deals an extra 1 damage and adds the following effects to the [tier outcomes](../../Browse/rule/dice/tier-outcome.md) of the [power roll](../../Browse/rule/dice/power-roll.md):
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A ruby purloined from a vampire

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Proto-Ctholl

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Agility](../../Browse/rule/character/agility.md) or [Reason](../../Browse/rule/character/reason.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of demon honey

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Kalliak

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Intuition](../../Browse/rule/character/intuition.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of witherite crystal

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Caelian
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One vial of fire giant blood
...
**Effect:** As a maneuver, you coat a weapon in this oil and ignite it. The weapon burns persistently and without harming itself until it is extinguished as a maneuver. Whenever you use a weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using a weapon that is ignited this way, the ability deals an extra 2 fire damage.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A half-pound of seagrass
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of costmary leaves
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One imp's tongue
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A leftover carcass of a lachomp meal
...
**Effect:** As a maneuver, you attach a lachomp tooth to a weapon, allowing that weapon to [supernatural](../../Browse/rule/general/supernatural.md)ly flicker in and out of reality. Your next strike that uses the weapon can tear through multiple targets in a line (for a [ranged](../../Browse/rule/combat/ranged.md) [strike](../../Browse/rule/combat/strike.md)) or surrounding you (for a [melee](../../Browse/rule/combat/melee.md) [strike](../../Browse/rule/combat/strike.md)). The [strike](../../Browse/rule/combat/strike.md) adds the following effects to the [tier outcomes](../../Browse/rule/dice/tier-outcome.md) of the [power roll](../../Browse/rule/dice/power-roll.md):
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Three sheets of glass, sunbaked gold dust

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Variac
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A strip of starmetal coated in the blood of the item's crafter

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Zaliac

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md)

**Project Goal:** 45

**Effect:** When activated as a maneuver, this item erupts in a bright flash, you can [shift](../../Browse/movement/shifting.md) 1 square without your enemies noticing your movement, and a homunculus perfectly resembling you appears in an [adjacent](../../Browse/rule/combat/adjacent.md) space. The homunculus is a creature with [Stamina](../../Browse/rule/health/stamina.md) 15, a 0 in all their [characteristics](../../Browse/rule/character/characteristic.md), and a [speed](../../Browse/rule/character/speed.md) and [stability](../../Browse/rule/character/stability.md) equal to yours. They appear indistinguishable from you but can't use any abilities.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A cup of rainwater from a sacred fey grove, plus an optional prerequisite (see below)
...
**Effect:** As a maneuver, you throw this delicate glass sphere up to 5 squares, breaking it and creating a 4 [cube](../../Browse/rule/combat/cube.md) of fog. The fog dissipates after 10 minutes or if a strong gust of wind created by a storm or magic passes through the area.

Enterprising mages within various thieves' guilds have developed variations of the Portable Cloud. Each variation has a secondary [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md) and a project goal of 45.

**Noxious Cloud:** Filled with a green or putrid yellow haze, this sphere spreads a choking, foul-smelling mist when broken. Each creature who enters the cloud for the first time in a [combat round](../../Browse/rule/combat/combat-round.md) or starts their turn there takes 5 poison damage. Additionally, any creature is [weakened](../../Browse/condition/weakened.md) while in the fog.

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of undead flesh. **Thunderhead Cloud:** Small lightning bolts arc around the black cloud in this sphere, which creates a 3 [cube](../../Browse/rule/combat/cube.md) of cloud and lightning when broken. Each creature who enters the cloud for the first time in a [combat round](../../Browse/rule/combat/combat-round.md) or starts their turn there takes 5 lightning damage. Additionally, any creature is [slowed](../../Browse/condition/slowed.md) while in the cloud.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The roots of a just-budded nightshade
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Fifty snapdragon seeds

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Yllyric
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The breath of a mystic sage captured at sunrise

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Hyrallic

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Intuition](../../Browse/rule/character/intuition.md) or [Presence](../../Browse/rule/character/presence.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One vial of pure bovine essence
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A chocolate made by a gnome confectioner
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of sap from a tree damaged by psionic fire
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Several strands of hag hair

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Khelt
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A cup of algae from glacial water
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A sheet of paper infused with the dust of a painite

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in the First Language

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Intuition](../../Browse/rule/character/intuition.md) or [Presence](../../Browse/rule/character/presence.md)

**Project Goal:** 90

**Effect:** As a [respite](../../Browse/rule/resource/respite.md) activity, you repeatedly chant the contents of this scroll over the remains of a creature who has been dead for less than 1 year. The creature's soul must be willing to return to life for the scroll to work. If they are not willing, you instinctively understand that as you start the [respite](../../Browse/rule/resource/respite.md) activity and can cease it immediately. The scroll is not consumed, and you can undertake a new [respite](../../Browse/rule/resource/respite.md) activity.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A shard of prismacore, an ounce of ferrous metal
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A signed agreement with a ghost, a large obsidian disk

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Anjali
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A grub steeped in voiceless talker bile

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Variac

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md) or [Intuition](../../Browse/rule/character/intuition.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A month's lifespan from the creator or another willing creature, ground sapphire
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One vial of archdevil's blood, an expired contract
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A brief period of contact with the creature the effigy is tied to

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Khemharic
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of scrapings from a coven's used cauldron

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts in Anjali
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A time crystal

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Voll

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 180

**Effect:** As a maneuver, you make a [ranged](../../Browse/rule/combat/ranged.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) using the Timesplitter, which shatters upon impact. The [strike](../../Browse/rule/combat/strike.md) deals an extra 1d6 psychic damage and adds the following effects to the [tier outcomes](../../Browse/rule/dice/tier-outcome.md) of the [power roll](../../Browse/rule/dice/power-roll.md):
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A small quartz
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of troll's blood, raw honey
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The captured breath of a god, an ounce of condensed dreams
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of the blood of Saint Elspeth

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Caelian

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Presence](../../Browse/rule/character/presence.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One vial of sacred ink, blessed parchment

**[Project Source](../../Browse/rule/downtime/project-source.md):** Reference materials in the First Language from the
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A year's lifespan from the creator or another willing creature, the laughter of a young hero

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Khelt

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Presence](../../Browse/rule/character/presence.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A pint of blue ichor, soul chalk

**[Project Source](../../Browse/rule/downtime/project-source.md):** Licensing agreements in Anjali
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A pint of red ichor, soul chalk
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A pint of yellow ichor, soul chalk
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One humanoid femur, one bar of lead laced with starmetal
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Petrified wood from a tree that has not been observed since falling
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Three withered mundane vines, a tree's blessing

**[Project Source](../../Browse/rule/downtime/project-source.md):** Songs in Yllyric
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A humanoid's shadow disconnected from its source
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Ten gecko tails
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One broken contract, one ingot of steel

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Anjali and Caelian

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md) or [Reason](../../Browse/rule/character/reason.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One used death shroud
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One uncut opal
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One battered gold chain of at least fifty links
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A giant's tooth

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in High Kuric
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An eyeball from a pirate captain who drowned at sea
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One measure of pure crystal, a jarred memory of true joy
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The finger bone of a creature with telepathy, three black opals

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Ullorvic
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The gold nib of a fountain pen used to sign a major treaty or compact, a ruby once worn by a [devil](../../Browse/ancestry/devil.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A gallon of swamp water, the limbs of four different newts
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A piece of polished obsidian, seven flawless pea-sized diamonds
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A coin minted during an earthquake
...
- **1-Red:** The area within 2 squares of you is [difficult terrain](../../Browse/movement/difficult-terrain.md) for enemies until the end of your next [turn](../../Browse/rule/combat/turn.md).
- **2-Green:** You and each ally who starts their [turn](../../Browse/rule/combat/turn.md) within 2 squares of you gains a +1 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [speed](../../Browse/rule/character/speed.md) until the end of your next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The severed hand of a giant
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An overmind egg, the skin of any shapeshifter
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A spool of mindspider silk, an ingot of white gold

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Higaran

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**Effect:** While wearing the Mirage Band, you automatically perceive illusions for what they are, you can see invisible creatures, and [supernatural](../../Browse/rule/general/supernatural.md) effects can't conceal creatures and objects from you.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A wafer of gallium arsenide

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Mindspeech
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One-third of a pound of diamond dust, one nugget of pure silver
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The powdered jawbone of a powerful spellcaster, wood from a tree marking multiple graves
...
**Effect:** The Gravekeeper's Lantern can temporarily trap a nonhostile spirit of the dead—either an incorporeal undead or the wandering spirit of a creature who died within the last 30 days—allowing you to interrogate them. Trapping a spirit requires you to be within 10 squares of them and succeed on a hard [Intuition](../../Browse/rule/character/intuition.md) [test](../../Browse/rule/test/test.md) as a main action. Once a spirit is trapped, you make a [Presence](../../Browse/rule/character/presence.md) [test](../../Browse/rule/test/test.md) to coax them into answering your questions:
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Steel alloy, one fine-cut topaz

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Mindspeech

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Agility](../../Browse/rule/character/agility.md) or [Presence](../../Browse/rule/character/presence.md)
...
It's fine to own or possess more than three [leveled treasures](../../Browse/rule/treasure/leveled-treasure.md), as long as the extras are stored away or in the possession of other creatures. But if you carry more than three [leveled treasures](../../Browse/rule/treasure/leveled-treasure.md), you must make a [Presence](../../Browse/rule/character/presence.md) [test](../../Browse/rule/test/test.md) during each [respite](../../Browse/rule/resource/respite.md):

- **≤11:** One of your [leveled treasures](../../Browse/rule/treasure/leveled-treasure.md) (chosen by the Director) grabs hold of your psyche. It forces you to sleepwalk or otherwise enter an active fugue state and discard the rest of your [leveled treasures](../../Browse/rule/treasure/leveled-treasure.md) in locations you can't remember. If you want those items back, you'd better get looking before someone else finds them.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Five rabid honey badger pelts, the quills of a hedgehog
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md), and you have immunity to acid and poison damage equal to your highest [characteristic](../../Browse/rule/character/characteristic.md) score.

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12. Additionally, whenever an [adjacent](../../Browse/rule/combat/adjacent.md) creature deals damage to you, they take 3 acid or poison damage (your choice).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A set of wings from a [flying](../../Browse/movement/fly.md) carp, a set of chain mail rusted by seawater
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md), you can automatically swim at full [speed](../../Browse/rule/character/speed.md) while moving, and you can breathe underwater for up to 1 hour. Returning to the surface to breathe air again for any length of time reset's the armor's water-breathing benefit.

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12, and you have cold immunity 5. Additionally, whenever you fall, you can extend your arms (no action required) to unfurl a thick membrane between your arms and your body, slowing your fall and allowing you to glide. While gliding this way, you move downward at 1 square per round, and you can glide up to 6 squares horizontally as a [free maneuver](../../Browse/rule/combat/free-maneuver.md) once during each of your [turns](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A giant scarab beetle carapace

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Phaedran

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md), [Reason](../../Browse/rule/character/reason.md), or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** While you wear this armor, you gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) and you can [fly](../../Browse/movement/fly.md). If you don't end your turn on the ground, you fall.

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12. Additionally, you no longer need to end your turn on the ground to avoid falling.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A ballad of heroism, two ingots of sunmetal

**[Project Source](../../Browse/rule/downtime/project-source.md):** Songs in High Rhyvian

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Reason](../../Browse/rule/character/reason.md), [Intuition](../../Browse/rule/character/intuition.md), or [Presence](../../Browse/rule/character/presence.md)
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The eyes of a [time raider](../../Browse/ancestry/time-raider.md) who died valiantly in battle
...
**1st Level:** You gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) while you wear this armor. Additionally, whenever a creature within 5 squares deals damage to you, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to capture a moment of time in the armor, making that creature [slowed](../../Browse/condition/slowed.md) until the end of their next [turn](../../Browse/rule/combat/turn.md).

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12. Additionally, when you capture a moment of time in the armor, the triggering creature also takes corruption damage equal to twice your highest [characteristic](../../Browse/rule/character/characteristic.md) score.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Ten pages from each of a hundred different books
...
**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12, and when you return to your true form, you are [dazed](../../Browse/condition/dazed.md) only until the end of your next [turn](../../Browse/rule/combat/turn.md). Additionally, while you are paper thin, you can use a maneuver to wrap yourself around an [adjacent](../../Browse/rule/combat/adjacent.md) target who is the same [size](../../Browse/rule/character/size.md) or smaller than you, automatically grabbing them.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The will of a deceased person with no heirs
...
**1st Level:** You gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) while you wear this armor. Additionally, you gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made to lie about or conceal your identity.

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12. Additionally, whenever you take damage, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to [teleport](../../Browse/movement/teleport.md) up to 5 squares. If you do, you create an illusion of you [dying](../../Browse/rule/health/dying.md) in your previous space, which fades at the end of your next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Ten steel gears from an ancient construct
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A large vessel of astral ice, a pint of supercooled mercury
...
**1st Level:** While you wear this armor, you gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md), but any magic ability gains an [edge](../../Browse/rule/dice/edge.md) when targeting you. Additionally, you instinctively know the location of any creature with [concealment](../../Browse/rule/combat/concealment.md) within 2 squares. You can also [turn](../../Browse/rule/combat/turn.md) invisible as a maneuver. Your invisibility ends if you take damage or use an ability, or at the end of your next [turn](../../Browse/rule/combat/turn.md).

**5th Level:** The armor's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12, you instinctively know the location of any creature with [concealment](../../Browse/rule/combat/concealment.md) within 5 squares, and your invisibility no longer ends at the end of your next [turn](../../Browse/rule/combat/turn.md). Additionally, you have psychic immunity 5.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Three ingots of steel, six crystals that resonate with psionic power
...
**1st Level:** While you wield or carry this shield, you gain a +2 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md). This [Stamina](../../Browse/rule/health/stamina.md) [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) adds to the [Stamina](../../Browse/rule/health/stamina.md) [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) granted by other treasures. Additionally, once per [turn](../../Browse/rule/combat/turn.md) when an [adjacent](../../Browse/rule/combat/adjacent.md) enemy uses an ability, you can use a free [triggered action](../../Browse/rule/combat/triggered-action.md) to use the [Grab](../../Browse/feature/common/maneuvers/grab.md) maneuver against that enemy. You can have any number of enemies [grabbed](../../Browse/condition/grabbed.md) in this way.
...
**Keywords:** [Implement](../../Browse/rule/treasure/implement.md), Magic

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A diamond ring
...
**1st Level:** While you wield this [implement](../../Browse/rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) gain a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, you gain [temporary Stamina](../../Browse/rule/health/temporary-stamina.md) equal to your highest [characteristic](../../Browse/rule/character/characteristic.md) score.

**5th Level:** The [implement](../../Browse/rule/treasure/implement.md)'s damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) using a magic or psionic ability, you can use a maneuver to create an immobile field of protection that is a 1 [cube](../../Browse/rule/combat/cube.md), around yourself or around an ally within 5 squares. While in the area, you or the chosen ally has [damage immunity](../../Browse/rule/damage/damage-immunity.md) 5. The field disappears at the start of your next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A handful of shattered quartz
...
**1st Level:** While you wield this [implement](../../Browse/rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) deal an extra 2 psychic damage. Additionally, you have [damage weakness](../../Browse/rule/damage/damage-weakness.md) 3, and you gain an [edge](../../Browse/rule/dice/edge.md) on magic or psionic abilities if you aren't at full [Stamina](../../Browse/rule/health/stamina.md), or a double [edge](../../Browse/rule/dice/edge.md) if you are [winded](../../Browse/rule/health/winded.md).

**5th Level:** The [implement](../../Browse/rule/treasure/implement.md)'s extra psychic damage increases to 3. Additionally, once per round when you take more than 20 damage from a single source, the [implement](../../Browse/rule/treasure/implement.md)'s extra damage is doubled until the end of your next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ounce of primordial ice, an ounce of mammoth-ivory shards
...
**1st Level:** While you wield this [implement](../../Browse/rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) gain a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, if you make a magic [strike](../../Browse/rule/combat/strike.md), the [strike](../../Browse/rule/combat/strike.md) must deal cold damage instead of its usual damage.

**5th Level:** The [implement](../../Browse/rule/treasure/implement.md)'s damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you use a magic or psionic ability, a whirlwind of sleet and ice whips around you, dealing 3 cold damage to each [adjacent](../../Browse/rule/combat/adjacent.md) enemy.
...
**Keywords:** [Implement](../../Browse/rule/treasure/implement.md), Psionic

**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Incense distilled from the essence of ether
...
**1st Level:** While you wield this [implement](../../Browse/rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) gain a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, they become insubstantial to you until the end of their next [turn](../../Browse/rule/combat/turn.md), allowing you to pass through them freely. While insubstantial, a creature can't make [opportunity attacks](../../Browse/rule/combat/opportunity-attack.md) against you.

**5th Level:** The [implement](../../Browse/rule/treasure/implement.md)'s damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, when you move through a creature who is insubstantial to you, you can use a free [triggered action](../../Browse/rule/combat/triggered-action.md) to deal damage to them equal to your highest [characteristic](../../Browse/rule/character/characteristic.md) score. If you do, the insubstantial effect ends immediately after you pass through the creature and into an [adjacent](../../Browse/rule/combat/adjacent.md) space outside them.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Two clear lenses carved from volcanic glass
...
**1st Level:** While you wield this [implement](../../Browse/rule/treasure/implement.md), your magic or psionic abilities that deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) gain a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) to a creature using a magic or psionic ability, you can use that creature's senses until the end of your next [turn](../../Browse/rule/combat/turn.md), allowing you to experience all they observe and to use your abilities as if you were in their space. You also benefit from your own senses at the same time.

**5th Level:** The [implement](../../Browse/rule/treasure/implement.md)'s damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, whenever you deal 20 or more [rolled damage](../../Browse/rule/damage/rolled-damage.md) with a magic or psionic ability to a creature whose senses you are using, that creature is weakend until the end of their next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Written permission from a [high elf](../../Browse/ancestry/high-elf.md) magistrate
...
**1st Level:** You can open or close the tome as a maneuver while speaking or thinking its full name. While the tome is open, it floats in an [adjacent](../../Browse/rule/combat/adjacent.md) space and flips to specific pages at your command, you gain an [edge](../../Browse/rule/dice/edge.md) on [Reason](../../Browse/rule/character/reason.md) [tests](../../Browse/rule/test/test.md) made to recall lore, and you gain a +3 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [distance](../../Browse/rule/combat/distance.md) for your [ranged](../../Browse/rule/combat/ranged.md) magic or psionic abilities.

**5th Level:** While the tome is open, the [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [distance](../../Browse/rule/combat/distance.md) for your [ranged](../../Browse/rule/combat/ranged.md) magic or psionic abilities increases to +5. Additionally, when you or a creature you have [line of effect](../../Browse/rule/combat/line-of-effect.md) to uses a magic or psionic ability, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to grant a +3 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to the [power roll](../../Browse/rule/dice/power-roll.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A lash used to punish a mutineer
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Whenever you damage a creature with the weapon, you can immediately use a maneuver to end one effect imposed by that creature on you or another creature within 5 squares of you.

**5th Level:** The weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, you and each ally within 2 squares of you gains a +1 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [saving throws](../../Browse/rule/general/saving-throw.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A ruby hardened in the fires of the City of Brass, a sapphire that has been struck by lightning
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, you can change the [damage type](../../Browse/rule/damage/damage-type.md) of such abilities to cold, fire, lightning, or sonic.

**5th Level:** The weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +2. Additionally, the weapon can be used with [ranged](../../Browse/rule/combat/ranged.md) weapon abilities, and returns to you when a [ranged](../../Browse/rule/combat/ranged.md) ability is resolved. [Ranged](../../Browse/rule/combat/ranged.md) abilities used with the weapon increase their [distance](../../Browse/rule/combat/distance.md) by 3, and must deal cold, fire, lightning, or sonic damage (chosen when you use the ability).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A personal blessing from the greatest duelist in the land, six fake and extremely shiny gemstones
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon gains a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) with this weapon, you can immediately [shift](../../Browse/movement/shifting.md) 1 square. As well, while you wield or carry the weapon and are present in a negotiation, if an [NPC](../../Browse/rule/general/npc.md) in the negotiation has the greed, legacy, power, or revelry motivation, their starting interest increases by 1 (to a maximum of 5).
...
**9th Level:** The weapon's damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) increases to +3. Additionally, you have a double [edge](../../Browse/rule/dice/edge.md) on any [test](../../Browse/rule/test/test.md) you make using a skill you have from the interpersonal skill group.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** An ancient bronze gear covered in indecipherable runes

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts in Zaliac

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md) or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) to a creature, you can use a maneuver to [teleport](../../Browse/movement/teleport.md) you and that creature, letting you trade places provided you both fit into each other's spaces.

**5th Level:** The weapon's extra psychic damage increases to 2. Additionally, whenever you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) to a creature, you can use a maneuver to trade places with that creature or any creature within 4 squares of them, provided you both fit into each other's spaces.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** The skull of a convicted criminal
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage, or an extra 2 psychic damage if the target is [winded](../../Browse/rule/health/winded.md). Additionally, the first time in an encounter that you cause an enemy to become [winded](../../Browse/rule/health/winded.md) with an ability using the weapon, you gain 10 [temporary Stamina](../../Browse/rule/health/temporary-stamina.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Eight iron bars cooled in a glacier, the branch of an ancient evergreen
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 cold damage. Additionally, you can use a maneuver to create an ice field in a 3 [burst](../../Browse/rule/combat/burst.md). The ground in this area is [difficult terrain](../../Browse/movement/difficult-terrain.md) for enemies, and lasts until the end of the encounter or when you use this ability again.

**5th Level:** The weapon's extra cold damage increases to 2, and the ice field becomes a 4 [burst](../../Browse/rule/combat/burst.md). Additionally, whenever you use a weapon ability using this weapon against one or more enemies in the ice field, you gain 1 [surge](../../Browse/rule/resource/surge.md) that you can use immediately.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Eighteen daggers—nine taken from personal enemies and nine gifted by friends
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. This extra damage increases by 1 each time you deal [rolled damage](../../Browse/rule/damage/rolled-damage.md) using the weapon to the same target during the same encounter (to a maximum of 3).

**5th Level:** Whenever you reduce a creature to 0 [Stamina](../../Browse/rule/health/stamina.md) with an ability using this weapon, one of its indentations glows brighter. When you use a [signature ability](../../Browse/rule/combat/signature-ability.md) using the weapon, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to expend any number of bright-glowing indentations, with the ability dealing extra psychic damage equal to the number of indentations. The expended indentations then return to a dim glow.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Night-blooming flower petals, a starmetal meteorite
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Four iron bars coated in magma slag
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A venom sac from a giant spider, one valok gyroscope

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Caelian and Variac

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md), [Reason](../../Browse/rule/character/reason.md), or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 poison damage. Additionally, any [signature ability](../../Browse/rule/combat/signature-ability.md) using the weapon that obtains a tier 3 outcome also makes the target [weakened](../../Browse/condition/weakened.md) until the end of their next [turn](../../Browse/rule/combat/turn.md).

**5th Level:** The weapon's extra poison damage increases to 2. A [signature ability](../../Browse/rule/combat/signature-ability.md) made using the weapon that obtains a tier 3 outcome also makes the target [weakened](../../Browse/condition/weakened.md) and [slowed](../../Browse/condition/slowed.md) until the end of their next [turn](../../Browse/rule/combat/turn.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One hundred steel arrowheads stained with blood

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Caelian and Kalliak

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md), [Reason](../../Browse/rule/character/reason.md), or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** You gain a +1 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [melee](../../Browse/rule/combat/melee.md) [distance](../../Browse/rule/combat/distance.md) with weapon abilities using this weapon. Additionally, any damage-dealing weapon ability using the weapon against a target who has A < AVERAGE also leaves that target [bleeding](../../Browse/condition/bleeding.md) (save ends).

**5th Level:** The weapon's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [melee](../../Browse/rule/combat/melee.md) [distance](../../Browse/rule/combat/distance.md) increases to +2. Additionally, any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using the weapon gains a +3 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) against any target who is [bleeding](../../Browse/condition/bleeding.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** Heart strings of a tapir, a pound of tiger's eye gemstones
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, any damage-dealing weapon ability using the weapon that achieves a tier 3 outcome also leaves the target [dazed](../../Browse/condition/dazed.md) until the end of their next [turn](../../Browse/rule/combat/turn.md). **5th Level:** The weapon's extra psychic damage increases to 2. Additionally, whenever a creature within [distance](../../Browse/rule/combat/distance.md) of your [ranged](../../Browse/rule/combat/ranged.md) weapon free strike uses a [triggered action](../../Browse/rule/combat/triggered-action.md), you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) after their [triggered action](../../Browse/rule/combat/triggered-action.md) resolves to make a [ranged](../../Browse/rule/combat/ranged.md) weapon free strike using this weapon against the creature.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A jar of captured thunder, two ingots of moon metal
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A folded metal blade infused with blood
...
**1st Level:** Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using this weapon deals an extra 1 psychic damage. Additionally, if you reduce a creature to 0 [Stamina](../../Browse/rule/health/stamina.md) using this weapon, you can immediately use a maneuver to make a [melee](../../Browse/rule/combat/melee.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md).

**5th Level:** The weapon's extra psychic damage increases to 2. Additionally, if you reduce a creature to 0 [Stamina](../../Browse/rule/health/stamina.md) using the weapon, you can use a maneuver to make a [melee](../../Browse/rule/combat/melee.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) and can move up to 2 squares before or after the [strike](../../Browse/rule/combat/strike.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A pair of obituaries that each mention the subject of the other
...
**1st Level:** While you wear this ring, you gain a +6 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md). Additionally, during a [respite](../../Browse/rule/resource/respite.md), you can touch the ring to any number of other Bloodbound Bands worn by willing creatures to form a bond among all of you. Creatures related by blood can't form bonds in this way. Bonded creatures can each use the highest [recovery value](../../Browse/rule/health/recoveries.md) of any bonded creature in place of their own, and can spend each other's [Recoveries](../../Browse/rule/health/recoveries.md) as if they were their own. Whenever any other bonded creature takes damage, each bonded creature takes 1 damage that can't be reduced in any way. Your bond ends if you remove the ring, use it to bond with one or more other creatures, or die, but other rings continue to be bonded to each other.

**5th Level:** The ring's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to +12. Additionally, you have [damage immunity](../../Browse/rule/damage/damage-immunity.md) 2.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One cotton bolt soaked in the blood of six adventurers

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Caelian

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md), [Agility](../../Browse/rule/character/agility.md), or [Intuition](../../Browse/rule/character/intuition.md)

**Project Goal:** 450

**1st Level:** While you wear these hand wraps, any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using your unarmed [strikes](../../Browse/rule/combat/strike.md) gains a +1 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md). Additionally, once per [turn](../../Browse/rule/combat/turn.md), you can take 5 damage that can't be reduced in any way to use the [Grab](../../Browse/feature/common/maneuvers/grab.md) maneuver (no action required).

**5th Level:** The damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) granted by the hand wraps increases to +2. Additionally, once per [turn](../../Browse/rule/combat/turn.md), you can take 10 damage that can't be reduced in any way to make a [melee](../../Browse/rule/combat/melee.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) (no action required). On your [turn](../../Browse/rule/combat/turn.md), you can use the wraps' [melee](../../Browse/rule/combat/melee.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) option or [Grab](../../Browse/feature/common/maneuvers/grab.md) maneuver option, but only one.
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** One jar of lightning
...
**1st Level:** While you wear these boots, any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using your unarmed [strikes](../../Browse/rule/combat/strike.md) deals an extra 1 lightning damage. Additionally, you gain a +2 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [speed](../../Browse/rule/character/speed.md).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A cloak worn by a murdered monarch
...
**1st Level:** While you wear this cloak, any creature who damages you is marked for revenge until the end of your next [turn](../../Browse/rule/combat/turn.md) or until another creature damages you. Any strike you make against a creature marked for revenge deals extra damage equal to your highest [characteristic](../../Browse/rule/character/characteristic.md) score, and whenever you damage a creature marked for revenge, they are also [bleeding](../../Browse/condition/bleeding.md) until the end of their next [turn](../../Browse/rule/combat/turn.md).

**5th Level:** Each creature who damages you is marked for revenge until the end of your next [turn](../../Browse/rule/combat/turn.md). Whenever you damage a creature marked for revenge, they are also [bleeding](../../Browse/condition/bleeding.md) (save ends).
...
**[Item Prerequisite](../../Browse/rule/downtime/item-prerequisite.md):** A pound of feathers, a pound of bricks from the Seven Cities of Hell

**[Project Source](../../Browse/rule/downtime/project-source.md):** Texts or lore in Anjali

**[Project Roll](../../Browse/rule/downtime/project-roll.md) [Characteristic](../../Browse/rule/character/characteristic.md):** [Might](../../Browse/rule/character/might.md), [Reason](../../Browse/rule/character/reason.md), or [Presence](../../Browse/rule/character/presence.md)

**Project Goal:** 450

**1st Level:** While you wear this torque, you gain a [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) equal to twice your highest [characteristic](../../Browse/rule/character/characteristic.md) score. Additionally, you can use a maneuver to choose a creature in your [line of effect](../../Browse/rule/combat/line-of-effect.md) and learn their level. If their level is higher than yours, the torque grants you envy. If their level is equal to or lower than yours, the torque grants you disdain. You can have both envy and disdain from different creatures, but not more than one instance of either.

Whenever a creature within 10 squares of you deals damage to another creature, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to expend your envy or disdain. If you expend envy, you deal damage equal to the triggering damage to a creature [adjacent](../../Browse/rule/combat/adjacent.md) to you. If you expend disdain, you reduce the triggering damage by half. At the end of the encounter, you lose any envy or disdain granted by the torque.

**5th Level:** The torque's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to three times your highest [characteristic](../../Browse/rule/character/characteristic.md) score. Additionally, when you use the torque's maneuver and the target creature is the same level as you, you gain your choice of envy or disdain.

**9th Level:** The torque's [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) increases to five times your highest [characteristic](../../Browse/rule/character/characteristic.md) score. Additionally, you can have multiple instances of envy and disdain, with no limit on either.
...
**Suited for [Victory](../../Browse/rule/resource/victories.md):** This sword takes on the size, shape, and make that the wielder wills into it. It can be a light, medium, or heavy weapon, and you can change its weapon type and appearance as a [free maneuver](../../Browse/rule/combat/free-maneuver.md). Any weapon ability that deals [rolled damage](../../Browse/rule/damage/rolled-damage.md) using the Blade of a Thousand Years gains a +5 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md), and that ability always deals holy damage. Any creature with weakness to holy damage who takes damage from this weapon is also [frightened](../../Browse/condition/frightened.md) and [weakened](../../Browse/condition/weakened.md) until the end of their next [turn](../../Browse/rule/combat/turn.md).

**Rally the Righteous:** This blade fills all around it with hope and courage. Each ally within 1 mile of the weapon gains an [edge](../../Browse/rule/dice/edge.md) on weapon abilities and magic abilities, and has [damage immunity](../../Browse/rule/damage/damage-immunity.md) 5. Additionally, each such creature's [Stamina](../../Browse/rule/health/stamina.md) maximum increases by 15 and they gain a +15 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [Stamina](../../Browse/rule/health/stamina.md) when this ability first affects them.

**Turn the Tide:** Each enemy minion within 1 mile of the sword is [dazed](../../Browse/condition/dazed.md). Any enemy leader or solo creature in that area takes a [bane](../../Browse/rule/dice/bane.md) on [ability rolls](../../Browse/rule/dice/ability-roll.md).

**[Victory](../../Browse/rule/resource/victories.md)'s Assurance:** This weapon always appears on the eve before what will later come to be known as a historic battle. It disappears after 24 hours or when the battle is won, whichever comes first. By taking the blade, the wielder unwittingly enters into a pact with the weapon. If they don't secure [victory](../../Browse/rule/resource/victories.md) against monumental odds or some great foe by the time the sword disappears, they are pulled into the sword, preventing any chance of resurrection, and forever dooming them to lend their strength to the heroes of other ages.
...
Only one destined for death can contain the power of the Mortal Coil. A mortal creature who carries this artifact serves as its host, gaining an additional main action on each of their [turns](../../Browse/rule/combat/turn.md), aging at ten times the usual rate, and becoming unable to ever regain [Stamina](../../Browse/rule/health/stamina.md). A host with no natural maximum lifespan permanently reduces their [Stamina](../../Browse/rule/health/stamina.md) maximum by 10 each year.
...
Players don't simply choose their characters' titles. Like treasures and [Renown](../../Browse/rule/resource/renown.md) (in the next section), titles must be won. Each title has a unique requirement, so that earning a title might mean your character needs to defeat a specific monster, research dangerous forbidden lore, or—in the case of the [Monarch](../../Browse/title/monarch.md) title—win a kingdom!
...
Although the Director gives out titles, if you want to earn a specific title, let your Director know. For instance, you might say, "I'm interested in the [Dragon Blooded](../../Browse/title/dragon-blooded.md) title. Can my hero listen for rumors of any wicked dragons nearby that need smiting?" Having ambition is good! Pursue the titles you want that will make you a better hero.

### Title Echelons

Each title is assigned to an [echelon](../../Browse/rule/general/echelon.md) of play where it is most likely to be earned. For instance, knighthood is something that can be typically earned by the 2nd [echelon](../../Browse/rule/general/echelon.md), but becoming a [monarch](../../Browse/title/monarch.md) can usually only be achieved in the 4th [echelon](../../Browse/rule/general/echelon.md). But don't let the rules get in the way of a good story! If the Director decides that your character somehow wins a knighthood at 1st level, bask in the glory of this great accomplishment.

> For the Director: Granting Titles Early
>
> Granting titles before characters reach the recommended [echelon](../../Browse/rule/general/echelon.md) can be fun, but it's worth noting that doing so might have unwanted effects on the game. Higher-[echelon](../../Browse/rule/general/echelon.md) titles often grant more significant benefits than lower-[echelon](../../Browse/rule/general/echelon.md) titles. If a hero becomes queen at 1st level, her royal responsibilities might overshadow her other adventures. Don't grant a title more than one [echelon](../../Browse/rule/general/echelon.md) early unless you know what you're getting yourself into!

### Customizing Titles

This section details a number of ready-to-use titles. But the Director can also create custom titles, both to reward specific player accomplishments and to flesh out organizations, locations, and foes within their own game world. When a hero finally achieves a long-term goal after many game sessions of struggle, the Director can memorialize the moment by granting a unique title. Similarly, the Director can grant custom titles when the heroes befriend specific factions, defeat notorious villains, or learn new moves from skilled [NPCs](../../Browse/rule/general/npc.md).

The easiest way to create custom titles is to modify an existing title's requirements to fit the adventure at hand. For instance, your world might contain a secretive organization of freedom fighters—the Jesters—who never carry weapons, defeating foes with unarmed attacks and improvised weapons. Creating a Jester title can be as easy as modifying the [Brawler](../../Browse/title/brawler.md) title by changing its requirements to "Fight alongside the Jesters against a mutual foe."

> **For the Director: Perks as Custom Titles**
>
> You can [turn](../../Browse/rule/combat/turn.md) a perk into a 1st-[echelon](../../Browse/rule/general/echelon.md) title simply by giving it a prerequisite (see Chapter 7: [Perks](perks.md)). For example, a hero might gain the Familiar perk as a title instead if they complete a quest for an archmage, who then teaches the hero the conjuring ritual as a reward.

### How Many Titles?

Just because a hero meets the prerequisite for a title doesn't mean it is granted to them. The Director decides when a hero earns a title and its benefits. Odds are you'll be adventuring quite a bit and qualify for more than a few, but gaining too many titles all at once can make for a complicated hero. In general, a hero typically earns one title per [echelon](../../Browse/rule/general/echelon.md) of play, though they can earn more or fewer at the Director's discretion.
...
Most titles, however, are earned by all the heroes at once for accomplishing a great task, benefiting them all. These titles typically offer a selection of three or four different options. When the party earns the title, each player decides which benefit their hero takes. For instance, if the party triumphs in a tavern fight and gains the [Brawler](../../Browse/title/brawler.md) title, one hero might become more adept at fighting with improvised weapons, another might learn a special dodge to use when flanked by multiple enemies, and two others might simply revel in the increased notoriety. A hero can take any of a title's benefits they qualify for, and multiple heroes can take the same benefit.

### Granting Titles

Titles are rewards for heroic activities, and they often go hand in hand with treasure and other goodies. If the party defeats a fearsome monster and earns [Renown](../../Browse/rule/resource/renown.md), or accomplishes a quest and wins a magic [leveled treasure](../../Browse/rule/treasure/leveled-treasure.md), one or more characters might earn a title at the same time.

There is no hard-and-fast rule for the number of titles characters should accumulate by a certain level. If a character wins a title whenever they accomplish a truly notable deed—once every few adventures—then they might earn about one title per [echelon](../../Browse/rule/general/echelon.md). Sticking to this rate isn't a requirement, though. Characters might easily earn twice or half as many titles, making them a bit more or less powerful than they otherwise would be. A Director can even skip granting titles altogether if they wish.

### 1st-Echelon Titles

Titles suitable for 1st-[echelon](../../Browse/rule/general/echelon.md) characters are presented in alphabetical order.

> **Optional Rule: Players Choose Titles**
>
> If the Director doesn't want to track player accomplishments, they can let the players do it instead. In this case, whenever a hero enters a new [echelon](../../Browse/rule/general/echelon.md) of play, they gain one title of their choice for which they qualify.
...
- *Iron Hand in Velvet Glove:* The first time during a negotiation that you make a [test](../../Browse/rule/test/test.md) using the [Intimidate](../../Browse/skill/intimidate.md) skill and don't make an argument that appeals to an [NPC](../../Browse/rule/general/npc.md)'s motivation, you don't lower the [NPC](../../Browse/rule/general/npc.md)'s patience or interest no matter the outcome of the roll.
...
- *Duck!:* When an enemy strikes you while a second creature is [flanking](../../Browse/rule/combat/flanking.md) you, you can use a [triggered action](../../Browse/rule/combat/triggered-action.md) to redirect the [strike](../../Browse/rule/combat/strike.md) against the second creature. Once you use this benefit, you can't use it again until you earn 1 or more [Victories](../../Browse/rule/resource/victories.md).
- *Furniture Fighter:* When you use a weapon ability with an improvised weapon or a weapon that isn't part of your kit, the ability benefits from your kit's [melee](../../Browse/rule/combat/melee.md) weapon damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md).
...
**Prerequisite:** You have spent at least five [respites](../../Browse/rule/resource/respite.md) in a metropolis.

**Effect:** Choose one of the following benefits:

- *Discerning Shopper:* When looking for an [item prerequisite](../../Browse/rule/downtime/item-prerequisite.md) for a [crafting project](../../Browse/rule/downtime/crafting-project.md), you can remember meeting someone who might have the item—or at least information about it.
...
**Prerequisite:** You aren't a [hakaan](../../Browse/ancestry/hakaan.md) but have witnessed the death of a [hakaan](../../Browse/ancestry/hakaan.md).
...
- *Close Formation:* While [adjacent](../../Browse/rule/combat/adjacent.md) to two or more allies, you gain a +2 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [stability](../../Browse/rule/character/stability.md).
...
- *Academic Faction:* You find a sage who can make up to three [Reason](../../Browse/rule/character/reason.md) [tests](../../Browse/rule/test/test.md) to recall lore or make [project rolls](../../Browse/rule/downtime/project-roll.md) for [research projects](../../Browse/rule/downtime/research-project.md) on your behalf. The sage has a +5 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to these [tests](../../Browse/rule/test/test.md). These [project rolls](../../Browse/rule/downtime/project-roll.md) take 10 minutes each and don't need to be made during a [respite](../../Browse/rule/resource/respite.md).
- *Guild Faction:* You find an expert crafter who can make up to three [project rolls](../../Browse/rule/downtime/project-roll.md) for [crafting projects](../../Browse/rule/downtime/crafting-project.md) on your behalf. The crafter has a +5 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to these [tests](../../Browse/rule/test/test.md). These [project rolls](../../Browse/rule/downtime/project-roll.md) take 10 uninterrupted minutes each and don't need to be made during a [respite](../../Browse/rule/resource/respite.md).
...
> **[Renown](../../Browse/rule/resource/renown.md) and [Wealth](../../Browse/rule/resource/wealth.md)**
>
...
- *Arcane Dampening:* When resisting [potencies](../../Browse/rule/character/potency.md) from magic abilities, your [characteristic](../../Browse/rule/character/characteristic.md) scores are considered to be 1 higher than usual.
...
**Prerequisite:** You join an organization that hunts criminals, such as the Far Mariners (see [Orden](../../Browse/rule/world/orden.md) and the Timescape in Chapter 1: [The Basics](the-basics.md)), or you are deputized to act for the local authorities.

**Effect:** Choose one of the following benefits:

- *Guess It's the Hard Way Then:* When combat begins and you aren't [surprised](../../Browse/rule/combat/surprised.md), the first time you take damage before taking your [turn](../../Browse/rule/combat/turn.md), you halve that damage.
- *Heedless Pursuer:* Once on each of your [turns](../../Browse/rule/combat/turn.md), you can use a [free maneuver](../../Browse/rule/combat/free-maneuver.md) to deal yourself 1d6 damage that can't be reduced in any way. When you do, you ignore [difficult terrain](../../Browse/movement/difficult-terrain.md) and you can increase the [distance](../../Browse/rule/combat/distance.md) of any jump you make by 1 square, both until the end of your [turn](../../Browse/rule/combat/turn.md).
...
**Effect:** While it might appear that you died, you did not. Instead, you regain 1 [Stamina](../../Browse/rule/health/stamina.md) and can spend 1 or more [Recoveries](../../Browse/rule/health/recoveries.md). Additionally, you gain a 1st-[echelon](../../Browse/rule/general/echelon.md) [trinket](../../Browse/rule/treasure/trinket.md) of the Director's choice (see Treasures earlier in this chapter).
...
>
> **Effect:** Each target who has P < AVERAGE is [taunted](../../Browse/condition/taunted.md) by you until the end of their next [turn](../../Browse/rule/combat/turn.md), and you know the location of each creature [taunted](../../Browse/condition/taunted.md) in this way.
...
**Effect:** After being defeated, each character awakes, alive and with full [Stamina](../../Browse/rule/health/stamina.md) and [Recoveries](../../Browse/rule/health/recoveries.md). You are all captives of the creatures who defeated you, and a gruesome end awaits you—unless you can escape or overcome the nefarious challenge your captors have planned.

The Director chooses one of the following benefits, based on the fate your captors have in mind for you. Each hero gains the same benefit. Additionally, you must face an encounter, [montage test](../../Browse/rule/test/montage-test.md), or adventure related to the benefit, as the Director determines.

- *Gladiators:* You must fight to the death for your captors' amusement. Your intended opponents wield or guard a [trinket](../../Browse/rule/treasure/trinket.md) or [leveled treasure](../../Browse/rule/treasure/leveled-treasure.md), which you can earn if you are victorious.
- *Prey:* Your captors plan to release you and hunt you down, but it's no fun unless you offer a challenge. Each of you is given a medicinal draught that grants a +1 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [speed](../../Browse/rule/character/speed.md) and increases your [Recoveries](../../Browse/rule/health/recoveries.md) by 2. This benefit lasts until the end of your next [respite](../../Browse/rule/resource/respite.md).
...
- *Deep-Sea Diver:* You can automatically swim at full [speed](../../Browse/rule/character/speed.md) while moving.
...
- *Honor Among Thieves:* When negotiating with criminals, your [Renown](../../Browse/rule/resource/renown.md) score is considered to be 2 higher than usual.
...
- *Dirty Fighting:* While you are standing, your [melee](../../Browse/rule/combat/melee.md) [strikes](../../Browse/rule/combat/strike.md) gain a +3 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) against [prone creature](../../Browse/condition/prone.md)s. Additionally, being prone doesn't impose a [bane](../../Browse/rule/dice/bane.md) on your [strikes](../../Browse/rule/combat/strike.md).
- *Foes as Weapons:* Whenever you have a creature of your [size](../../Browse/rule/character/size.md) or smaller [grabbed](../../Browse/condition/grabbed.md), you can use them as a weapon when you make a [melee](../../Browse/rule/combat/melee.md) weapon free strike. Both the target and the [grabbed](../../Browse/condition/grabbed.md) enemy take the [strike](../../Browse/rule/combat/strike.md)'s damage.
...
> - **17+:** 14 damage; I < STRONG, [dazed](../../Browse/condition/dazed.md) (save ends)
>
...
- *Artillerist:* You gain a +5 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) when using a ship's weapons
- *Black Flag:* You have a recognizable flag that strikes terror on the high seas. While your flag is [flying](../../Browse/movement/fly.md) from your ship, crewmembers of other ships who have [line of effect](../../Browse/rule/combat/line-of-effect.md) to the flag take a [bane](../../Browse/rule/dice/bane.md) on [strikes](../../Browse/rule/combat/strike.md) made against your ship or its crew.
...
**Prerequisite:** You have the [Faction Member](../../Browse/title/faction-member.md) title, and you greatly advance the faction's goals.
...
**Prerequisite:** You eat and drink with an elf [monarch](../../Browse/title/monarch.md) or archfey.
...
- *Gift of Knowledge:* You gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) you make that use any skill from the lore skill group.
...
- *Up the Beanstalk:* You have the [Climb](../../Browse/skill/climb.md) skill. If you already have this skill, you instead gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made using the [Climb](../../Browse/skill/climb.md) skill. While you're climbing a creature, the creature has a double [bane](../../Browse/rule/dice/bane.md) on [strikes](../../Browse/rule/combat/strike.md) against you and you have a double [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made to stay on the creature.
...
**Prerequisite:** You do a favor for an agent of a god or [saint](../../Browse/rule/world/saint.md), or promise to do so.
...
**Prerequisite:** You have the [Troupe Leading Player](../../Browse/title/troupe-leading-player.md) title, and you have used planning and teamwork to execute a theft that went (reasonably) according to plan.
...
>
> **Trigger:** An ally makes a [test](../../Browse/rule/test/test.md) to lie to, pick the pocket of, hide from, or sneak by the target and doesn't like the outcome.
>
...
**Prerequisite:** A [noble](../../Browse/title/noble.md) or [monarch](../../Browse/title/monarch.md) grants you knighthood or a similar rank.

**Effect:** Choose one of the following benefits:

- *Heraldic Fame:* You earn 1 [Renown](../../Browse/rule/resource/renown.md).
...
> - **17+:** 16 damage; [taunted](../../Browse/condition/taunted.md) (save ends)
>
> **Effect:** You can end the [taunted](../../Browse/condition/taunted.md) [condition](../../Browse/rule/combat/condition.md) on the target as a [free maneuver](../../Browse/rule/combat/free-maneuver.md).
>
...
**Prerequisite:** You have the [Ancient Loremaster](../../Browse/title/ancient-loremaster.md) title, and you have completed a Discover Lore project to learn lost knowledge or forbidden knowledge.
...
- Make a [test](../../Browse/rule/test/test.md) that uses the Disguise skill. You gain an [edge](../../Browse/rule/dice/edge.md) on the [test](../../Browse/rule/test/test.md).
...
**Effect:** You return to life 1 minute after being killed with [Stamina](../../Browse/rule/health/stamina.md) equal to your [winded](../../Browse/rule/health/winded.md) value. You gain corruption immunity equal to your level and one of the benefits below, based on the type of creature who killed you. If you die again, you rise as an undead creature under the Director's control.

- *Ghoul or Vampire:* When you make a [melee](../../Browse/rule/combat/melee.md) [free strike](../../Browse/feature/common/main-actions/free-strike.md) against an [adjacent](../../Browse/rule/combat/adjacent.md) creature, you can bite that creature. If you do so and obtain a tier 3 outcome, you gain [temporary Stamina](../../Browse/rule/health/temporary-stamina.md) equal to the damage dealt. If not lost beforehand, this [temporary Stamina](../../Browse/rule/health/temporary-stamina.md) lasts until the end of your next [respite](../../Browse/rule/resource/respite.md).
...
**Prerequisite:** You defeat a foe while at or below 0 [Stamina](../../Browse/rule/health/stamina.md).

**Effect:** Choose one of the following benefits:

- *From Hell's Heart:* While you are [winded](../../Browse/rule/health/winded.md), your [melee](../../Browse/rule/combat/melee.md) [strikes](../../Browse/rule/combat/strike.md) gain a +3 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md).
- *Furious Attack:* Choose one [signature ability](../../Browse/rule/combat/signature-ability.md) from the [fury](../../Browse/class/fury.md) class. You gain that ability regardless of whether your class and [subclass](../../Browse/rule/general/subclass.md) allow you to take it. If this ability allows you to gain or spend ferocity, you can't do so unless you have the Ferocity class feature.
- *Furious Charge:* When you use the [Charge](../../Browse/feature/common/main-actions/charge.md) action, your [strike](../../Browse/rule/combat/strike.md) made as part of that action gains a damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) equal to the number of squares you moved as part of the charge.
...
**Prerequisite:** You die at the hands of your greatest foe, that foe still lives, and you aren't a [revenant](../../Browse/ancestry/revenant.md).
...
- *Lethe:* While you are [winded](../../Browse/rule/health/winded.md), your [strikes](../../Browse/rule/combat/strike.md) gain a +5 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md)
...
**Prerequisite:** You defeat a leader or solo creature with the [Devil](../../Browse/ancestry/devil.md) keyword, such as an archdevil, or you make a deal with a [devil](../../Browse/ancestry/devil.md).

**Effect:** Choose one of the following benefits:

- *Devil Lore:* You know the Anjali language, and your understanding of this language helps you create irresistible [supernatural](../../Browse/rule/general/supernatural.md) effects. The [potencies](../../Browse/rule/character/potency.md) of your magic or psionic abilities that target [Reason](../../Browse/rule/character/reason.md), [Intuition](../../Browse/rule/character/intuition.md), or [Presence](../../Browse/rule/character/presence.md) increase by 1.
...
**Prerequisite:** You have the [Corsair](../../Browse/title/corsair.md) title, and you lead a fleet of at least three ships.

**Effect:** Choose one of the following benefits:

- *First Mate:* You have a pirate [retainer](../../Browse/rule/general/retainer.md), such as a **[human](../../Browse/ancestry/human.md) warrior**, chosen by the Director from *Draw Steel: Monsters*. This [retainer](../../Browse/rule/general/retainer.md)'s level increases to your level.
- *[Swashbuckler](../../Browse/kit/swashbuckler.md):* You can automatically climb at full [speed](../../Browse/rule/character/speed.md) while moving
- *Treasure Keeper:* You earn 1 [Wealth](../../Browse/rule/resource/wealth.md).
- *Weather Wizard:* Once per day, you can spend 10 uninterrupted minutes to magically alter mundane weather in a 5-mile radius around you. The weather moves with you and persists for 6 hours or until you dismiss it as a [free maneuver](../../Browse/rule/combat/free-maneuver.md). Choose from one of the following weather types:
  - *Calm:* Wind-powered vessels and technology cease working
  - *Fog:* Visibility is reduced to 6 squares.
  - *High Winds:* The [speed](../../Browse/rule/character/speed.md) of wind-powered vessels is doubled.
...
**Prerequisite:** You visit the realms of gods, [devils](../../Browse/ancestry/devil.md), or other immortal beings and hear a note of the Music of Creation.
...
> - **17+:** 10 sonic damage; M < STRONG, [weakened](../../Browse/condition/weakened.md) and [bleeding](../../Browse/condition/bleeding.md) (save ends)
>
...
**Prerequisite:** You complete a downtime project to imbue armor, an [implement](../../Browse/rule/treasure/implement.md), or a weapon with a 9th-level [enhancement](../../Browse/rule/treasure/enhancement.md).
...
- *Skilled Hands:* You have a skill from the crafting skill group that would have been used during the creation of the prerequisite item. If you already have that skill, you instead gain an [edge](../../Browse/rule/dice/edge.md) on [tests](../../Browse/rule/test/test.md) made using the skill. Additionally, you gain a second skill of your choice from the crafting skill group.
...
**Prerequisite:** A [monarch](../../Browse/title/monarch.md) or important [noble](../../Browse/title/noble.md) grants you a [noble](../../Browse/title/noble.md) rank.

**Effect:** Choose one of the following benefits:

- *I Know How to Talk to These People:* You gain an [edge](../../Browse/rule/dice/edge.md) on [Presence](../../Browse/rule/character/presence.md) [tests](../../Browse/rule/test/test.md) made to interact with royals, nobles, and their feudal [followers](../../Browse/rule/general/follower.md), provided they are aware of your [noble](../../Browse/title/noble.md) rank.
- *Noble Splendor:* You earn 1 [Renown](../../Browse/rule/resource/renown.md) and 1 [Wealth](../../Browse/rule/resource/wealth.md).
- *Retinue:* The number of [followers](../../Browse/rule/general/follower.md) you can recruit increases by two.
...
- *Prismacore Eyes:* Exposure to prismacore has given your eyes a mirrorlike sheen. You have psychic immunity 10, creatures can't use magic or psionic abilities or other effects to determine your location or read your thoughts unless you allow them to, and you gain a +3 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [stability](../../Browse/rule/character/stability.md) against magic or psionic abilities.
...
**Prerequisite:** You have the [Battlefield Commander](../../Browse/title/battlefield-commander.md) title, and you lead the defense of a settlement or fortification.

**Effect:** Choose one of the following benefits:

- *Death From Above:* When you gain an [edge](../../Browse/rule/dice/edge.md) on an ability due to [high ground](../../Browse/movement/high-ground.md), the ability gains a +8 damage [bonus](../../Browse/rule/dice/bonuses-and-penalties.md).
...
- *Best of the Best:* Choose a skill you used during the competition. You gain a +4 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md) to [tests](../../Browse/rule/test/test.md) made using that skill instead of a +2 [bonus](../../Browse/rule/dice/bonuses-and-penalties.md)
...
**Prerequisite:** You have the [Godsworn](../../Browse/title/godsworn.md) title, and hundreds of worshipful mortals complete a divine ritual in your name.
...
- *Acolytes:* The number of [followers](../../Browse/rule/general/follower.md) you can recruit increases by two
...
- *Cosmic Revelation:* When you make a [test](../../Browse/rule/test/test.md) with a skill from the lore skill group and obtain a tier 1 or tier 2 outcome, you can instead obtain a tier 3 outcome. Once you use this benefit, you can't use it again until you earn 1 or more [Victories](../../Browse/rule/resource/victories.md).
...
- *Brief Reunion:* While you're [winded](../../Browse/rule/health/winded.md), you can use a maneuver to summon the artifact to your hand. It disappears at the end of your next [turn](../../Browse/rule/combat/turn.md). Once you use this benefit, you can't use it again until you earn 1 or more [Victories](../../Browse/rule/resource/victories.md).
...
**Prerequisite:** You or a member of your party becomes the [monarch](../../Browse/title/monarch.md) of a nation.
...
- *Crown Jewels:* You gain one of your nation's treasures—a [trinket](../../Browse/rule/treasure/trinket.md) of the Director's choice.
- *Royal Fame:* You earn 2 [Renown](../../Browse/rule/resource/renown.md).
- *Royal Retinue:* The number of [followers](../../Browse/rule/general/follower.md) you can recruit increases by 2
- *Royal [Wealth](../../Browse/rule/resource/wealth.md):* You earn 2 [Wealth](../../Browse/rule/resource/wealth.md).
...
- *Drop Your Sword:* When you succeed on a [test](../../Browse/rule/test/test.md) using the [Intimidate](../../Browse/skill/intimidate.md) skill, you can cause affected creatures to drop any items they are holding.
...
- *Many Paths to Peace:* When you make a [test](../../Browse/rule/test/test.md) with a skill from the interpersonal skill group, you can use any [characteristic](../../Browse/rule/character/characteristic.md) of your choice for the [test](../../Browse/rule/test/test.md).
...
- *Holy Weapon:* You have a [leveled treasure](../../Browse/rule/treasure/leveled-treasure.md) of the Director's choice.
- *Kill Me Once, Shame On You:* Choose a creature keyword belonging to one of the creatures who defeated you. Any creature with that keyword takes a [bane](../../Browse/rule/dice/bane.md) on [ability rolls](../../Browse/rule/dice/ability-roll.md) against you.
...
**Prerequisite:** You have the [Unstoppable](../../Browse/title/unstoppable.md) title, and you make or assist on a [test](../../Browse/rule/test/test.md) as part of a [montage test](../../Browse/rule/test/montage-test.md) that obtains a full success.
...
- *Bounce Back Fast:* Whenever you rest for 8 hours or more, you can gain the benefit of a [respite](../../Browse/rule/resource/respite.md). Once you use this benefit, you can't use it again until you have taken a regular [respite](../../Browse/rule/resource/respite.md).
...
- *Bye-Bye:* You can use a maneuver to [teleport](../../Browse/movement/teleport.md) yourself and each willing ally within 5 squares of you to new positions within 10 squares of your original starting point. Once you use this benefit, you can't use it again until you earn 1 or more [Victories](../../Browse/rule/resource/victories.md).
...
Draw Steel isn't about accumulating and counting every piece of copper you acquire. Instead of tracking a bank account, the amount of stuff your hero can purchase is based on their Wealth score. As you accomplish more deeds, you acquire more treasure and rewards from grateful [NPCs](../../Browse/rule/general/npc.md) that allow you to be an even more effective hero.
...
Treasures such as magic swords, psionic crowns, and even healing potions are rare to the point where they don't appear on the Hero Wealth table. Such items typically can't be purchased, and are instead found on adventures, traded for other treasures, given as rewards by [NPCs](../../Browse/rule/general/npc.md), or crafted by the heroes.

### Earning Wealth

Each hero starts with a [Wealth](../../Browse/rule/resource/wealth.md) score of 1 that can be improved by their choice of career during character creation (see Chapter 4: [Background](background.md)). Your hero earns [Wealth](../../Browse/rule/resource/wealth.md) whenever you find and keep a massive amount of monetary treasure, such as a hoard of coins and gems from a dragon's lair, or several unique and valuable paintings gifted by a [monarch](../../Browse/title/monarch.md) as a reward for a job well done.

In general, a hero earns 1 wealth every second level of play. The Director can increase this rate if they wish.

### Losing Wealth

As an optional rule, the Director can allow a hero to make a purchase that is one above their [Wealth](../../Browse/rule/resource/wealth.md) score. If this occurs, the hero's [Wealth](../../Browse/rule/resource/wealth.md) is reduced by 1 (to a minimum of 0) after making the purchase.
...
| Score       | Affordable                                                                                                                            |
|-------------|---------------------------------------------------------------------------------------------------------------------------------------|
| 1           | Mundane clothing, gear, armor, [implements](../../Browse/rule/treasure/implement.md), and weapons; meals or drinks at a common tavern; a stay at a common inn; passage on a boat |
