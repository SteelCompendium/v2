...
You can don or remove a disguise as part of any test you make using the Hide skill, or while using the [Hide](../../Browse/feature/common/maneuvers/hide.md) maneuver.
