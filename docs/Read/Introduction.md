...
In a tactical game, *positioning matters*. So our game is played on a grid. Effects and distances are measured in squares. This means all players are focused on the same problem, and there is no ambiguity regarding where the heroes and villains are in relation to each other. The hobgoblin troopers are setting themselves up in a line to stop our [tactician](../Browse/Classes/Tactician.md#tactician) and [fury](../Browse/Classes/Fury.md#fury) from getting into melee with the hobgoblin war mage. We're all aware of what's happening, and we can talk about what we're going to do to stop it.
...
**[Background](../Chapters/Background.md#background):** A hero's culture and career.

**Bane:** A situational disadvantage that gives a creature a −2 penalty to a power roll.

**[Bleeding](../Browse/Conditions/Bleeding.md#bleeding):** A condition that causes a creature to take 1d6 + level damage whenever they use a main action or triggered action, or make a power roll using Might or Agility.
...
**[Burrow](../Browse/Movement/Burrow.md#burrow):** A movement mode available to creatures with "burrow" in their speed entry, or who gain the capability to temporarily [burrow](../Browse/Movement/Burrow.md#burrow). Such creatures can move through dirt horizontally at full speed.
...
**[Censor](../Browse/Classes/Censor.md#cen-or):** A class for a hero who is a trained warrior devoted to a saint or god.
...
**Charge Main Action:** A main action that allows a creature to move up to their speed in a straight line, then make a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) or use an ability with the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) keyword against a target when they end their move.

**Ceiling:** Any solid surface above a creature.

**Clarity:** The [talent](../Browse/Classes/Talent.md#talent)'s Heroic Resource. Unlike other Heroic Resources, clarity can go below 0, leaving a [talent](../Browse/Classes/Talent.md#talent) strained.

**Class:** A hero's current role, which largely determines how they interact with the game's rules.

**Claw Dirt:** An ability that uses a maneuver to allow a creature without "burrow" in their speed entry to [burrow](../Browse/Movement/Burrow.md#burrow).

**[Climb](../Browse/Movement/Climb or Swim.md#climbor-wim):** A movement mode that allows a creature to [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) without using additional squares of movement. A creature without "climb" in their speed entry or the temporary ability to [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) must use 2 squares of movement to [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) 1 square.
...
**[Crawl](../Browse/Movement/Crawl.md#crawl):** A movement mode that allows a [prone](../Browse/Conditions/Prone.md#prone) creature to move. A [prone](../Browse/Conditions/Prone.md#prone) creature must use 2 squares of movement to [crawl](../Browse/Movement/Crawl.md#crawl) 1 square.
...
**Damaging Terrain:** An area of obstacles that deal damage to creatures who are in the area or move through it. A creature can't shift into or out of damaging terrain, and can't [jump](../Browse/Movement/Jump.md#jump) out of damaging terrain.

**[Dazed](../Browse/Conditions/Dazed.md#dazed):** A condition that limits a creature to doing only one thing on their turn: use a main action, use a maneuver, or use a move action. A [dazed](../Browse/Conditions/Dazed.md#dazed) creature also can't use triggered actions, free triggered actions, or free maneuvers.
...
**[Devil](../Browse/Ancestries/Devil.md#devil):** An ancestry from the Seven Cities of Hell.

**Difficult Terrain:** An area of obstacles that are difficult to move through. It costs 1 additional square of movement to enter a square of difficult terrain. A creature can't shift into or out of difficult terrain, and can't [jump](../Browse/Movement/Jump.md#jump) out of difficult terrain.

**Dig Maneuver:** A maneuver that allows a creature with "burrow" in their speed entry or the temporary ability to [burrow](../Browse/Movement/Burrow.md#burrow) to move a number of squares equal to their size vertically through dirt.
...
**Discipline:** The [null](../Browse/Classes/Null.md#null)'s Heroic Resource.
...
**[Dragon Knight](../Browse/Ancestries/Dragon Knight.md#dragonknight):** An ancestry with a draconic heritage.

**Drama:** The [troubadour](../Browse/Classes/Troubadour.md#troubadour)'s Heroic Resource.

**[Dwarf](../Browse/Ancestries/Dwarf.md#dwarf):** An ancestry with stone skin and short stature.

**Dying:** A state a hero enters when their Stamina is 0 or lower but doesn't reach the negative of their winded value. While dying, a hero is [bleeding](../Browse/Conditions/Bleeding.md#bleeding) and they can't use the [Catch Breath](../Browse/Abilities/Common/Maneuvers/Catch Breath.md#catchbreath) maneuver in combat. A hero dies when their Stamina equals the negative of their winded value.
...
**[Elementalist](../Browse/Classes/Elementalist.md#elementali-t):** A class for a hero mage who wields the elemental forces of the timescape—earth, green, fire, the void, and more.
...
**Escape Grab Maneuver:** A maneuver that allows a [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature to make an ability roll to escape.

**Essence:** The [elementalist](../Browse/Classes/Elementalist.md#elementali-t)'s Heroic Resource.
...
**Falling:** When a creature falls 2 or more squares, they take 2 damage for each square they fall (to a maximum of 50 damage) and land [prone](../Browse/Conditions/Prone.md#prone). A falling creature can reduce the effective height of their fall by a number of squares equal to their Agility score (minimum 0).

**Ferocity:** The [fury](../Browse/Classes/Fury.md#fury)'s Heroic Resource.
...
**[Fly](../Browse/Movement/Fly.md#fly):** A movement mode available to creatures with "[fly](../Browse/Movement/Fly.md#fly)" in their speed entry, or who gain the capability to temporarily [fly](../Browse/Movement/Fly.md#fly). Such creatures can move through the air horizontally or diagonally at full speed and remain in midair. If a [flying](../Browse/Movement/Fly.md#fly) creature is made [prone](../Browse/Conditions/Prone.md#prone) or has their speed reduced to 0, they fall.

**Focus:** The [tactician](../Browse/Classes/Tactician.md#tactician)'s Heroic Resource.

**Forced Movement:** When an ability or effect compels a creature to move, usually against their will. There are three types of forced movement: a pull, a push, and a slide. Forced movement is always along the ground unless noted as [vertical](../Browse/Movement/Vertical.md#vertical). Forced movement can be reduced by [stability](../Browse/Movement/Stability.md#tability).
...
**[Frightened](../Browse/Conditions/Frightened.md#frightened):** A condition that causes a creature to take a bane on ability rolls against the source of their fear. The creature can't willingly move closer to the source of their fear, and that source gains an edge on ability rolls made against the creature.

**[Fury](../Browse/Classes/Fury.md#fury):** A class for a hero warrior who courses with the [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) of the Primordial Chaos.

**God:** A deity who grants power to their most devout worshipers through saint intermediaries.

**Grab Maneuver:** A maneuver that allows a creature to make an ability roll to make another creature [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by them.

**[Grabbed](../Browse/Conditions/Grabbed.md#grabbed):** A condition that reduces a creature's speed to 0 and causes them to take a bane on abilities that don't target the creature, object, or effect that has them [grabbed](../Browse/Conditions/Grabbed.md#grabbed).
...
**[Hakaan](../Browse/Ancestries/Hakaan.md#hakaan):** An ancestry with stone giant blood.
...
**Hide Maneuver:** A maneuver that allows a creature to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) from other creatures who aren't observing them.
...
**[Hover](../Browse/Movement/Hover.md#hover):** A creature who has "[hover](../Browse/Movement/Hover.md#hover)" in their speed entry (commonly alongside "[fly](../Browse/Movement/Fly.md#fly)" or "[teleport](../Browse/Movement/Teleport.md#teleport)"), or who gains the ability to temporarily [hover](../Browse/Movement/Hover.md#hover), can remain motionless in midair. They don't fall even if they are knocked [prone](../Browse/Conditions/Prone.md#prone) or their speed is reduced to 0.

**[Human](../Browse/Ancestries/Human.md#human):** An ancestry much like [humans](../Browse/Ancestries/Human.md#human) in the real world, except that they can sense magic.

**Humanoid:** Creatures who are of similar size to, have similar limb arrangements as, and have sapience on par with [humans](../Browse/Ancestries/Human.md#human).

**Implement:** A piece of jewelry, a staff, an orb, a wand, or some other object used by a creature to channel supernatural power.

**Insight:** The [shadow](../Browse/Classes/Shadow.md#hadow)'s Heroic Resource.
...
**[Jump](../Browse/Movement/Jump.md#jump):** A creature can automatically long [jump](../Browse/Movement/Jump.md#jump) a number of squares up to their Might or Agility score (their choice). The height of their [jump](../Browse/Movement/Jump.md#jump) is automatically 1 square as part of that movement. A creature who wants to [jump](../Browse/Movement/Jump.md#jump) farther or higher must make a Might or Agility test.
...
**Melee Free Strike:** A [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) made using a melee ability.

**[Memonek](../Browse/Ancestries/Memonek.md#memonek):** An ancestry of machine people.
...
**Mounted Combat:** Special rules that apply when one creature [rides](../Browse/Abilities/Common/Move Actions/Ride.md#ride) another into battle.
...
**Opportunity Attack:** When an adjacent enemy willingly moves away from a creature without shifting or [teleporting](../Browse/Movement/Teleport.md#teleport), the creature can make a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) as an opportunity attack against the enemy.
...
**[Orc](../Browse/Ancestries/Orc.md#orc):** An ancestry of people with magic blood in their glowing veins.

**Orden:** The prime manifold, where [humans](../Browse/Ancestries/Human.md#human), elves, [dwarves](../Browse/Ancestries/Dwarf.md#dwarf), and [orcs](../Browse/Ancestries/Orc.md#orc) share a world with dragons, goblins, kobolds, and dozens of other speaking peoples.
...
**Piety:** The [conduit](../Browse/Classes/Conduit.md#conduit)'s Heroic Resource.

**Pitfall:** A negotiation trait an NPC has that determines what type of arguments will not work on them.

**[Polder](../Browse/Ancestries/Polder.md#polder):** An ancestry of short folk who can slip into shadows to hide.
...
**[Prone](../Browse/Conditions/Prone.md#prone):** A condition that causes a creature to become flat on the ground. Strikes made by a [prone](../Browse/Conditions/Prone.md#prone) creature take a bane, and melee abilities used against a [prone](../Browse/Conditions/Prone.md#prone) creature gain an edge.
...
**Ranged Free Strike:** A [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) made using a ranged ability.
...
**[Restrained](../Browse/Conditions/Restrained.md#re-trained):** A condition that reduces a creature's speed to 0 and prevents them from using the Stand Up maneuver or being force moved.

**Retainer:** A follower who adventures alongside a hero.

**[Revenant](../Browse/Ancestries/Revenant.md#revenant):** An undead ancestry. [Revenants](../Browse/Ancestries/Revenant.md#revenant) return to the mortal world to complete unfinished business they had in life.
...
**[Sage](../Browse/Careers/Sage.md#age):** A follower who undertakes research projects for a hero.
...
**[Shadow](../Browse/Classes/Shadow.md#hadow):** A class for a hero who is an expert infiltrator and thief utilizing magic.
...
**[Slowed](../Browse/Conditions/Slowed.md#lowed):** A condition that reduces a creature's speed to 2.
...
**Speed:** A measure of how many squares a creature can move when taking the [Advance](../Browse/Abilities/Common/Move Actions/Advance.md#advance) move action during combat.

**Square:** The smallest unit of measurement on an encounter map. Distance, space, and speed are all reckoned in squares.

**Stability:** A measure of a creature's immovability. When a creature is force moved, the distance they can be force moved is reduced by a number of squares equal to their [stability](../Browse/Movement/Stability.md#tability).
...
**Stand Up Maneuver:** A maneuver that a [prone](../Browse/Conditions/Prone.md#prone) creature can use to end the [prone](../Browse/Conditions/Prone.md#prone) condition on themself. Alternatively, a creature can use this maneuver on a willing adjacent [prone](../Browse/Conditions/Prone.md#prone) creature to end the [prone](../Browse/Conditions/Prone.md#prone) condition on them.

**Strained:** A state the [talent](../Browse/Classes/Talent.md#talent) enters when they have clarity below 0, and which effects their abilities.
...
**[Swim](../Browse/Movement/Climb or Swim.md#climbor-wim):** A movement mode that allows a creature to [swim](../Browse/Movement/Climb or Swim.md#climbor-wim) without using additional squares of movement. A creature without "[swim](../Browse/Movement/Climb or Swim.md#climbor-wim)" in their speed entry or the temporary ability to [swim](../Browse/Movement/Climb or Swim.md#climbor-wim) must use 2 squares of movement to [swim](../Browse/Movement/Climb or Swim.md#climbor-wim) 1 square.

**[Tactician](../Browse/Classes/Tactician.md#tactician):** A class for a hero who is a brilliant strategist and weapons expert.

**[Talent](../Browse/Classes/Talent.md#talent):** A class for a hero who is a master of psionics.

**[Taunted](../Browse/Conditions/Taunted.md#taunted):** A condition that causes a creature to have a double bane on ability rolls that don't target the creature or effect that [taunted](../Browse/Conditions/Taunted.md#taunted) them.
...
**[Teleport](../Browse/Movement/Teleport.md#teleport):** Moving from one location to another instantaneously. [Teleporting](../Browse/Movement/Teleport.md#teleport) requires line of effect to the space where a creature ends up, bypasses obstacles, and doesn't provoke opportunity attacks or other effects triggered by moving.
...
**[Time Raider](../Browse/Ancestries/Time Raider.md#timeraider):** An ancestry of four-armed psionic folk with ocular sensors instead of eyes.
...
**[Troubadour](../Browse/Classes/Troubadour.md#troubadour):** A class for a hero who is a storytelling [swashbuckler](../Browse/Kits/Swashbuckler.md#wa-hbuckler).
...
**Vertical:** When any form of forced movement is noted as [vertical](../Browse/Movement/Vertical.md#vertical), the creature performing the forced movement can move the target up or down in addition to horizontally.
...
**[Walk](../Browse/Movement/Walk.md#walk):** The most common movement type, used to move over solid ground. [Walking](../Browse/Movement/Walk.md#walk) can incorporate ambulating on legs, rolling, slithering, or any other default method of movement.
...
**[Weakened](../Browse/Conditions/Weakened.md#weakened):** A condition that causes a creature to take a bane on power rolls.
...
**Wrath:** The [censor](../Browse/Classes/Censor.md#cen-or)'s Heroic Resource.
