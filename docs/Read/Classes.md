...
Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities—for example, the [censor](../../Browse/Classes/Censor)'s Judgment ability and the [null](../../Browse/Classes/Null)'s [Null](../../Browse/Classes/Null) Field ability—allow you to manipulate the value of potencies. If you build a hero who can adjust potencies, pay attention during combat! You might be able to help out a friend who needs a little boost to make their ability take full effect, or hinder an enemy about to lock down one of your allies.
...
For example, the [tactician](../../Browse/Classes/Tactician)'s [Overwatch](../../Browse/Abilities/Tactician/1st-Level%20Features/Overwatch) ability allows the [tactician](../../Browse/Classes/Tactician) to spend 1 focus to impose the [slowed](../../Browse/Conditions/Slowed) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](../../Browse/Classes/Tactician) targets a creature whose high Reason leaves them unaffected, the [tactician](../../Browse/Classes/Tactician) doesn't waste any focus. However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
A [troubadour](../../Browse/Classes/Troubadour)'s battle song, a [fury](../../Browse/Classes/Fury)'s building ferocity, and a [shadow](../../Browse/Classes/Shadow)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
For example, the [null](../../Browse/Classes/Null)'s [Null](../../Browse/Classes/Null) Field ability reduces the potencies of enemies within the field by 1. If two allied [nulls](../../Browse/Classes/Null) each have their [Null](../../Browse/Classes/Null) Field ability active and an enemy cultist is targeted by both abilities, that cultist's potencies are reduced by 1, not by 2.
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 1st-Level [Conduit](../../Browse/Classes/Conduit) Domain Features table. Additionally, you gain a skill from the chosen domain, selected from the skill group indicated on the table. (*Quick Build:* [Revitalizing Ritual](../../Browse/Conduit/1st-Level%20Features/Revitalizing%20Ritual) and the Heal skill from the Life domain.)
...
Your god grants you a ward that protects you from the faithless. Choose one of the following wards. You can change your ward along with your prayer (see Prayer above) by praying to your god as a respite activity. (*Quick Build:* [Bastion Ward](../../Browse/Conduit/1st-Level%20Features/Bastion%20Ward).)
...
**As an [elementalist](../../Browse/Classes/Elementalist), you can unleash your wrath across a field of foes, debilitate enemies, ward yourself and allies, manipulate terrain, warp space, and more. Your elemental specialization determines which of these talents you excel at.**
...
You can use a maneuver to shapeshift into a type of creature on the Green Animal Forms table. While in [animal form](../../Browse/Complications/Animal%20Form), you can speak, and you use your Reason score to make melee [free strikes](../../Browse/Abilities/Common/Main%20Actions/Free%20Strike). Your statistics stay the same except as noted on the table.
...
You choose a specific animal and appearance while in [animal form](../../Browse/Complications/Animal%20Form). For example, if you become a rodent, you might become a mouse, a rat, a shrew, or any other size 1T animal who fits the rodent type. When you take on an [animal form](../../Browse/Complications/Animal%20Form), your equipment either melds into your new form or falls undamaged to the ground (your choice). When you return to your true form, any melded gear reappears on your person.

You can revert back to your true form as a maneuver. You can't enter an [animal form](../../Browse/Complications/Animal%20Form) unless you are in your true form. When you are dying, you revert to your true form and can't turn back into an animal until you are no longer dying.
...
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ---------------- |
| 1st   | [Primordial Aspect](../../Browse/Fury/1st-Level%20Features/Primordial%20Aspect), Ferocity, [Growing Ferocity](../../Browse/Features/Fury/1st-Level%20Features/Growing%20Ferocity), Aspect Features, Aspect Triggered Action, [Mighty Leaps](../../Browse/Fury/1st-Level%20Features/Mighty%20Leaps), [Fury](../../Browse/Classes/Fury) Abilities                                                          | Signature, 3, 5           | -                |
...
Though you can't gain [ferocity outside of combat](../../Browse/Fury/1st-Level%20Features/Ferocity%20Outside%20of%20Combat), you can use your heroic abilities and effects that cost ferocity without spending it. Whenever you use an ability or effect outside of combat that costs ferocity, you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.
...
| Aspect     | Feature                                                                                                                                                                                            |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Berserker  | Kit, [Primordial Strength](../../Browse/Fury/1st-Level%20Features/Primordial%20Strength)                                                                                    |
| Reaver     | Kit, [Primordial Cunning](../../Browse/Fury/1st-Level%20Features/Primordial%20Cunning)                                                                                      |
| Stormwight | [Beast Shape](../../Browse/Fury/1st-Level%20Features/Beast%20Shape), [Relentless Hunter](../../Browse/Fury/1st-Level%20Features/Relentless%20Hunter) |
...
| ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Null](../../Browse/Classes/Null) Tradition, Discipline, [Null](../../Browse/Classes/Null) Field, [Inertial Shield](../../Browse/Abilities/Null/1st-Level%20Features/Inertial%20Shield), Discipline Mastery, [Null](../../Browse/Classes/Null) Speed, Psionic Augmentation, [Psionic Martial Arts](../../Browse/Null/1st-Level%20Features/Psionic%20Martial%20Arts), [Null](../../Browse/Classes/Null) Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Two signature, 3, 5           | 5                   |
| 3rd   | [Psionic Leap](../../Browse/Null/3rd-Level%20Features/Psionic%20Leap), Reorder, 7-Discipline Ability                                                                                                                                                                                                                                                                                                                                                                                                                                | Two signature, 3, 5, 7        | 5                   |
...
At the start of each of your turns, you can use a free triggered action to end one effect on you that is ended by a saving throw or that ends at the end of your turn. Alternatively, you can grant this benefit to one creature in the area of your [Null](../../Browse/Classes/Null) Field ability.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your [Null](../../Browse/Classes/Null) Field ability increases by 1. While the area of that ability is enlarged this way, each enemy who has I < AVERAGE and enters the area for the first time in a combat round or starts their turn there is [bleeding](../../Browse/Conditions/Bleeding) (save ends). Each ally who enters the area for the first time in a combat round or starts their turn there gains temporary Stamina equal to your Intuition score.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your [Null](../../Browse/Classes/Null) Field ability increases by 1. While the area of that ability is enlarged this way, you ignore difficult terrain and reduce the potency of enemy effects targeting you by 1 for you. You can also use a free triggered action at the start of each of your turns to end one effect on you that is ended by a saving throw or that ends at the end of your turn. Each ally in the area also gains these benefits.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your [Null](../../Browse/Classes/Null) Field ability increases by 1. While the area of that ability is enlarged this way, whenever an enemy in the area takes rolled damage, they take extra psychic damage equal to twice your Intuition score.
...
> | **📏 Self** | **🎯 Self** |
>
> **Effect:** You [jump](../../Browse/Movement/Jump) up to your speed without provoking opportunity attacks. Until the end of your next turn, a static afterimage of you remains in the space you left, and any enemy adjacent to your afterimage takes a bane on ability rolls. You can use your abilities from your own space or from the space of your afterimage as if you were still there. Additionally, if your [Null](../../Browse/Classes/Null) Field ability is active, your afterimage also projects the aura from that ability, which you control as if you were in the afterimage's space.
...
At the start of a combat encounter, you can spend 1 order to increase the size of your [Null](../../Browse/Classes/Null) Field by 1 until the end of the encounter.
...
Even before battle begins, your enemies struggle to keep up with your tactics. At the start of an encounter, you can use a free triggered action to use your Mark ability against one enemy you have line of effect to, even if you are surprised. You can then slide the marked target up to 3 squares, ignoring [stability](../../Browse/Movement/Stability). The target can't be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
| Level | Features                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Abilities                     | Tradition Abilities |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Talent](../../Browse/Classes/Talent) Tradition, Clarity and Strain, [Mind Spike](../../Browse/Abilities/Talent/1st-Level%20Features/Mind%20Spike), Psionic Augmentation, [Talent](../../Browse/Classes/Talent) Ward, [Telepathic Speech](../../Browse/Talent/1st-Level%20Features/Telepathic%20Speech), Tradition Features, [Talent](../../Browse/Classes/Talent) Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Two signature, 3, 5           | 5                   |
...
Psionic abilities are grouped into categories according to their effects, with each category comprising one of many [talent](../../Browse/Classes/Talent) traditions:
...
You manifest a variety of psionic powers that let you impact the environment, bolster your allies, and empower yourself. You can choose abilities across different [talent](../../Browse/Classes/Talent) traditions or focus on abilities tied to your chosen tradition to dedicate yourself to its power.
...
| Tradition   | Features                                                                                               |
| ----------- | ------------------------------------------------------------------------------------------------------ |
| Chronopathy | [Ease the Hours](../../Browse/Talent/2nd-Level%20Features/Ease%20the%20Hours)   |
| Telekinesis | [Ease Their Fall](../../Browse/Talent/2nd-Level%20Features/Ease%20Their%20Fall) |
| Telepathy   | [Ease the Mind](../../Browse/Talent/2nd-Level%20Features/Ease%20the%20Mind)     |
...
| Tradition   | Features                                                                                                                                                                                                       |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Chronopathy | [Doubling the Hours](../../Browse/Talent/8th-Level%20Features/Doubling%20the%20Hours), [Stasis Shield](../../Browse/Talent/8th-Level%20Features/Stasis%20Shield) |
| Telekinesis | [Levitation Field](../../Browse/Abilities/Talent/8th-Level%20Features/Levitation%20Field), [Low Gravity](../../Browse/Talent/8th-Level%20Features/Low%20Gravity) |
| Telepathy   | [Mindlink](../../Browse/Talent/8th-Level%20Features/Mindlink), [Universal Connection](../../Browse/Talent/8th-Level%20Features/Universal%20Connection)           |
...
You start off with the Choreography and [Revitalizing Limerick](../../Browse/Abilities/Troubadour/1st-Level%20Features/Revitalizing%20Limerick) performance abilities. Your choice of class act grants you additional performances.
