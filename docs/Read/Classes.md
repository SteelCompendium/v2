...
Your class provides you with many of your features, most of your abilities—your most potent combat moves and noncombat options and a Heroic Resource that fuels many of those abilities. This book presents nine [classes](../Chapters/Classes.md#classes) to choose from.

**[Censor](../Browse/Classes/Censor.md#censor):** A [censor](../Browse/Classes/Censor.md#censor) is a trained warrior devoted to a saint or god. They hunt down the forces of evil using melee weapons and magic granted to them by their divine patron, specializing in confronting the wicked and locking down single enemies during combat.
...
- The [censor](../Browse/Classes/Censor.md#censor)'s wrath
- The [conduit](../Browse/Classes/Conduit.md#conduit)'s piety
- The [elementalist](../Browse/Classes/Elementalist.md#elementalist)'s essence
- The [fury](../Browse/Classes/Fury.md#fury)'s ferocity
- The [null](../Browse/Classes/Null.md#null)'s discipline
- The [shadow](../Browse/Classes/Shadow.md#shadow)'s insight
...
An ability never has both the Melee and Ranged keywords at the same time. For example, if you have the [Cloak and Dagger](../Browse/Kits/Cloak and Dagger.md#cloak-and-dagger) kit, which has a weapon damage bonus to melee abilities and a weapon damage bonus to ranged abilities, only one bonus at a time applies to an ability with both the Melee and Ranged keywords. (See [Chapter 6: Kits](#page-231-0).)
...
Using the [fury](../Browse/Classes/Fury.md#fury)'s [Brutal Slam](../Browse/Abilities/Fury/1st-Level Features/Brutal Slam.md#brutal-slam) ability as an example again, that ability uses a Might power roll and features the following damage expressions in the three tier outcomes of the power roll:
...
Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities—for example, the [censor](../Browse/Classes/Censor.md#censor)'s [Judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) ability and the [null](../Browse/Classes/Null.md#null)'s Null Field ability—allow you to manipulate the value of potencies. If you build a hero who can adjust potencies, pay attention during combat! You might be able to help out a friend who needs a little boost to make their ability take full effect, or hinder an enemy about to lock down one of your allies.
...
For example, the [tactician](../Browse/Classes/Tactician.md#tactician)'s [Overwatch](../Browse/Abilities/Tactician/1st-Level Features/Overwatch.md#overwatch) ability allows the [tactician](../Browse/Classes/Tactician.md#tactician) to spend 1 focus to impose the [slowed](../Browse/Conditions/Slowed.md#slowed) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](../Browse/Classes/Tactician.md#tactician) targets a creature whose high Reason leaves them unaffected, the [tactician](../Browse/Classes/Tactician.md#tactician) doesn't waste any [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus). However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
A [troubadour](../Browse/Classes/Troubadour.md#troubadour)'s battle song, a [fury](../Browse/Classes/Fury.md#fury)'s building [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity), and a [shadow](../Browse/Classes/Shadow.md#shadow)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
If an ability's effect allows you to take a main action, a maneuver, a move action, or a triggered action, the cost of doing so is subsumed in the ability's type entry on the first line below the flavor text. You never need to spend additional time to use an ability. For example, the [shadow](../Browse/Classes/Shadow.md#shadow)'s Black Ash [Teleport](../Browse/Movement/Teleport.md#teleport) ability is a maneuver that allows you to [teleport](../Browse/Movement/Teleport.md#teleport) and then use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver as its overall effect. Using the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver is part of the maneuver to use the ability, so that you don't need to have another maneuver available to do so.
...
A creature can release a creature they have [grabbed](../Browse/Conditions/Grabbed.md#grabbed) at any time to end that condition (no action required). A [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature can attempt to escape being [grabbed](../Browse/Conditions/Grabbed.md#grabbed) using the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#escape-grab) maneuver (see [Chapter 10: Combat](#page-288-0)). If a [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature [teleports](../Browse/Movement/Teleport.md#teleport), or if either the [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature or the creature grabbing them is force moved so that both creatures are not adjacent to each other, that creature is no longer [grabbed](../Browse/Conditions/Grabbed.md#grabbed).
...
A creature who is [restrained](../Browse/Conditions/Restrained.md#restrained) has speed 0, can't use the Stand Up maneuver, and can't be force moved. A [restrained](../Browse/Conditions/Restrained.md#restrained) creature takes a bane on ability rolls and on Might and Agility tests, and abilities used against them gain an edge.

If a creature [teleports](../Browse/Movement/Teleport.md#teleport) while [restrained](../Browse/Conditions/Restrained.md#restrained), that condition ends.

##### Slowed

A creature who is [slowed](../Browse/Conditions/Slowed.md#slowed) has speed 2 unless their speed is already lower, and they can't shift.
...
For example a 6th-level [censor](../Browse/Classes/Censor.md#censor) has "Signature, 3, 5, 7, 9" in their Abilities column, and "5, 9" in their Order Abilities column (representing the [censor](../Browse/Classes/Censor.md#censor)'s subclass). This means a [censor](../Browse/Classes/Censor.md#censor) of that level has a signature ability and four heroic abilities costing 3, 5, 7, and 9 wrath respectively, plus an additional two subclass heroic abilities costing 5 and 9 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath).
...
Demons and deathless fear you. Criminals run from the sight of your shadow. Agents of chaos, blasphemers, and heretics tremble at the sound of your voice. You carry the power of the gods, armed with [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath) and sent out into the world first to seek, then [censor](../Browse/Classes/Censor.md#censor) those whose actions—or even existence—are anathema to your church.

As a [censor](../Browse/Classes/Censor.md#censor), you're at your best against the strongest foes. Your [judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) terrifies heretics, stops enemies in their tracks, and even hurls them across the battlefield.
...
As a 2nd-level [censor](../Browse/Classes/Censor.md#censor), you gain the following features.
...
As a 4th-level [censor](../Browse/Classes/Censor.md#censor), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 4th-Level [Censor](../Browse/Classes/Censor.md#censor) Domain Features table.
...
As a 5th-level [censor](../Browse/Classes/Censor.md#censor), you gain the following features.
...
As a 7th-level [censor](../Browse/Classes/Censor.md#censor), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 7th-Level [Censor](../Browse/Classes/Censor.md#censor) Domain Features table.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 4 + I holy damage; P < WEAK, before taking damage, the target makes a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) against a target you choose
...
> **Power Roll + Intuition:**
>
> - **≤11:** 2 damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **12-16:** 3 damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **17+:** 7 damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
...
Each time you finish a respite, you can choose a willing hero ally who finished the respite with you. That ally gains the benefits of your [Burgeoning Saint](../Browse/Features/Conduit/6th-Level Features/Burgeoning Saint.md#burgeoning-saint) feature until you finish another respite. Additionally, you can spend [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) as a free maneuver to give the hero 1 of their Heroic Resource for every 2 piety spent.
...
[Divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divine-power) remains until you spend it.
...
As a 1st-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
You choose an [elemental specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-specialization) from the following options: earth, fire, green, or void. Your [elemental specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-specialization) is your subclass, and your choice of specialization determines many of the features you'll gain as you gain new levels, including one of the following benefits. (Other [elemental specializations](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-specialization) will be featured in future products.) (*Quick Build:* Fire.)

##### Earth: Acolyte of Earth

You harness the flow of earth magic to become harder to move. Whenever you use an ability that has the Earth and Magic keywords, your [stability](../Browse/Movement/Stability.md#stability) increases by 1 until the start of your next turn. This benefit is cumulative.
...
You channel the substance of creation in the form of a Heroic Resource called [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#essence), gathering and burning it to cast and maintain spells.
...
As a 2nd-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
As a 3rd-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
As a 4th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
| Specialization | Feature                                                                                                                                   |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Quaking Earth](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Quaking Earth.md#quaking-earth)     |
| Fire           | [Burning Grounds](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Burning Grounds.md#burning-grounds) |
| Green          | [Flowering Bed](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Flowering Bed.md#flowering-bed)     |
| Void           | [Veiling Bed](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Veiling Bed.md#veiling-bed)         |
...
As a 5th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 corruption damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **12-16:** 3 corruption damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **17+:** 5 corruption damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
>
> **Effect:** The area is difficult terrain until the start of your next turn. Each enemy who ends their turn in the area is [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends).
>
> **Persistent 1:** The area remains until the start of your next turn.

### 6th-Level Features

As a 6th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
>
> - Their size and [stability](../Browse/Movement/Stability.md#stability) increase by 2, with any size 1 target becoming size 3. Each creature who is within the target's new space slides to the nearest unoccupied space, ignoring [stability](../Browse/Movement/Stability.md#stability). If the target doesn't have space to grow, they grow as much as they can and become [restrained](../Browse/Conditions/Restrained.md#restrained) until the effect ends.
...
As a 7th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
When you gain [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#essence) at the start of each of your turns during combat, you gain 3 essence instead of 2.
...
As an 8th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
> | **📏 Ranged 10**         |  **🎯 Special** |
>
> **Effect:** A size 5 tree appears in an unoccupied space within distance. The tree has 100 Stamina and can't be force moved. You and any ally can touch the tree to use the [Catch Breath](../Browse/Abilities/Common/Maneuvers/Catch Breath.md#catch-breath) maneuver as a free maneuver. Additionally, when you start your turn with line of effect to the tree, you can end one effect on yourself that is ended by a saving throw or that ends at the end of your turn, or you can stand up if you are [prone](../Browse/Conditions/Prone.md#prone). Each ally within distance also gains this benefit.
>
> Each enemy who ends their turn within 3 squares of the tree is [restrained](../Browse/Conditions/Restrained.md#restrained) until the end of their next turn. A creature [restrained](../Browse/Conditions/Restrained.md#restrained) this way can use a main action to end the effect early.
...
As a 10th-level [elementalist](../Browse/Classes/Elementalist.md#elementalist), you gain the following features.
...
| Specialization | Feature                                                                                                                    |
| -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Master of Earth](../Browse/Features/Elementalist/10th-Level Features/One/Master of Earth.md#master-of-earth) |
| Fire           | [Master of Fire](../Browse/Features/Elementalist/10th-Level Features/One/Master of Fire.md#master-of-fire)   |
| Green          | [Master of Green](../Browse/Features/Elementalist/10th-Level Features/One/Master of Green.md#master-of-green) |
| Void           | [Master of Void](../Browse/Features/Elementalist/10th-Level Features/One/Master of Void.md#master-of-void)   |
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- | ---------------- |
| 1st   | [Primordial Aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordial-aspect), [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity), [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growing-ferocity), Aspect Features, [Aspect Triggered Action](../Browse/Features/Fury/1st-Level Features/Aspect Triggered Action.md#aspect-triggered-action), [Mighty Leaps](../Browse/Features/Fury/1st-Level Features/Mighty Leaps.md#mighty-leaps), [Fury](../Browse/Classes/Fury.md#fury) Abilities | Signature, 3, 5           | -                |
| 2nd   | Perk, Aspect Feature, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Signature, 3, 5           | 5                |
| 3rd   | Aspect Feature, 7-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7        | 5                |
| 4th   | [Characteristic Increase](../Browse/Features/Fury/4th-Level Features/Characteristic Increase.md#characteristic-increase), [Damaging Ferocity](../Browse/Features/Fury/4th-Level Features/Damaging Ferocity.md#damaging-ferocity), [Growing Ferocity Improvement](../Browse/Features/Fury/7th-Level Features/Growing Ferocity Improvement.md#growing-ferocity-improvement), Perk, [Primordial Attunement](../Browse/Features/Fury/4th-Level Features/Primordial Attunement.md#primordial-attunement), [Primordial Strike](../Browse/Features/Fury/4th-Level Features/Primordial Strike.md#primordial-strike), Skill           | Signature, 3, 5, 7        | 5                |
| 5th   | Aspect Feature, 9-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7, 9     | 5                |
| 6th   | [Marauder of the Primordial Chaos](../Browse/Features/Fury/6th-Level Features/Marauder of the Primordial Chaos.md#marauder-of-the-primordial-chaos), Perk, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9     | 5, 9             |
| 7th   | [Characteristic Increase](../Browse/Features/Fury/7th-Level Features/Characteristic Increase.md#characteristic-increase), [Elemental Form](../Browse/Features/Fury/7th-Level Features/Elemental Form.md#elemental-form), [Greater Ferocity](../Browse/Features/Fury/7th-Level Features/Greater Ferocity.md#greater-ferocity), [Growing Ferocity Improvement](../Browse/Features/Fury/7th-Level Features/Growing Ferocity Improvement.md#growing-ferocity-improvement), Skill                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5, 9             |
| 8th   | Perk, Aspect Feature, 11-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9             |
| 9th   | [Harbinger of the Primordial Chaos](../Browse/Features/Fury/9th-Level Features/Harbinger of the Primordial Chaos.md#harbinger-of-the-primordial-chaos), Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
| 10th  | [Chaos Incarnate](../Browse/Features/Fury/10th-Level Features/Chaos Incarnate.md#chaos-incarnate), [Characteristic Increase](../Browse/Features/Fury/10th-Level Features/Characteristic Increase.md#characteristic-increase), [Growing Ferocity Improvement](../Browse/Features/Fury/10th-Level Features/Growing Ferocity Improvement.md#growing-ferocity-improvement), Perk, [Primordial Ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordial-ferocity), [Primordial Power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordial-power), Skill                | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
...
Your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growing-ferocity) feature provides additional benefits when you have 8 or more [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; M < WEAK, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
> - **12-16:** 13 + M damage; M < AVERAGE, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
> - **17+:** 18 + M damage; M < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
>
> **Effect:** While the target is [slowed](../Browse/Conditions/Slowed.md#slowed) this way, any other effect that would make the target [slowed](../Browse/Conditions/Slowed.md#slowed) instead makes them [restrained](../Browse/Conditions/Restrained.md#restrained) by this ability. Additionally, a creature who fails the saving throw while [restrained](../Browse/Conditions/Restrained.md#restrained) this way is petrified until they are given a supernatural cure or you choose to reverse the effect (no action required).
...
Your [primordial aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordial-aspect) grants you a feature, as shown on the 8th-Level Aspect Features table.

###### 8th-Level Aspect Features Table

| Aspect     | Feature                                                                                                                                          |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Berserker  | [Strongest There Is](../Browse/Features/Fury/8th-Level Features/8th-Level Aspect Feature/Strongest There Is.md#strongest-there-is) |
| Reaver     | [A Step Ahead](../Browse/Features/Fury/8th-Level Features/8th-Level Aspect Feature/A Step Ahead.md#a-step-ahead)             |
...
You move with legendary grace. Whenever you make an Agility test, you can roll three dice and choose which two to use. Additionally, whenever you use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action, the distance you can shift gains a bonus equal to your Agility score.
...
You can create a temporary source of elemental power as a respite activity. This source of elemental power lasts 24 hours after creation, and can be used to create a portal to Quintessence with your [Primordial Portal](../Browse/Features/Fury/6th-Level Features/Primordial Portal.md#primordial-portal) feature. If you do so, the source of elemental power lasts as long as the portal is maintained in your network.
...
Your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growing-ferocity) feature provides additional benefits when you have 12 or more [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
You can also spend 3 [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordial-power) to create a portal to Quintessence without needing a source of elemental power.

[Primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordial-power) remains until you spend it.
...
Your [primordial aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordial-aspect) benefits are always available to you, and you gain additional benefits while in the animal or hybrid form granted by your stormwight kit.
...
Each stormwight kit grants a set of benefits for your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growing-ferocity) feature.

#### Boren

With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordial-ferocity) into the form of a bear, becoming large, durable, and imposing. Boren are tied to the craggy, rocky north, and this aspect is associated with the blizzard's bitter cold.
...
- **[Stability](../Browse/Movement/Stability.md#stability) Bonus:** +2
...
With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordial-ferocity) into the form of a crow, becoming stealthy and quick. Corven are tied to the mountain passes and the hot winds that flow through them. This aspect is associated with the warm and fast-rising anabatic wind.
...
- **[Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) Bonus:** +1
...
| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                           | Whenever you use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action, the distance you can shift gains a bonus equal to your Agility score.                                                         |
| 4                                                                                           | The first time you shift on a turn, you gain 1 surge.                                                                                                                                                                                                      |
| 6                                                                                           | You gain an edge on Agility tests, the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#escape-grab) maneuver, and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.       |
| 8 (4th level)                                                                               | The first time you shift on a turn, you gain 2 surges instead of 1.                                                                                                                                                                                        |
| 10 (7th level)                                                                              | You have a double edge on Agility tests, the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#escape-grab) maneuver, and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver. |
...
With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordial-ferocity) into the form of a rat, becoming mobile and elusive. Raden are associated with the wild nature of the rat, before cities became their habitat. This aspect is associated with the rat flood—a surge of corrupted water that draws forth hordes of rats.
...
While you are in your rat form, your size is 1T and you can automatically [climb](../Browse/Movement/Climb or Swim.md#climb-or-swim) at full speed while moving. You can use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver as a free maneuver, you can use your allies as cover when you [hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide), and you can stay hidden while you move through squares occupied by any creature. Additionally, you gain an edge on tests made to [climb](../Browse/Movement/Climb or Swim.md#climb-or-swim) other creatures. You can't use any abilities while in this form except for Aspect of the Wild.

##### Hybrid Form: Rat

While you are in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can automatically [climb](../Browse/Movement/Climb or Swim.md#climb-or-swim) at full speed while moving.
...
With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordial-ferocity) into the form of a wolf, becoming a fleet-footed hunter. Vuken are tied to forests and open steppes, and this aspect is associated with the thunderstorm.

##### Aspect Benefits

Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can then use the [Aid Attack](../Browse/Abilities/Common/Maneuvers/Aid Attack.md#aid-attack) maneuver as a free triggered action.
...
As your mastery of your body and tradition grows, it imbues you with a Heroic Resource called [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline).
...
Though you can't gain [discipline outside of combat](../Browse/Features/Null/1st-Level Features/Discipline/Discipline Outside of Combat.md#discipline-outside-of-combat), you can use your heroic abilities and effects that cost discipline without spending it. Whenever you use an ability or effect outside of combat that costs [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited discipline on its effect, you can use it as if you had spent an amount of [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline) equal to your Victories. (Such abilities aren't part of the core rules for the [null](../Browse/Classes/Null.md#null), but they might appear in future products.)
...
| [Discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline) | Benefit                                                                                                                                                                                                                                                                                                     |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                               | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action as a free triggered action either before or after the maneuver. |
...
The flow of psionic power through you allows you to achieve high velocity. You gain a bonus to speed and to the number of squares you can shift when you take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action equal to your Agility score.

#### Psionic Augmentation

Your training has turned your body into the perfect psionic weapon, shaping pathways in your mind that enhance your physical form. Choose one of the following augmentations. You can change your augmentation by undergoing a psionic meditation as a respite activity. (*Quick Build:* [Speed Augmentation](../Browse/Features/Talent/1st-Level Features/Psionic Augmentation/Speed Augmentation.md#speed-augmentation).)
...
| Tradition     | Feature                                                                                                                                         |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Chronokinetic | [Shared Momentum](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Shared Momentum.md#shared-momentum)     |
| Cryokinetic   | [Synaptic Triage](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Synaptic Triage.md#synaptic-triage)     |
| Metakinetic   | [Inertial Dampener](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Inertial Dampener.md#inertial-dampener) |

##### Inertial Dampener

You and each creature or object of your choice in the area of your Null Field ability gain a bonus to [stability](../Browse/Movement/Stability.md#stability) equal to your Intuition score. A creature who attempts to force move a target with this bonus takes psychic damage equal to your Intuition score.

##### Shared Momentum

When you take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action, one ally in the area of your Null Field ability can also take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action as a free triggered action, using your distance for that move action.
...
Your [Discipline Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery.md#discipline-mastery) feature provides additional benefits when you have 12 or more [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline).

#### Manifold Body

When you gain [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#discipline) at the start of each of your turns during combat, you gain 4 discipline instead of 3.
...
Whenever you use an ability, you gain 1 discipline that can be used only to apply a benefit from your [Psi Boost](../Browse/Features/Talent/6th-Level Features/Psi Boost.md#psi-boost) feature to that ability. Additionally, you and allies in the area of your Null Field ability ignore banes and double banes on your power rolls.
...
| 9th   | [Gloom Squad](../Browse/Features/Shadow/9th-Level Features/Gloom Squad.md#gloom-squad), College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |
| 10th  | [Characteristic Increase](../Browse/Features/Shadow/10th-Level Features/Characteristic Increase.md#characteristic-increase), [Death Pool](../Browse/Features/Shadow/10th-Level Features/Death Pool.md#death-pool), Perk, Skill, [Careful Observation Improvement](../Browse/Features/Shadow/10th-Level Features/Careful Observation Improvement.md#careful-observation-improvement), [Improved Umbral Form](../Browse/Features/Shadow/10th-Level Features/Improved Umbral Form.md#improved-umbral-form), [Subterfuge](../Browse/Features/Shadow/10th-Level Features/Subterfuge.md#subterfuge) | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |

### 1st-Level Features

As a 1st-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.

#### Shadow College

[Shadow](../Browse/Classes/Shadow.md#shadow) colleges are secret institutions that turn ordinary folk into something else. Finding a college is the first step in a rigorous initiation process that tests the mettle of an applicant. Even those who make the cut often wash out—or are kicked out—as the master shadows who teach stealth, magic, and assassination to their students are often less than gentle in their approach.

You graduated from a [shadow](../Browse/Classes/Shadow.md#shadow) college chosen from the following options, each of which grants you a skill. (*Quick Build:* College of Black Ash.)

- College of Black Ash: The College of Black Ash founded the art of being a [shadow](../Browse/Classes/Shadow.md#shadow). Its graduates are unmatched in mobility, using sorcery to [teleport](../Browse/Movement/Teleport.md#teleport) around the battlefield, manipulate shadows, and summon darkness. You have the Magic skill.
...
Your [shadow](../Browse/Classes/Shadow.md#shadow) college is your subclass, and your choice of college determines many of the features you'll gain as you gain new levels.

#### Insight

By observing your enemy, you learn how to use their weaknesses against them, building up a Heroic Resource called [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight).

##### Insight in Combat

At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight) equal to your Victories. At the start of each of your turns during combat, you gain 1d3 [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight).

Additionally, the first time each combat round that you deal damage incorporating 1 or more surges, you gain 1 [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight).
...
Although you can't gain [insight outside of combat](../Browse/Features/Shadow/1st-Level Features/Insight/Insight Outside of Combat.md#insight-outside-of-combat), you can use your heroic abilities and effects that cost insight without spending it. Whenever you use an ability or effect outside of combat that costs [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited insight on its effect, such as Black Ash [Teleport](../Browse/Movement/Teleport.md#teleport), you can use it as if you had spent an amount of [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#insight) equal to your Victories.
...
You can use and gain the benefits of a kit. See Chapter 6: Kits for more information. (*Quick Build:* [Cloak and Dagger](../Browse/Kits/Cloak and Dagger.md#cloak-and-dagger).)
...
As a 2nd-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
Your [shadow](../Browse/Classes/Shadow.md#shadow) college grants you a feature, as shown on the 2nd-Level College Features table.

###### 2nd-Level College Features Table

| College         | Feature                                                                                                                                       |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Black Ash       | [Burning Ash](../Browse/Features/Shadow/2nd-Level Features/2nd-Level College Feature/Burning Ash.md#burning-ash)           |
| Caustic Alchemy | [Trained Assassin](../Browse/Features/Shadow/2nd-Level Features/2nd-Level College Feature/Trained Assassin.md#trained-assassin) |
| Harlequin Mask  | Friend!                                                                                                                                       |

##### Burning Ash

The ash you leave behind burns your foes. The first time on a turn that you use a [shadow](../Browse/Classes/Shadow.md#shadow) ability to [teleport](../Browse/Movement/Teleport.md#teleport) away from or into a space adjacent to an enemy, that enemy takes fire damage equal to your Agility score.
...
Additionally, when you use your I'm No Threat ability, you can take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action as part of that ability.
...
As a 3rd-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, whenever an enemy moves or is force moved adjacent to you or damages you, you can take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action as a free triggered action.
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + A damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **12-16:** 12 + A damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **17+:** 16 + A damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; M < WEAK, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
...
As a 4th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
As a 5th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.

#### 5th-Level College Feature

Your [shadow](../Browse/Classes/Shadow.md#shadow) college grants you a feature, as shown on the 5th-Level College Features table.

###### 5th-Level College Features Table

| College         | Feature                                                                                                                                         |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Black Ash       | [Trail of Cinders](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Trail of Cinders.md#trail-of-cinders) |
| Caustic Alchemy | [Volatile Reagents](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Volatile Reagents.md#volatile-reagents) |
| Harlequin Mask  | [Harlequin Gambit](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Harlequin Gambit.md#harlequin-gambit)   |
...
As a 7th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
As an 8th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 11 corruption damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **12-16:** 16 corruption damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
> - **17+:** 21 corruption damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (save ends)
...
As a 9th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
As a 10th-level [shadow](../Browse/Classes/Shadow.md#shadow), you gain the following features.
...
You gain full control over the [shadow](../Browse/Classes/Shadow.md#shadow) creature you become with your [Umbral Form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbral-form) feature, and you can end the transformation at will (no action required). Additionally, you are always wreathed in darkness that grants you concealment while in this form, and creatures no longer gain an edge on strikes against you.

While you are in your [umbral form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbral-form), you can spend 1 uninterrupted minute concentrating on a location where you've been before. At the end of that minute, you and each willing creature of your choice within 10 squares of you can [teleport](../Browse/Movement/Teleport.md#teleport) to unoccupied spaces of your choice within that location. Each creature who [teleports](../Browse/Movement/Teleport.md#teleport) this way is invisible for 1 hour or until they use an ability.
...
[Subterfuge](../Browse/Features/Shadow/10th-Level Features/Subterfuge.md#subterfuge) remains until you spend it.
...
Warfare is as old as civilization—and perhaps even older. As battle became ever more complex, military leaders invented [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine), outlining how combatants should be structured, used, and deployed. Doctrine can be learned at war colleges passing on ancient martial traditions, or directly through blood and sweat on the battlefield. Whatever path brought you to your mastery of historically proven tactics, you choose a [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) from the following options, each of which grants you a skill. (*Quick Build:* Vanguard and the Intimidate skill.)
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) is your subclass, and your choice of doctrine determines many of the features you'll gain as you gain new levels.
...
Though you can't gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus) outside of combat, you can use your heroic abilities and effects that cost focus without spending it. Whenever you use an ability or effect outside of combat that costs [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited focus on its effect, you can use it as if you had spent an amount of [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus) equal to your Victories. (Such abilities aren't part of the core rules for the [tactician](../Browse/Classes/Tactician.md#tactician), but they might appear in future products.)
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) grants you a feature, as shown on the 1st-Level Doctrine Features table.

###### 1st-Level Doctrine Features Table

| Doctrine   | Feature                                                                                                                                                 |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Covert Operations](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Covert Operations.md#covert-operations)     |
| Mastermind | [Studied Commander](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Studied Commander.md#studied-commander)     |
| Vanguard   | [Commanding Presence](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Commanding Presence.md#commanding-presence) |
...
You have drilled with a broad array of arms and armor, and have developed techniques to optimize their use. You can use and gain the benefits of two kits, including both their signature abilities. Whenever you would choose or change one kit, you can choose or change your second kit as well. See Chapter 6: Kits for more information. (*Quick Build:* [Shining Armor](../Browse/Kits/Shining Armor.md#shining-armor), [Sniper](../Browse/Kits/Sniper.md#sniper).)
...
For example, if you take the [Shining Armor](../Browse/Kits/Shining Armor.md#shining-armor) and [Sniper](../Browse/Kits/Sniper.md#sniper) kits, you gain the following benefits overall:

- Stamina Bonus: +12 per echelon
- [Stability](../Browse/Movement/Stability.md#stability) Bonus: +1
- Melee Damage Bonus: +2/+2/+2
...
[Kit signature abilities](../Browse/Features/Tactician/1st-Level Features/Tactician Abilities/Kit Signature Ability.md#kit-signature-ability) have their kit's bonuses already applied, which might require you to adjust the bonuses of the signature abilities you gain from a kit. For example, you might take the [Martial Artist](../Browse/Kits/Martial Artist.md#martial-artist) kit, which gives a melee weapon damage bonus of +2/+2/+2, and the [Mountain](../Browse/Kits/Mountain.md#mountain) kit, which gives a melee weapon damage bonus of +0/+0/+4. If you choose to use the [Mountain](../Browse/Kits/Mountain.md#mountain) kit's damage bonus, then the Battle Grace signature ability from the [Martial Artist](../Browse/Kits/Martial Artist.md#martial-artist) kit loses the +2/+2/+2 bonus from that kit, reducing its usual 5/8/11 damage for its tier 1, tier 2, and tier 3 outcomes to 3/6/9. It then gains the +0/+0/+4 of the [Mountain](../Browse/Kits/Mountain.md#mountain) kit to deal 3/6/13 damage.
...
>
> You can initially mark only one creature using this ability, though other [tactician](../Browse/Classes/Tactician.md#tactician) abilities allow you to mark additional creatures at the same time. The mastermind [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine)'s [Anticipation](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Anticipation.md#anticipation) feature allows you to target additional creatures with this ability starting at 5th level.
>
...
> | **📏 Ranged 10** | **🎯 Three allies** |
>
> **Effect:** Each target can make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike).
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) grants you a feature, as shown on the 2nd-Level Doctrine Features table.

###### 2nd-Level Doctrine Features Table

| Doctrine   | Feature                                                                                                                                                   |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Infiltration Tactics](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Infiltration Tactics.md#infiltration-tactics) |
| Mastermind | [Goaded](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Goaded.md#goaded)                               |
| Vanguard   | [Melee Superiority](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Melee Superiority.md#melee-superiority)       |
...
>
> **Effect:** Each target is marked by you, and must immediately make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) against a creature of your choice within 5 squares of them.
>
> **Mark Benefit:** Until the end of the encounter, whenever you or any ally makes a strike against a creature marked by you, you can spend 2 focus to force that target to make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) against a creature of your choice within 5 squares of them.
...
> | **📏 1 burst** | **🎯 Self and each ally in the area** |
>
> **Effect:** Until the start of your next turn, each target has a bonus to [stability](../Browse/Movement/Stability.md#stability) equal to your Might score. Additionally, each target gains 2 surges.
...
Even before battle begins, your enemies struggle to keep up with your tactics. At the start of an encounter, you can use a free triggered action to use your [Mark](../Browse/Features/Tactician/1st-Level Features/Mark.md#mark) ability against one enemy you have line of effect to, even if you are surprised. You can then slide the marked target up to 3 squares, ignoring [stability](../Browse/Movement/Stability.md#stability). The target can't be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) grants you two features, as shown on the 5th-Level Doctrine Features table.

###### 5th-Level Doctrine Features Table

| Doctrine   | Features                                                                                                                                                                                                                                                                                             |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Distracted](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Distracted.md#distracted), [Leave No Trace](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Leave No Trace.md#leave-no-trace)               |
| Mastermind | [Anticipation](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Anticipation.md#anticipation), [I Predicted That](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/I Predicted That.md#i-predicted-that)       |
| Vanguard   | [Shake It Off](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Shake It Off.md#shake-it-off), [Tactical Offensive](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Tactical Offensive.md#tactical-offensive) |
...
When you use the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action to attack a creature marked by you, you can use a signature or heroic ability with the Melee and Strike keywords instead of a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike).
...
>
> **Effect:** If a target is force moved into another creature, they must make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) against that creature.
...
When you gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus) at the start of each of your turns during combat, you gain 3 focus instead of 2.
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tactical-doctrine) grants you a feature, as shown on the 7th-Level Doctrine Features table.

###### 7th-Level Doctrine Features Table

| Doctrine   | Feature                                                                                                                                               |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Asymmetric Warfare](../Browse/Features/Tactician/7th-Level Features/7th-Level Doctrine Feature/Asymmetric Warfare.md#asymmetric-warfare) |
| Mastermind | [Grand Strategy](../Browse/Features/Tactician/7th-Level Features/7th-Level Doctrine Feature/Grand Strategy.md#grand-strategy)         |
| Vanguard   | [Shock and Awe](../Browse/Features/Tactician/7th-Level Features/7th-Level Doctrine Feature/Shock and Awe.md#shock-and-awe)         |
...
Your expertise with weapons has grown to true mastery. Whenever you use a signature ability from one of your equipped kits or make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) using a weapon from one of your equipped kits, you automatically obtain a tier 3 outcome on the power roll. You can still roll to determine if you score a critical hit.
...
When you gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focus) at the start of each of your turns during combat, you gain 4 focus instead of 3.
...
You can [fly](../Browse/Movement/Fly.md#fly). While [flying](../Browse/Movement/Fly.md#fly), your [stability](../Browse/Movement/Stability.md#stability) is reduced to 0 and can't be increased. If you can already [fly](../Browse/Movement/Fly.md#fly), you have a +2 bonus to speed while [flying](../Browse/Movement/Fly.md#fly) instead.
...
>
> **Effect:** The area is frozen in time until the start of your next turn. Each object in the area is [restrained](../Browse/Conditions/Restrained.md#restrained) and can't fall until the effect ends. Until the effect ends, creatures in the area who are reduced to 0 Stamina or would die stay alive, and objects in the area that are reduced to 0 Stamina remain undestroyed.
>
> Make a power roll that targets each enemy in the area.
>
> **Power Roll + Presence:**
>
> - **≤11:** P < WEAK, the target is [slowed](../Browse/Conditions/Slowed.md#slowed) until the effect ends
> - **12-16:** P < AVERAGE, the target's speed is 0 until the effect ends
> - **17+:** P < STRONG, the target is [restrained](../Browse/Conditions/Restrained.md#restrained) until the effect ends
>
> **Strained:** Any creature or object force moved in the area takes 2 corruption damage for each square of the area they enter. Creatures and objects [restrained](../Browse/Conditions/Restrained.md#restrained) in the area can be force moved. You are [restrained](../Browse/Conditions/Restrained.md#restrained) until the effect ends.
...
The range of your [Telepathic Speech](../Browse/Features/Talent/1st-Level Features/Telepathic Speech.md#telepathic-speech) feature increases to anywhere on the same world.
...
> - **17+:** 20 + P damage; P < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) and [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
>
...
>
> **Strained:** You and the target both permanently grow visibly younger (the equivalent of 20 [human](../Browse/Ancestries/Human.md#human) years, to the minimum of an 18-year-old). Additionally, you are [weakened](../Browse/Conditions/Weakened.md#weakened) and [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends).
...
[Vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vision) remains until you spend it.
