...
Your class provides you with many of your features, most of your abilities—your most potent combat moves and noncombat options and a Heroic Resource that fuels many of those abilities. This book presents nine [classes](../Chapters/Classes.md#cla-e) to choose from.

**[Censor](../Browse/Classes/Censor.md#cen-or):** A [censor](../Browse/Classes/Censor.md#cen-or) is a trained warrior devoted to a saint or god. They hunt down the forces of evil using melee weapons and magic granted to them by their divine patron, specializing in confronting the wicked and locking down single enemies during combat.

**[Conduit](../Browse/Classes/Conduit.md#conduit):** A [conduit](../Browse/Classes/Conduit.md#conduit) is the devoted priest of a saint or god. They wield divine magic that smites enemies with holy energy and supports their allies, and are renowned for their healing abilities.

**[Elementalist](../Browse/Classes/Elementalist.md#elementali-t):** An [elementalist](../Browse/Classes/Elementalist.md#elementali-t) studies the elemental forces of the timescape and controls earth, fire, the void, and more with magic. Many of their abilities cover wide areas of the battlefield, and they have a versatile array of tricks that allow them to both control combat and manipulate the environment around them when the fight is done.
...
**[Shadow](../Browse/Classes/Shadow.md#hadow):** Stalking from the darkness, the [shadow](../Browse/Classes/Shadow.md#hadow) is an expert assassin and thief who fights equally well in melee and at range as they get the drop on their foes. They utilize magic to help them stay mobile on the battlefield and sneak up on their prey.

**[Tactician](../Browse/Classes/Tactician.md#tactician):** A brilliant strategist and weapons master, the [tactician](../Browse/Classes/Tactician.md#tactician) excels at granting allies more movement and actions on the battlefield. They also support allies outside of combat, always inspiring their friends to greatness.
...
The name and story text for abilities sometimes refers to specific ways in which the ability plays out—particularly combat abilities whose names imply specific types of weapons or tactics. However, that narrative flavor has no effect on how an ability can be used. For example, the [fury](../Browse/Classes/Fury.md#fury)'s [Impaled](../Browse/Abilities/Fury/1st-Level Features/Impaled.md#impaled) ability allows you to [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) a target, setting up the idea of harpooning your monstrous foe with a sword to keep them close. But you can use that ability with an axe, a mace, a hammer, or any other weapon.
...
- The [censor](../Browse/Classes/Censor.md#cen-or)'s wrath
- The [conduit](../Browse/Classes/Conduit.md#conduit)'s piety
- The [elementalist](../Browse/Classes/Elementalist.md#elementali-t)'s essence
- The [fury](../Browse/Classes/Fury.md#fury)'s ferocity
- The [null](../Browse/Classes/Null.md#null)'s discipline
- The [shadow](../Browse/Classes/Shadow.md#hadow)'s insight
- The [tactician](../Browse/Classes/Tactician.md#tactician)'s focus
- The [talent](../Browse/Classes/Talent.md#talent)'s clarity
- The [troubadour](../Browse/Classes/Troubadour.md#troubadour)'s drama
...
Abilities with the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) keyword can be used with the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action instead of a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike). (The [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action is described in Main [Actions](#page-288-0) in [Chapter 10: Combat](#page-288-0).)
...
If an ability requires a triggered action or a free triggered action to use, a "Trigger" entry is part of the ability. For example, the trigger for the [tactician](../Browse/Classes/Tactician.md#tactician)'s [Parry](../Browse/Abilities/Tactician/1st-Level Features/Parry.md#parry) ability is: "A creature deals damage to the target." A [tactician](../Browse/Classes/Tactician.md#tactician) can use their [Parry](../Browse/Abilities/Tactician/1st-Level Features/Parry.md#parry) ability only when that specific triggering event occurs.
...
An ability never has both the Melee and Ranged keywords at the same time. For example, if you have the [Cloak and Dagger](../Browse/Kits/Cloak and Dagger.md#cloakanddagger) kit, which has a weapon damage bonus to melee abilities and a weapon damage bonus to ranged abilities, only one bonus at a time applies to an ability with both the Melee and Ranged keywords. (See [Chapter 6: Kits](#page-231-0).)
...
When an ability can target creatures and objects, the ability can damage objects. However, unless otherwise noted (as with the [talent](../Browse/Classes/Talent.md#talent)'s [Minor Telekinesis](../Browse/Abilities/Talent/1st-Level Features/Minor Telekinesis.md#minortelekine-i) ability) or if the Director allows it, objects are immune to an ability's other effects. If an ability forces an object to make a test, the object automatically gets a tier 1 result on the test.
...
Unlike power rolls made as tests (see Chapter 9), ability rolls always do something useful. You're rolling to determine the impact of the ability, including how much damage it deals and any other effects it imposes based on the tier outcome of the power roll. For instance, the [fury](../Browse/Classes/Fury.md#fury)'s [Brutal Slam](../Browse/Abilities/Fury/1st-Level Features/Brutal Slam.md#brutal-lam) ability is a melee strike that targets one adjacent creature (within 1 square), and which has the following effects:
...
Using the [fury](../Browse/Classes/Fury.md#fury)'s [Brutal Slam](../Browse/Abilities/Fury/1st-Level Features/Brutal Slam.md#brutal-lam) ability as an example again, that ability uses a Might power roll and features the following damage expressions in the three tier outcomes of the power roll:

- **≤11:** 3 + M damage
- **12-16:** 6 + M damage
- **17+:** 9 + M damage

For a [fury](../Browse/Classes/Fury.md#fury) with a Might of 2, the ability's damage breakdown would be:
...
Some abilities, including your [free strikes](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), allow you to pick which characteristic score you add to their damage. Such abilities use a format similar to "7 + M or A damage," indicating that you can add your Might or your Agility to determine the damage.
...
To keep things moving quickly and to make abilities easy to read during play, damage and effects are separated with a semicolon in a power roll tier entry, with effects abbreviated whenever possible. An effect determined by a power roll always applies to the target unless otherwise specified. For example, the [Brutal Slam](../Browse/Abilities/Fury/1st-Level Features/Brutal Slam.md#brutal-lam) ability mentioned above has the following power roll setup in the ability format:
...
Certain ability effects allow you to move and affect other creatures or objects during that move, such as the [shadow](../Browse/Classes/Shadow.md#hadow)'s One Hundred Throats ability. For such abilities, the move begins in the space you first leave when you start the move and ends in the last space you move into.
...
- **≤11:** 3 + I holy damage; A < WEAK, [prone](../Browse/Conditions/Prone.md#prone)
- **12-16:** 6 + I holy damage; A < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone)
- **17+:** 9 + I holy damage; A < STRONG, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)

At 1st level, a [conduit](../Browse/Classes/Conduit.md#conduit) uses their Intuition score to determine their potency values, and that score is 2. That gives the [conduit](../Browse/Classes/Conduit.md#conduit) the following potencies:
...
- **≤11:** 5 holy damage; A < 0, [prone](../Browse/Conditions/Prone.md#prone)
...
Potencies are made for quick resolution at the table, but a number of triggered actions and other abilities—for example, the [censor](../Browse/Classes/Censor.md#cen-or)'s [Judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) ability and the [null](../Browse/Classes/Null.md#null)'s Null Field ability—allow you to manipulate the value of potencies. If you build a hero who can adjust potencies, pay attention during combat! You might be able to help out a friend who needs a little boost to make their ability take full effect, or hinder an enemy about to lock down one of your allies.
...
For example, the [tactician](../Browse/Classes/Tactician.md#tactician)'s [Overwatch](../Browse/Abilities/Tactician/1st-Level Features/Overwatch.md#overwatch) ability allows the [tactician](../Browse/Classes/Tactician.md#tactician) to spend 1 focus to impose the [slowed](../Browse/Conditions/Slowed.md#lowed) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](../Browse/Classes/Tactician.md#tactician) targets a creature whose high Reason leaves them unaffected, the [tactician](../Browse/Classes/Tactician.md#tactician) doesn't waste any [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu). However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
You can't score a critical hit with an ability roll made as a maneuver or any other action type, but you can score a critical hit with a main action you use off your turn. For example, an opportunity attack made as a triggered action or a signature ability used as a free triggered action with the assistance of the [tactician](../Browse/Classes/Tactician.md#tactician)'s [Strike Now](../Browse/Abilities/Tactician/1st-Level Features/Strike Now.md#trikenow) ability can be critical hits.
...
A [troubadour](../Browse/Classes/Troubadour.md#troubadour)'s battle song, a [fury](../Browse/Classes/Fury.md#fury)'s building [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity), and a [shadow](../Browse/Classes/Shadow.md#hadow)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
If an ability's effect allows you to take a main action, a maneuver, a move action, or a triggered action, the cost of doing so is subsumed in the ability's type entry on the first line below the flavor text. You never need to spend additional time to use an ability. For example, the [shadow](../Browse/Classes/Shadow.md#hadow)'s Black Ash [Teleport](../Browse/Movement/Teleport.md#teleport) ability is a maneuver that allows you to [teleport](../Browse/Movement/Teleport.md#teleport) and then use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver as its overall effect. Using the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver is part of the maneuver to use the ability, so that you don't need to have another maneuver available to do so.
...
For example, the [null](../Browse/Classes/Null.md#null)'s Null Field ability reduces the potencies of enemies within the field by 1. If two allied [nulls](../Browse/Classes/Null.md#null) each have their Null Field ability active and an enemy cultist is targeted by both abilities, that cultist's potencies are reduced by 1, not by 2.

Different effects that impose the same condition (see [Conditions](#page-91-2) below) don't stack to impose the condition twice. For instance, if a hero is targeted by numerous creatures whose abilities cause a target to become [weakened](../Browse/Conditions/Weakened.md#weakened) (imposing a bane on the target's power rolls), the target isn't [weakened](../Browse/Conditions/Weakened.md#weakened) twice to impose a double bane on those rolls. A character who is [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by an enemy can't be [grabbed](../Browse/Conditions/Grabbed.md#grabbed) again by another enemy. The same holds true for game effects that aren't conditions. For example, if a hero is targeted by multiple abilities or effects that can halve their recovery value, the hero's recovery value is halved only once.
...
You take damage from this condition when you use a main action off your turn. For example, a signature ability used as a free triggered action with the assistance of the [tactician](../Browse/Classes/Tactician.md#tactician)'s [Strike Now](../Browse/Abilities/Tactician/1st-Level Features/Strike Now.md#trikenow) ability triggers the damage from the [bleeding](../Browse/Conditions/Bleeding.md#bleeding) condition.

##### Dazed

A creature who is [dazed](../Browse/Conditions/Dazed.md#dazed) can do only one thing on their turn: use a main action, use a maneuver, or use a move action. A [dazed](../Browse/Conditions/Dazed.md#dazed) creature also can't use triggered actions, free triggered actions, or free maneuvers.

##### Frightened

When a creature is [frightened](../Browse/Conditions/Frightened.md#frightened), any ability roll they make against the source of their fear takes a bane. If that source is a creature, their ability rolls made against the [frightened](../Browse/Conditions/Frightened.md#frightened) creature gain an edge. A [frightened](../Browse/Conditions/Frightened.md#frightened) creature can't willingly move closer to the source of their fear if they know the location of that source. If a creature gains the [frightened](../Browse/Conditions/Frightened.md#frightened) condition from one source while already [frightened](../Browse/Conditions/Frightened.md#frightened) by a different source, the new condition replaces the old one.

##### Grabbed

A creature who is [grabbed](../Browse/Conditions/Grabbed.md#grabbed) has speed 0, can't be force moved except by a creature, object, or effect that has them [grabbed](../Browse/Conditions/Grabbed.md#grabbed), can't use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)), and takes a bane on abilities that don't target the creature, object, or effect that has them [grabbed](../Browse/Conditions/Grabbed.md#grabbed). If a creature is [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by another creature and that creature moves, they bring the [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature with them. If a creature's size is equal to or less than the size of a creature they have [grabbed](../Browse/Conditions/Grabbed.md#grabbed), their speed is halved while they have that creature [grabbed](../Browse/Conditions/Grabbed.md#grabbed).

A creature who has another creature [grabbed](../Browse/Conditions/Grabbed.md#grabbed) can use a maneuver to move the [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature into an unoccupied space adjacent to them.

A creature can release a creature they have [grabbed](../Browse/Conditions/Grabbed.md#grabbed) at any time to end that condition (no action required). A [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature can attempt to escape being [grabbed](../Browse/Conditions/Grabbed.md#grabbed) using the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#e-capegrab) maneuver (see [Chapter 10: Combat](#page-288-0)). If a [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature [teleports](../Browse/Movement/Teleport.md#teleport), or if either the [grabbed](../Browse/Conditions/Grabbed.md#grabbed) creature or the creature grabbing them is force moved so that both creatures are not adjacent to each other, that creature is no longer [grabbed](../Browse/Conditions/Grabbed.md#grabbed).

A creature can [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) only creatures of their size or smaller. If a creature's Might score is 2 or higher, they can [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) any creature larger than them with a size equal to or less than their Might score.

Unless otherwise indicated, a creature can [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) only one creature at a time.

##### Prone

While a creature is [prone](../Browse/Conditions/Prone.md#prone), they are flat on the ground, any strike they make takes a bane, and melee abilities used against them gain an edge. A [prone](../Browse/Conditions/Prone.md#prone) creature must [crawl](../Browse/Movement/Crawl.md#crawl) to move along the ground, which costs 1 additional square of movement for every square crawled. A creature can't [climb](../Browse/Movement/Climb or Swim.md#climbor-wim), [jump](../Browse/Movement/Jump.md#jump), [swim](../Browse/Movement/Climb or Swim.md#climbor-wim), or [fly](../Browse/Movement/Fly.md#fly) while [prone](../Browse/Conditions/Prone.md#prone). If they are [climbing](../Browse/Movement/Climb or Swim.md#climbor-wim), [flying](../Browse/Movement/Fly.md#fly), or [jumping](../Browse/Movement/Jump.md#jump) when knocked [prone](../Browse/Conditions/Prone.md#prone), they fall.

Unless the ability or effect that imposed the [prone](../Browse/Conditions/Prone.md#prone) condition says otherwise, a [prone](../Browse/Conditions/Prone.md#prone) creature can stand up using the Stand Up maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)). A creature adjacent to a willing [prone](../Browse/Conditions/Prone.md#prone) creature can likewise use the Stand Up maneuver to make that creature stand up.

##### Restrained

A creature who is [restrained](../Browse/Conditions/Restrained.md#re-trained) has speed 0, can't use the Stand Up maneuver, and can't be force moved. A [restrained](../Browse/Conditions/Restrained.md#re-trained) creature takes a bane on ability rolls and on Might and Agility tests, and abilities used against them gain an edge.

If a creature [teleports](../Browse/Movement/Teleport.md#teleport) while [restrained](../Browse/Conditions/Restrained.md#re-trained), that condition ends.

##### Slowed

A creature who is [slowed](../Browse/Conditions/Slowed.md#lowed) has speed 2 unless their speed is already lower, and they can't shift.

##### Taunted

A creature who is [taunted](../Browse/Conditions/Taunted.md#taunted) has a double bane on ability rolls for any ability that doesn't target the creature who [taunted](../Browse/Conditions/Taunted.md#taunted) them, as long as they have line of effect to that creature. If a creature gains the [taunted](../Browse/Conditions/Taunted.md#taunted) condition from one source while already [taunted](../Browse/Conditions/Taunted.md#taunted) by a different source, the new condition replaces the old one.

##### Weakened

A creature who is [weakened](../Browse/Conditions/Weakened.md#weakened) takes a bane on power rolls.
...
For example a 6th-level [censor](../Browse/Classes/Censor.md#cen-or) has "Signature, 3, 5, 7, 9" in their Abilities column, and "5, 9" in their Order Abilities column (representing the [censor](../Browse/Classes/Censor.md#cen-or)'s subclass). This means a [censor](../Browse/Classes/Censor.md#cen-or) of that level has a signature ability and four heroic abilities costing 3, 5, 7, and 9 wrath respectively, plus an additional two subclass heroic abilities costing 5 and 9 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath).
...
Demons and deathless fear you. Criminals run from the sight of your shadow. Agents of chaos, blasphemers, and heretics tremble at the sound of your voice. You carry the power of the gods, armed with [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath) and sent out into the world first to seek, then [censor](../Browse/Classes/Censor.md#cen-or) those whose actions—or even existence—are anathema to your church.

As a [censor](../Browse/Classes/Censor.md#cen-or), you're at your best against the strongest foes. Your [judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) terrifies heretics, stops enemies in their tracks, and even hurls them across the battlefield.
...
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | -------------------- |
| 1st   | [Censor Order](../Browse/Features/Censor/1st-Level Features/Censor Order.md#cen-ororder), [Deity and Domains](../Browse/Features/Conduit/1st-Level Features/Deity and Domains.md#deityanddomain), [Wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath), [Judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment), [Kit](../Browse/Features/Censor/1st-Level Features/Kit.md#kit), [My Life for Yours](../Browse/Abilities/Censor/1st-Level Features/My Life for Yours.md#mylifeforyour), Domain Feature, Censor Abilities | Signature, 3, 5           | -                    |
| 2nd   | Perk, Order Features, Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5           | 5                    |
| 3rd   | [Look On My Work and Despair](../Browse/Features/Censor/3rd-Level Features/Look On My Work and Despair.md#lookonmyworkandde-pair), 7-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Signature, 3, 5, 7        | 5                    |
| 4th   | Characteristic Increase, Perk, Skill, [Wrath Beyond Wrath](../Browse/Features/Censor/4th-Level Features/Wrath Beyond Wrath.md#wrathbeyondwrath), Domain Feature                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Signature, 3, 5, 7        | 5                    |
| 5th   | Order Feature, 9-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | Signature, 3, 5, 7, 9     | 5                    |
| 6th   | [Implement of Wrath](../Browse/Features/Censor/6th-Level Features/Implement of Wrath.md#implementofwrath), Perk, Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7, 9     | 5, 9                 |
| 7th   | Characteristic Increase, Domain Feature, [Focused Wrath](../Browse/Features/Censor/7th-Level Features/Focused Wrath.md#focu-edwrath), Skill                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Signature, 3, 5, 7, 9     | 5, 9                 |
| 8th   | Perk, Order Feature, 11-Wrath Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Signature, 3, 5, 7, 9, 11 | 5, 9                 |
| 9th   | [Improved Implement of Wrath](../Browse/Features/Censor/9th-Level Features/Improved Implement of Wrath.md#improvedimplementofwrath), Order Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Signature, 3, 5, 7, 9, 11 | 5, 9, 11             |
| 10th  | [Characteristic Increase](../Browse/Features/Censor/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), Perk, Skill, [Templar](../Browse/Features/Censor/10th-Level Features/Templar.md#templar), [Virtue](../Browse/Features/Censor/10th-Level Features/Virtue.md#virtue), [Wrath of the Gods](../Browse/Features/Censor/10th-Level Features/Wrath of the Gods.md#wrathofthegod)                                                                                                                                                                                                        | Signature, 3, 5, 7, 9, 11 | 5, 9, 11             |
...
At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath) equal to your Victories. At the start of each of your turns during combat, you gain 2 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath).

Additionally, the first time each combat round that a creature judged by you (see [Judgment](#page-94-0) below) deals damage to you, you gain 1 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath). The first time each combat round that you deal damage to a creature judged by you, you gain 1 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath).
...
You pick out the enemies most worthy of your [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath) and place a divine judgment upon them, censoring them with the power of your god. You have the following ability.
...
You call upon a number of heroic abilities, all of them bound to your [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath).
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 + P holy damage; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 8 + P holy damage; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 11 + P holy damage; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 6 + M holy damage; [grabbed](../Browse/Conditions/Grabbed.md#grabbed)
> - **12-16:** 9 + M holy damage; [grabbed](../Browse/Conditions/Grabbed.md#grabbed)
> - **17+:** 13 + M holy damage; [grabbed](../Browse/Conditions/Grabbed.md#grabbed)
>
> **Effect:** If the target makes a strike against a creature while [grabbed](../Browse/Conditions/Grabbed.md#grabbed) this way, you can spend 3 wrath to deal holy damage to them equal to your Presence score, then change the target of the strike to another target within the strike's distance.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M holy damage; if the target has P < WEAK, each enemy within 2 squares of them is [frightened](../Browse/Conditions/Frightened.md#frightened) of you (save ends)
> - **12-16:** 5 + M holy damage; if the target has P < AVERAGE, each enemy within 2 squares of them is [frightened](../Browse/Conditions/Frightened.md#frightened) of you (save ends)
> - **17+:** 8 + M holy damage; if the target has P < STRONG, each enemy within 2 squares of them is [frightened](../Browse/Conditions/Frightened.md#frightened) of you (save ends)
>
> **Effect:** Each enemy [frightened](../Browse/Conditions/Frightened.md#frightened) this way is pushed up to 2 squares away from the target and takes psychic damage equal to your Presence score.
...
As a 2nd-level [censor](../Browse/Classes/Censor.md#cen-or), you gain the following features.
...
Your judgment has grown in divine power, instilling fear in those you condemn. Whenever you use your [Judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) ability, you can spend 1 [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath), and if the target has P < AVERAGE, they are [frightened](../Browse/Conditions/Frightened.md#frightened) of you (save ends). Additionally, whenever a creature judged by you is reduced to 0 Stamina and you use [Judgment](../Browse/Features/Censor/1st-Level Features/Judgment.md#judgment) as a free triggered action, if the new target has P < STRONG, they are [frightened](../Browse/Conditions/Frightened.md#frightened) of you (save ends). If the target is already [frightened](../Browse/Conditions/Frightened.md#frightened) of you, they instead take holy damage equal to twice your Presence score.
...
As a 4th-level [censor](../Browse/Classes/Censor.md#cen-or), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 4th-Level [Censor](../Browse/Classes/Censor.md#cen-or) Domain Features table.
...
Your divine presence causes those you deem worthy to recover quickly from a fight. Whenever an ally within distance of your [My Life for Yours](../Browse/Abilities/Censor/1st-Level Features/My Life for Yours.md#mylifeforyour) ability regains Stamina, they regain additional Stamina equal to your Presence score.
...
As a main action, you touch a living tree and make it part of a divine transportation network. You can maintain a number of trees in your network equal to your Presence score. Whenever you touch any tree in your network, you can use a main action to [teleport](../Browse/Movement/Teleport.md#teleport) yourself and any willing creatures within 10 squares of you to a tree in your network on the same world. If a tree in your network dies, it is no longer part of the network. You can remove a tree from your network no matter your distance from it, including across different worlds (no action required).

### 5th-Level Features

As a 5th-level [censor](../Browse/Classes/Censor.md#cen-or), you gain the following features.
...
> | **📏 Ranged 10** | **🎯 Self or one ally** |
>
> **Effect:** The target ends any condition or effect on them that is ended by a saving throw or that ends at the end of their turn, or a [prone](../Browse/Conditions/Prone.md#prone) target can stand up. The target then gains 2 surges, can shift up to their speed while ignoring difficult terrain, and can use a strike signature ability as a free triggered action.
...
>
> **Effect:** A target can end one effect on them that is ended by a saving throw or that ends at the end of their turn, or a [prone](../Browse/Conditions/Prone.md#prone) target can stand up.
...
- Any creature struck by the weapon who has holy weakness and has P < STRONG is [frightened](../Browse/Conditions/Frightened.md#frightened) and [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends).
...
- The weapon's wielder can't be made [frightened](../Browse/Conditions/Frightened.md#frightened).
...
> **Power Roll + Presence:**
>
> - **≤11:** Slide 3; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** Slide 5; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** Slide 7; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
As a 7th-level [censor](../Browse/Classes/Censor.md#cen-or), you gain the following features.
...
You gain a domain feature from your domain, as shown on the 7th-Level [Censor](../Browse/Classes/Censor.md#cen-or) Domain Features table.
...
| Storm      | [Ride the Lightning](../Browse/Features/Censor/7th-Level Features/7th-Level Domain Feature/Ride the Lightning.md#ridethelightning)                       |
...
>
> **Effect:** Each target is [teleported](../Browse/Movement/Teleport.md#teleport) to unoccupied spaces within 5 squares of a willing creature who you are bonded to with your Invocation of the Heart feature. You don't need line of effect to the bonded creature but you must be on the same world.
...
Each time you use your [My Life for Yours](../Browse/Abilities/Censor/1st-Level Features/My Life for Yours.md#mylifeforyour) ability, you gain 1 wrath that can be spent only on that ability during the same turn. If you don't use this [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath), it is lost. Additionally, the target of [My Life for Yours](../Browse/Abilities/Censor/1st-Level Features/My Life for Yours.md#mylifeforyour) gains 10 temporary Stamina.
...
Lightning and thunder infuse your body. Whenever you use an ability to deal rolled damage to another creature, the ability deals extra lightning damage equal to your Presence score. Additionally, if you use an ability that force moves a creature, the forced movement distance gains a bonus equal to your Presence score. While you are under the effect of your [Windwalk](../Browse/Features/Censor/4th-Level Features/4th-Level Domain Feature/Windwalk.md#windwalk) feature, lightning enhances your locomotion to grant you a bonus to speed equal to your Might score. If [Windwalk](../Browse/Features/Censor/4th-Level Features/4th-Level Domain Feature/Windwalk.md#windwalk) already grants you a bonus to speed, this bonus adds to that.
...
When you gain [wrath](../Browse/Features/Censor/1st-Level Features/Wrath.md#wrath) at the start of each of your turns during combat, you gain 3 wrath instead of 2.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; I < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 13 + M damage; I < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 18 + M damage; I < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
> **Effect:** At the end of each of your turns, a target [weakened](../Browse/Conditions/Weakened.md#weakened) this way deals holy damage equal to twice your Presence score to each enemy within 2 squares of them. Additionally, a target [weakened](../Browse/Conditions/Weakened.md#weakened) this way can't be targeted by their allies' abilities.
...
> **Power Roll + Might:**
>
> - **≤11:** 9 + M damage; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 13 + M damage; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 18 + M damage; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
>
> **Effect:** At the end of each of your turns, a target [dazed](../Browse/Conditions/Dazed.md#dazed) this way deals holy damage equal to twice your Presence score to each enemy within 2 squares of them.
...
>
> **Effect:** This ability gains an edge against demons, [devils](../Browse/Ancestries/Devil.md#devil), undead, and creatures not native to your current world. If you know the target's true name, this ability has a double edge. While banished, the target is sent to another manifold in the timescape and removed from the encounter map. A banished target can do nothing but make saving throws, and takes 10 holy damage each time they do so. If the target is reduced to 0 Stamina while banished, they are lost to the timescape.
...
> **Power Roll + Presence:**
>
> - **≤11:** 7 + P psychic damage; P < WEAK, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 10 + P psychic damage; P < AVERAGE, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 13 + P psychic damage; P < STRONG, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
>
> **Effect:** While [frightened](../Browse/Conditions/Frightened.md#frightened) this way, if a target who is a leader or solo creature is winded, they take an extra 25 psychic damage. If a target [frightened](../Browse/Conditions/Frightened.md#frightened) this way is not a leader or solo creature and is winded, they are reduced to 0 Stamina.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ---------------- |
| 1st   | [Deity and Domains](../Browse/Features/Conduit/1st-Level Features/Deity and Domains.md#deityanddomain), [Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety), Domain Feature, [Healing Grace](../Browse/Abilities/Conduit/1st-Level Features/Healing Grace.md#healinggrace), [Ray of Wrath](../Browse/Abilities/Conduit/1st-Level Features/Ray of Wrath.md#rayofwrath), Triggered Action, [Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer), Conduit Ward, Conduit Abilities | Two signature, 3, 5           | -                |
| 2nd   | [The Lists of Heaven](../Browse/Features/Conduit/2nd-Level Features/The Lists of Heaven.md#theli-t-ofheaven), Perk, Domain Feature, Domain Ability                                                                                                                                                                                                                                                                                                                                                                                                                                        | Two signature, 3, 5           | 5                |
| 3rd   | [Minor Miracle](../Browse/Features/Conduit/3rd-Level Features/Minor Miracle.md#minormiracle), 7-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Two signature, 3, 5, 7        | 5                |
| 4th   | [Blessed Domains](../Browse/Features/Conduit/4th-Level Features/Blessed Domain.md#ble-eddomain), [Characteristic Increase](../Browse/Features/Conduit/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), Domain Feature, Perk, Skill Increase                                                                                                                                                                                                                                                                                                                     | Two signature, 3, 5, 7        | 5                |
| 5th   | Domain Feature, 9-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Two signature, 3, 5, 7, 9     | 5                |
| 6th   | [Burgeoning Saint](../Browse/Features/Conduit/6th-Level Features/Burgeoning Saint.md#burgeoning-aint), Perk, Domain Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Two signature, 3, 5, 7, 9     | 5, 9             |
| 7th   | [Characteristic Increase](../Browse/Features/Conduit/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), Domain Feature, [Faithful's Reward](../Browse/Features/Conduit/7th-Level Features/Faithfuls Reward.md#faithful-reward), Skill Increase                                                                                                                                                                                                                                                                                                                       | Two signature, 3, 5, 7, 9     | 5, 9             |
| 8th   | Domain Feature, Perk, 11-Piety Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Two signature, 3, 5, 7, 9, 11 | 5, 9             |
| 9th   | Domain Ability, [Faith's Sword](../Browse/Features/Conduit/9th-Level Features/Faiths Sword.md#faith-word), [Ordained](../Browse/Features/Conduit/9th-Level Features/Ordained.md#ordained)                                                                                                                                                                                                                                                                                                                                                                               | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
| 10th  | [Avatar](../Browse/Features/Conduit/10th-Level Features/Avatar.md#avatar), [Characteristic Increase](../Browse/Features/Conduit/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Divine Power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower), [Most Pious](../Browse/Features/Conduit/10th-Level Features/Most Pious.md#mo-tpiou), Perk, Skill Increase                                                                                                                                    | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11         |

### 1st-Level Features

As a [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
Your deity grants you a Heroic Resource called [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety), letting you heal and empower your allies, and unleash holy power upon your foes.

##### Piety in Combat

At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) equal to your Victories. At the start of each of your turns during combat, you gain 1d3 [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).

Additionally, you can gain more piety by praying to the gods—but beware! Doing so can easily draw their ire, as the gods hate to be annoyed. Before you roll to gain [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) at the start of your turn, you can pray (no action required). If you do, your roll gains the following additional effects:
...
- If the roll is a 2, you gain 1 additional [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).
...
Your choice of domains provides you with two additional ways to earn [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) during combat, as triggered by specific events. You might even have a single event trigger both your [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) effects. For example, the Sun domain grants piety when a nearby creature takes fire or holy damage, while the War domain grants piety when a nearby creature takes damage of 10 + your level or higher. If you have both those domains and a nearby creature takes an appropriate amount of fire damage, you gain [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) from both your domains.

Additionally, whenever you activate a domain effect by praying for [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety), you can choose one of your domains and have that domain's prayer effect take effect immediately.

###### Creation Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that a creature within 10 squares uses an area ability.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** You summon the forces of creation and create a wall of stone within 10 squares whose size is 5 + your Intuition score. The wall lasts until the end of the encounter.

###### Death Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that a creature within 10 squares who isn't a minion is reduced to 0 Stamina, or the first time in an encounter that a solo creature within 10 squares becomes winded.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** You inflict a deadly curse on up to two enemies within 10 squares of you. Each target takes corruption damage equal to twice your Intuition score.
...
- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that the Director spends Malice (see *[Draw Steel: Monsters](https://mcdm.gg/DS-Monsters)*).
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** Choose up to five allies within 10 squares of you, or choose yourself instead of one ally. Each target gains 1 surge.

###### Life Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that a creature within 10 squares regains Stamina.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** Choose yourself or one ally within 10 squares. That character can spend a Recovery, can end one effect on them that is ended by a saving throw or that ends at the end of their turn, or can stand up if they are [prone](../Browse/Conditions/Prone.md#prone). Alternatively, you or one ally within 10 squares gains temporary Stamina equal to two times your Intuition score.
...
- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that you or a creature within 10 squares takes acid, cold, fire, lightning, poison, or sonic damage.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** Vines whip up from the floor or ground within 10 squares, wrapping around a number of creatures equal to your Intuition score. You can slide each creature up to a number of squares equal to your Intuition score. The vines then fade away.

###### Protection Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that you or any ally within 10 squares gains temporary Stamina, or uses a triggered action to reduce incoming damage or to impose a bane or double bane on an enemy's power roll.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** One ally within 10 squares gains temporary Stamina equal to four times your Intuition score.

###### Storm Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that an enemy within 10 squares is force moved.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** Each enemy in a 3 cube within 10 squares takes lightning damage equal to twice your Intuition score.

###### Sun Domain Piety and Effect

- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that an enemy within 10 squares takes fire or holy damage.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** One enemy within 10 squares takes fire damage equal to three times your Intuition score.
...
- **[Piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety):** You gain 2 piety the first time in an encounter that you or a creature within 10 squares takes damage greater than 10 + your level in a single turn.
- **[Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) Effect:** Choose up to three allies within 10 squares of you, or choose yourself instead of one ally. Each target gains 2 surges.
...
> - A [prone](../Browse/Conditions/Prone.md#prone) target can stand up.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 3 + I holy damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 2
> - **12-16:** 5 + I holy damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 3
> - **17+:** 8 + I holy damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 4
...
> - **17+:** 5 holy damage
>
> **Effect:** You can [teleport](../Browse/Movement/Teleport.md#teleport) yourself and each ally in the area to unoccupied spaces in the area.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 6 + I holy damage; I < WEAK, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 9 + I holy damage; I < AVERAGE, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 13 + I holy damage; I < STRONG, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
...
>
> **Effect:** Each target can spend a Recovery. Additionally, each target can use a free triggered action to end one effect on them that is ended by a saving throw or that ends at the end of their turn, or to stand up if [prone](../Browse/Conditions/Prone.md#prone).

### 2nd-Level Features

As a 2nd-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
Choose one of your domains. You gain a heroic ability from that domain, as shown on the 2nd-Level [Conduit](../Browse/Classes/Conduit.md#conduit) Domain Abilities table.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 4 + I holy damage; P < WEAK, before taking damage, the target makes a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against a target you choose
...
> **Power Roll + Intuition:**
>
> - **≤11:** 2 damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **12-16:** 3 damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **17+:** 7 damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
...
> **Power Roll + Intuition:**
>
> - **≤11:** 2 lightning damage; [vertical](../Browse/Movement/Vertical.md#vertical) slide 1
> - **12-16:** 5 lightning damage; [vertical](../Browse/Movement/Vertical.md#vertical) slide 2
> - **17+:** 7 lightning damage; [vertical](../Browse/Movement/Vertical.md#vertical) slide 3
...
As a 3rd-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 6 psychic damage; I < WEAK, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 9 psychic damage; I < AVERAGE, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 13 psychic damage; I < STRONG, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
>
> **Effect:** Each target is [frightened](../Browse/Conditions/Frightened.md#frightened) of you or a creature you choose within distance.
...
As a 4th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.

#### Blessed Domain

Whenever you gain [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) from a domain effect, you gain 1 additional [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 4th-Level [Conduit](../Browse/Classes/Conduit.md#conduit) Domain Features table.
...
As a main action, you touch a living tree and make it part of a divine transportation network. You can maintain a number of trees in your network equal to your Intuition score. Whenever you touch any tree in your network, you can use a main action to [teleport](../Browse/Movement/Teleport.md#teleport) yourself and any willing creatures within 10 squares of you to a tree in your network on the same world. If a tree in your network dies, it is no longer part of the network. You can remove a tree from your network no matter your distance from it, including across different worlds (no action required).

### 5th-Level Features

As a 5th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
> **Power Roll + Intuition:**
>
> - **≤11:** 4 corruption damage; I < WEAK, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)
> - **12-16:** 7 corruption damage; I < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)
> - **17+:** 11 corruption damage; I < STRONG, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)
...
As a 7th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
When you roll for piety at the start of your turn in combat, you gain 1d3 + 1 [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).
...
Choose one of your domains. You gain a domain feature for that domain, as shown on the 7th-Level [Conduit](../Browse/Classes/Conduit.md#conduit) Domain Features table.
...
As an 8th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.
...
> | **📏 Ranged 10**  | **🎯 Self or one ally** |
>
> **Effect:** The target can spend any number of Recoveries, can end any effects on them that are ended by a saving throw or that end at the end of their turn, and can stand up if they are [prone](../Browse/Conditions/Prone.md#prone). Additionally, at the start of each of their turns until the end of the encounter or until they are dying, the target gains 3 surges.
...
As a 9th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.

#### Faith's Sword

Each time you finish a respite, you can choose a willing hero ally who finished the respite with you. That ally gains the benefits of your [Burgeoning Saint](../Browse/Features/Conduit/6th-Level Features/Burgeoning Saint.md#burgeoning-aint) feature until you finish another respite. Additionally, you can spend [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety) as a free maneuver to give the hero 1 of their Heroic Resource for every 2 piety spent.
...
Choose one of your domains. You gain a heroic ability from that domain, as shown on the 9th-Level [Conduit](../Browse/Classes/Conduit.md#conduit) Domain Abilities table.
...
> | **📏 Ranged 10**  | **🎯 Four allies** |
>
> **Effect:** You can target yourself instead of one ally with this ability. Each target can spend any number of Recoveries, can end any effects on them that are ended by a saving throw or that end at the end of their turn, and can stand up if they are [prone](../Browse/Conditions/Prone.md#prone).
...
> **Power Roll + Intuition:**
>
> - **≤11:** 10 + I corruption damage; A < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 15 + I corruption damage; A < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 21 + I corruption damage; A < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
> **Effect:** While [weakened](../Browse/Conditions/Weakened.md#weakened) this way, the target has damage weakness 10.

### 10th-Level Features

As a 10th-level [conduit](../Browse/Classes/Conduit.md#conduit), you gain the following features.

#### Avatar

You are now an avatar of your god! When you use your [Prayer](../Browse/Features/Conduit/1st-Level Features/Prayer.md#prayer) feature, you can be affected by up to three prayers at once, and you can change all those prayers and your ward as a respite activity. You can also use a maneuver to activate one of your domain effects (see [Domain Piety and Effects](../Browse/Features/Conduit/1st-Level Features/Piety/Domain Piety and Effects.md#domainpietyandeffect)) without needing to pray.
...
You have an epic resource called [divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower). Each time you finish a respite, you gain [divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower) equal to the XP you gain. You can spend [divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower) on your abilities as if it were [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).

Additionally, you can spend [divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower) as if it were piety to use any [conduit](../Browse/Classes/Conduit.md#conduit) abilities you don't have, as the gods answer your prayers with temporary and unique gifts. If you use a [conduit](../Browse/Classes/Conduit.md#conduit) ability you don't have that usually costs no [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety), you must spend 1 [divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower) to use it.

[Divine power](../Browse/Features/Conduit/10th-Level Features/Divine Power.md#divinepower) remains until you spend it.

#### Most Pious

When you roll for piety at the start of your turn in combat and you pray, you gain 1 additional [piety](../Browse/Features/Conduit/1st-Level Features/Piety.md#piety).
...
As a 1st-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
You channel the substance of creation in the form of a Heroic Resource called [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence), gathering and burning it to cast and maintain spells.
...
>
> - You use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver (see Chapter 10: Combat), but its distance becomes the range of your [Hurl Element](../Browse/Abilities/Elementalist/1st-Level Features/Hurl Element.md#hurlelement) ability, and you use Reason instead of Might for the power roll.
> - You choose a creature within the distance of your [Hurl Element](../Browse/Abilities/Elementalist/1st-Level Features/Hurl Element.md#hurlelement) ability and one of the following damage types: acid, cold, corruption, fire, lightning, poison, or sonic. That creature takes damage of the chosen type equal to your Reason score.
> - You [teleport](../Browse/Movement/Teleport.md#teleport) up to a number of squares equal to your Reason score. If you choose this option, you can spend [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence) to [teleport](../Browse/Movement/Teleport.md#teleport) 1 additional square for each essence spent.

#### 1st-Level Specialization Feature

Your [elemental specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-pecialization) grants you a feature, as shown on the 1st-Level [Elemental Specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-pecialization) Features table.

###### 1st-Level Elemental Specialization Features Table

| Specialization | Feature                                                                                                                                                                                |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Motivate Earth](../Browse/Abilities/Elementalist/1st-Level Features/Motivate Earth.md#motivateearth)                                                                     |
| Fire           | [Return to Formlessness](../Browse/Abilities/Elementalist/1st-Level Features/Return to Formlessness.md#returntoformle-ne)                                                   |
| Green          | [It Is the Soul Which Hears](../Browse/Features/Elementalist/1st-Level Features/1st-Level Specialization Feature/It Is the Soul Which Hears.md#iti-the-oulwhichhear) |
| Void           | [A Beyonding of Vision](../Browse/Features/Elementalist/1st-Level Features/1st-Level Specialization Feature/A Beyonding of Vision.md#abeyondingofvi-ion)               |
...
>
> **Effect:** You [teleport](../Browse/Movement/Teleport.md#teleport) the target up to a number of squares equal to your Reason score. If the target moves to trigger this ability, you can [teleport](../Browse/Movement/Teleport.md#teleport) them at any point during the move.
>
> **Spend 1 Essence:** You [teleport](../Browse/Movement/Teleport.md#teleport) the target up to a number of squares equal to twice your Reason score instead.

#### Enchantment

You weave an elemental enchantment into your body that enhances your statistics. Choose one of the following enchantments. You can change your enchantment and ward (see Elementalist Ward below) by performing a complex ritual as a respite activity. (*Quick Build:* [Enchantment of Destruction](../Browse/Features/Elementalist/1st-Level Features/Enchantment/Enchantment of Destruction.md#enchantmentofde-truction).)
...
As a 2nd-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
Your [elemental specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-pecialization) grants you a feature, as shown on the 2nd-Level [Elemental Specialization](../Browse/Features/Elementalist/1st-Level Features/Elemental Specialization.md#elemental-pecialization) Features table.

###### 2nd-Level Elemental Specialization Features Table

| Specialization | Feature                                                                                                                                                                  |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Earth          | [Disciple of Earth](../Browse/Features/Elementalist/2nd-Level Features/2nd-Level Specialization Feature/Disciple of Earth.md#di-cipleofearth)           |
| Fire           | [Disciple of Fire](../Browse/Features/Elementalist/2nd-Level Features/2nd-Level Specialization Feature/Disciple of Fire.md#di-cipleoffire)             |
| Green          | [Disciple of the Green](../Browse/Features/Elementalist/2nd-Level Features/2nd-Level Specialization Feature/Disciple of the Green.md#di-cipleofthegreen) |
| Void           | [There Is No Space Between](../Browse/Abilities/Elementalist/2nd-Level Features/There Is No Space Between.md#therei-no-pacebetween)                           |
...
| Animal Type           | Level | Temporary Stamina | Speed                                                                           | Size | [Stability](../Browse/Movement/Stability.md#tability) Bonus | Melee Damage Bonus | Special                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| --------------------- | ----- | ----------------- | ------------------------------------------------------------------------------- | ---- | ------------------------------------------------------------------------- | ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Canine                | 2nd   | 5                 | 7                                                                               | 1M   | +0                                                                        | +1/+1/+1           | You gain an edge on tests that involve smell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Fish                  | 2nd   | 0                 | 5 ([swim](../Browse/Movement/Climb or Swim.md#climbor-wim) only) | 1T   | +0                                                                        | +0/+0/+0           | You can breathe in water but can't breathe outside of it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Rodent                | 2nd   | 0                 | 5 ([climb](../Browse/Movement/Climb or Swim.md#climbor-wim))     | 1T   | +0                                                                        | +0/+0/+0           | You gain an edge on tests that involve smell.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Bird                  | 3rd   | 0                 | 5 ([fly](../Browse/Movement/Fly.md#fly))                     | 1T   | +0                                                                        | +0/+0/+0           | -                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| Great cat             | 3rd   | 5                 | 6 ([climb](../Browse/Movement/Climb or Swim.md#climbor-wim))     | 2    | +0                                                                        | +1/+1/+1           | As a maneuver, you can [jump](../Browse/Movement/Jump.md#jump) up to 3 squares in any direction. If you land on<br/> an enemy of your size or smaller, that enemy is knocked [prone](../Browse/Conditions/Prone.md#prone), and you can<br/> make a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against them (no action required).                                                                                                                                                                                                                               |
| Giant frog            | 4th   | 5                 | 5 ([swim](../Browse/Movement/Climb or Swim.md#climbor-wim))      | 2    | +0                                                                        | +0/+0/+0           | Your melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) has a distance of melee 3. When you take the [Advance](../Browse/Abilities/Common/Move Actions/Advance.md#advance)<br/> move action, you can high [jump](../Browse/Movement/Jump.md#jump) or long [jump](../Browse/Movement/Jump.md#jump) up to half your speed. This<br/> [jump](../Browse/Movement/Jump.md#jump) can allow you to move more squares than your speed.                                                                                                     |
...
| Bear                  | 5th   | 10                | 5 ([climb](../Browse/Movement/Climb or Swim.md#climbor-wim))     | 2    | +1                                                                        | +2/+2/+2           | Your melee distance gains a +1 bonus.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Giant bird            | 5th   | 0                 | 7 ([fly](../Browse/Movement/Fly.md#fly))                     | 2    | +0                                                                        | +1/+1/+1           | After making a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), you can shift up to 3 squares as a free<br/> triggered action.                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Giant<br/> salamander | 6th   | 5                 | 5                                                                               | 1L   | +3                                                                        | +2/+2/+2           | Your melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) deals fire damage. Additionally, you have fire immunity<br/> 3.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| Giant spider          | 6th   | 0                 | 5 ([climb](../Browse/Movement/Climb or Swim.md#climbor-wim))     | 2    | +0                                                                        | +0/+1/+2           | You have a double edge on melee [free strikes](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against creatures you are hidden<br/> from.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| Giant snake           | 7th   | 5                 | 5                                                                               | 3    | +0                                                                        | +0/+1/+2           | Whenever you obtain a tier 2 or tier 3 outcome on a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), you<br/> can automatically [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) the target. While [grabbed](../Browse/Conditions/Grabbed.md#grabbed) this way, the target takes 2<br/> damage at the start of each of their turns.                                                                                                                                                                                                                          |
| Kangaroo              | 7th   | 0                 | 7                                                                               | 1L   | +1                                                                        | +0/+0/+4           | When you score a critical hit with a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), the target is [dazed](../Browse/Conditions/Dazed.md#dazed) (save<br/> ends). When you take the [Advance](../Browse/Abilities/Common/Move Actions/Advance.md#advance) move action, you can high [jump](../Browse/Movement/Jump.md#jump) or long<br/> [jump](../Browse/Movement/Jump.md#jump) up to half your speed. This [jump](../Browse/Movement/Jump.md#jump) can allow you to move more squares<br/> than your speed. |
...
| Shark                 | 8th   | 0                 | 8 ([swim](../Browse/Movement/Climb or Swim.md#climbor-wim) only) | 2    | +0                                                                        | +2/+2/+2           | You can breathe in water but can't breathe outside of it. Additionally, you gain<br/> an edge on strikes against targets who are [bleeding](../Browse/Conditions/Bleeding.md#bleeding) or winded.                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| Giant octopus         | 9th   | 5                 | 5 ([swim](../Browse/Movement/Climb or Swim.md#climbor-wim))      | 3    | +2                                                                        | +0/+0/+0           | You can breathe in water. Additionally, you can target two creatures or objects<br/> with your melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike). Whenever you obtain a tier 2 or tier 3 outcome on<br/> a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), you can automatically [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) the target. You can have up to<br/> eight creatures [grabbed](../Browse/Conditions/Grabbed.md#grabbed).                                                              |
| Rhinoceros            | 9th   | 10                | 8                                                                               | 2    | +5                                                                        | +2/+2/+2           | Whenever you make a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) as part of the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) action, that<br/> strike gains an edge.                                                                                                                                                                                                                                                                                                                                                                                        |
| King terror lizard    | 10th  | 20                | 5                                                                               | 4    | +3                                                                        | +2/+2/+2           | Your melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) is a 1 burst with the Area and Strike keywords.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
> | **📏 Ranged 10**        | **🎯 Special** |
>
> **Effect:** You open two size 1 portals in unoccupied spaces within distance, which last until you move beyond distance from any portal, end the effect as a maneuver, or are dying. Each portal must be placed at a height of no more than 1 square above the ground. When you or any ally touch a portal, that creature can choose to be instantly [teleported](../Browse/Movement/Teleport.md#teleport) to an unoccupied space of their choice adjacent to the other portal. If an enemy is force moved into a portal, their forced movement ends and they emerge from the other portal in an unoccupied space chosen by the creature who force moved them.
>
...
> | **📏 Ranged 10**              | **🎯 Self or one ally** |
>
> **Effect:** The target is [teleported](../Browse/Movement/Teleport.md#teleport) to another space within distance. Make a power roll that affects each enemy adjacent to the target's new space.
>
> **Power Roll + Reason:**
>
> - **≤11:** 3 fire damage
...
As a 3rd-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
As a 4th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
While you have 3 or more essence and are not dying, you exude an aura of magic whose distance is equal to your Reason score. The effects within the area of the aura are based on your specialization, as shown on the [Mantle of Essence](../Browse/Features/Elementalist/4th-Level Features/Mantle of Essence.md#mantleofe-ence) Specialization Effects table. You can activate and deactivate the aura at will (no action required).

###### Mantle of Essence Specialization Effects Table

| Specialization | Feature                                                                                                                                   |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Quaking Earth](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Quaking Earth.md#quakingearth)     |
| Fire           | [Burning Grounds](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Burning Grounds.md#burningground) |
| Green          | [Flowering Bed](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Flowering Bed.md#floweringbed)     |
| Void           | [Veiling Bed](../Browse/Features/Elementalist/4th-Level Features/Mantle Of Essence/Veiling Bed.md#veilingbed)         |
...
As a 5th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 corruption damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **12-16:** 3 corruption damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **17+:** 5 corruption damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
>
> **Effect:** The area is difficult terrain until the start of your next turn. Each enemy who ends their turn in the area is [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends).
>
> **Persistent 1:** The area remains until the start of your next turn.

### 6th-Level Features

As a 6th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
> | **📏 Ranged 10**                     | **🎯 Self or one ally** |
>
> **Effect:** The target has a +3 bonus to speed, they can [fly](../Browse/Movement/Fly.md#fly), and their abilities ignore concealment. Additionally, whenever the target gains their Heroic Resource, they gain 1 additional Heroic Resource. This effect lasts until the start of your next turn.
>
> **Persistent 1:** The effect lasts until the start of your next turn.
...
>
> - Their size and [stability](../Browse/Movement/Stability.md#tability) increase by 2, with any size 1 target becoming size 3. Each creature who is within the target's new space slides to the nearest unoccupied space, ignoring [stability](../Browse/Movement/Stability.md#tability). If the target doesn't have space to grow, they grow as much as they can and become [restrained](../Browse/Conditions/Restrained.md#re-trained) until the effect ends.
...
> **Power Roll + Reason:**
>
> - **≤11:** You [teleport](../Browse/Movement/Teleport.md#teleport) the target up to 4 squares.
> - **12-16:** You [teleport](../Browse/Movement/Teleport.md#teleport) the target up to 6 squares.
> - **17+:** You [teleport](../Browse/Movement/Teleport.md#teleport) the target up to 8 squares.
>
> **Effect:** If the target is [teleported](../Browse/Movement/Teleport.md#teleport) to a space where they would fall, they immediately do so, treating the fall as if their Agility score were 0. The target takes fire damage from the fall, and each enemy within 3 squares of where they land takes the same amount of fire damage. The ground within 3 squares of where the target lands is difficult terrain.
...
As a 7th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
Your [Mantle of Essence](../Browse/Features/Elementalist/4th-Level Features/Mantle of Essence.md#mantleofe-ence) feature no longer requires [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence).

Additionally, your [Mantle of Essence](../Browse/Features/Elementalist/4th-Level Features/Mantle of Essence.md#mantleofe-ence) now radiates magic that creates a calming air. Creatures in the area of the mantle's aura have their starting patience increased by 1 (to a maximum of 5) during any negotiation. While in the area, you and any ally gain an edge on tests that use the Handle Animals skill. If you have 5 or more Victories, the bonus to patience increases to 2 and tests that use the Handle Animals skill have a double edge.

#### Surging Essence

When you gain [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence) at the start of each of your turns during combat, you gain 3 essence instead of 2.
...
As an 8th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.
...
| Specialization | Feature                                                                                                                                                                |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Summon Source of Earth](../Browse/Abilities/Elementalist/8th-Level Features/Summon Source of Earth.md#ummon-ourceofearth)                                 |
| Fire           | [The Flame Primordial](../Browse/Features/Elementalist/8th-Level Features/8th-Level Specialization Feature/The Flame Primordial.md#theflameprimordial)   |
| Green          | [Chimeric Manifestation](../Browse/Features/Elementalist/8th-Level Features/8th-Level Specialization Feature/Chimeric Manifestation.md#chimericmanife-tation) |
| Void           | [Black Hole Star](../Browse/Features/Elementalist/8th-Level Features/8th-Level Specialization Feature/Black Hole Star.md#blackhole-tar)             |

##### Black Hole Star

You warp gravity around your heavenly body and can pull even the sturdiest titans toward your core. At the end of each of your turns, you target one creature or object within distance of your [Hurl Element](../Browse/Abilities/Elementalist/1st-Level Features/Hurl Element.md#hurlelement) ability and [vertical](../Browse/Movement/Vertical.md#vertical) pull that target up to 5 squares. If their [stability](../Browse/Movement/Stability.md#tability) reduces this forced movement, they are pulled a minimum of 2 squares. This forced movement ignores [stability](../Browse/Movement/Stability.md#tability) for your allies.

Additionally, your [Mantle of Essence](../Browse/Features/Elementalist/4th-Level Features/Mantle of Essence.md#mantleofe-ence) improves. While in the area of the aura, enemies and objects have their [stability](../Browse/Movement/Stability.md#tability) reduced by an amount equal to your level.

##### Chimeric Manifestation

Nature isn't static and unchanging, and neither are you. You can enter or exit your animal form as a free maneuver the first time you use your [Disciple of the Green](../Browse/Features/Elementalist/2nd-Level Features/2nd-Level Specialization Feature/Disciple of the Green.md#di-cipleofthegreen) feature on your turn.

Additionally, whenever you use your [Disciple of the Green](../Browse/Features/Elementalist/2nd-Level Features/2nd-Level Specialization Feature/Disciple of the Green.md#di-cipleofthegreen) feature, you can select an additional animal form and gain the positive benefits from both forms. You can choose the size of either animal, and if both animal forms grant you the same benefit, you can choose whichever you prefer. You gain the highest speed between the two animal forms and have all types of movement from both forms.
...
> | **📏 Ranged 10**         |  **🎯 Special** |
>
> **Effect:** A size 5 tree appears in an unoccupied space within distance. The tree has 100 Stamina and can't be force moved. You and any ally can touch the tree to use the [Catch Breath](../Browse/Abilities/Common/Maneuvers/Catch Breath.md#catchbreath) maneuver as a free maneuver. Additionally, when you start your turn with line of effect to the tree, you can end one effect on yourself that is ended by a saving throw or that ends at the end of your turn, or you can stand up if you are [prone](../Browse/Conditions/Prone.md#prone). Each ally within distance also gains this benefit.
>
> Each enemy who ends their turn within 3 squares of the tree is [restrained](../Browse/Conditions/Restrained.md#re-trained) until the end of their next turn. A creature [restrained](../Browse/Conditions/Restrained.md#re-trained) this way can use a main action to end the effect early.
...
> | **📏 Ranged 10**              |  **🎯 Special** |
>
> **Effect:** You create a size 1L vortex that lasts until the end of the encounter. At the start of each combat round while the vortex is unoccupied, the vortex vertical pulls 3 each enemy within 5 squares of it. Each enemy who enters the vortex or starts their turn there is knocked [prone](../Browse/Conditions/Prone.md#prone). At the end of the round, if a winded enemy who is not a leader or solo creature is in the vortex, they are instantly destroyed.
...
> **Power Roll + Reason:**
>
> - **≤11:** M < WEAK, [prone](../Browse/Conditions/Prone.md#prone)
> - **12-16:** M < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone)
> - **17+:** M < STRONG, [prone](../Browse/Conditions/Prone.md#prone)
>
> **Effect:** You create a fissure in the ground adjacent to you that is a 10 x 2 line and 6 squares deep. Each creature in the area who is [prone](../Browse/Conditions/Prone.md#prone) and size 2 or smaller falls in. Other creatures can enter the fissure or can shift to the nearest unoccupied space of their choice outside it.
...
You have mastered the magic of shaping a wyrd, and can use your [Wyrding](../Browse/Features/Elementalist/6th-Level Features/Wyrding.md#wyrding) feature as a main action.
...
> **Power Roll + Reason:**
>
> - **≤11:** 13 + R fire damage; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 18 + R fire damage; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 25 + R fire damage; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
>
> **Effect:** This damage ignores immunity.

### 10th-Level Features

As a 10th-level [elementalist](../Browse/Classes/Elementalist.md#elementali-t), you gain the following features.

#### Breath

You have an epic resource called breath. Each time you finish a respite, you gain breath equal to the XP you gain. You can spend any number of breath to gain [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence) (no action required). When you do, 1 breath becomes 3 [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence).

[Breath](../Browse/Features/Elementalist/10th-Level Features/Breath.md#breath) remains until you convert it to [essence](../Browse/Features/Elementalist/1st-Level Features/Essence.md#e-ence).
...
| Specialization | Feature                                                                                                                    |
| -------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Earth          | [Master of Earth](../Browse/Features/Elementalist/10th-Level Features/One/Master of Earth.md#ma-terofearth) |
| Fire           | [Master of Fire](../Browse/Features/Elementalist/10th-Level Features/One/Master of Fire.md#ma-teroffire)   |
| Green          | [Master of Green](../Browse/Features/Elementalist/10th-Level Features/One/Master of Green.md#ma-terofgreen) |
| Void           | [Master of Void](../Browse/Features/Elementalist/10th-Level Features/One/Master of Void.md#ma-terofvoid)   |
...
Additionally, your [Return to Formlessness](../Browse/Abilities/Elementalist/1st-Level Features/Return to Formlessness.md#returntoformle-ne) ability can be used on supernatural objects (but not on artifacts). When you melt a treasure (see Chapter 13: Rewards), you gain breath equal to its echelon.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------- | ---------------- |
| 1st   | [Primordial Aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordiala-pect), [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity), [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity), Aspect Features, [Aspect Triggered Action](../Browse/Features/Fury/1st-Level Features/Aspect Triggered Action.md#a-pecttriggeredaction), [Mighty Leaps](../Browse/Features/Fury/1st-Level Features/Mighty Leaps.md#mightyleap), [Fury](../Browse/Classes/Fury.md#fury) Abilities | Signature, 3, 5           | -                |
| 2nd   | Perk, Aspect Feature, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Signature, 3, 5           | 5                |
| 3rd   | Aspect Feature, 7-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7        | 5                |
| 4th   | [Characteristic Increase](../Browse/Features/Fury/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Damaging Ferocity](../Browse/Features/Fury/4th-Level Features/Damaging Ferocity.md#damagingferocity), [Growing Ferocity Improvement](../Browse/Features/Fury/7th-Level Features/Growing Ferocity Improvement.md#growingferocityimprovement), Perk, [Primordial Attunement](../Browse/Features/Fury/4th-Level Features/Primordial Attunement.md#primordialattunement), [Primordial Strike](../Browse/Features/Fury/4th-Level Features/Primordial Strike.md#primordial-trike), Skill           | Signature, 3, 5, 7        | 5                |
| 5th   | Aspect Feature, 9-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Signature, 3, 5, 7, 9     | 5                |
| 6th   | [Marauder of the Primordial Chaos](../Browse/Features/Fury/6th-Level Features/Marauder of the Primordial Chaos.md#marauderoftheprimordialchao), Perk, Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9     | 5, 9             |
| 7th   | [Characteristic Increase](../Browse/Features/Fury/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Elemental Form](../Browse/Features/Fury/7th-Level Features/Elemental Form.md#elementalform), [Greater Ferocity](../Browse/Features/Fury/7th-Level Features/Greater Ferocity.md#greaterferocity), [Growing Ferocity Improvement](../Browse/Features/Fury/7th-Level Features/Growing Ferocity Improvement.md#growingferocityimprovement), Skill                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5, 9             |
| 8th   | Perk, Aspect Feature, 11-Ferocity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9             |
| 9th   | [Harbinger of the Primordial Chaos](../Browse/Features/Fury/9th-Level Features/Harbinger of the Primordial Chaos.md#harbingeroftheprimordialchao), Aspect Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |
| 10th  | [Chaos Incarnate](../Browse/Features/Fury/10th-Level Features/Chaos Incarnate.md#chao-incarnate), [Characteristic Increase](../Browse/Features/Fury/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Growing Ferocity Improvement](../Browse/Features/Fury/10th-Level Features/Growing Ferocity Improvement.md#growingferocityimprovement), Perk, [Primordial Ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordialferocity), [Primordial Power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower), Skill                | Signature, 3, 5, 7, 9, 11 | 5, 9, 11         |

### 1st-Level Features

As a 1st-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
Within the heat of battle, your determination and anger grow, fueling a Heroic Resource called [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) equal to your Victories. At the start of each of your turns during combat, you gain 1d3 [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).

Additionally, the first time each combat round that you take damage, you gain 1 [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity). The first time you become winded or are dying in an encounter, you gain 1d3 [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                        |
| ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2                                                                                           | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, the forced movement distance gains a bonus equal to your Might score.                                     |
| 4                                                                                           | The first time you push a creature on a turn, you gain 1 surge.                                                                                                                                                                |
| 6                                                                                           | You gain an edge on Might tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                        |
| 8 (4th level)                                                                               | The first time you push a creature on a turn, you gain 2 surges.                                                                                                                                                               |
| 10 (7th level)                                                                              | You have a double edge on Might tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                  |
...
| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                           | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, the forced movement distance gains a bonus equal to your Agility score.                                     |
| 4                                                                                           | The first time you slide a creature on a turn, you gain 1 surge.                                                                                                                                                                 |
| 6                                                                                           | You gain an edge on Agility tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                        |
| 8 (4th level)                                                                               | The first time you slide a creature on a turn, you gain 2 surges.                                                                                                                                                                |
| 10 (7th level)                                                                              | You have a double edge on Agility tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                  |
...
You can't obtain lower than a tier 2 outcome on any Might test made to [jump](../Browse/Movement/Jump.md#jump) (see Movement Types in Chapter 10: Combat).
...
As a 2nd-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; P < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) and [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 5 + M damage; P < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) and [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 8 + M damage; P < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) and [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 2 damage; A < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 4 damage; A < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 6 damage; A < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
As a 3rd-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, each enemy who starts their turn adjacent to you and has P < STRONG is [frightened](../Browse/Conditions/Frightened.md#frightened) until the end of their turn.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, each creature you make a melee strike against who has P < AVERAGE is [taunted](../Browse/Conditions/Taunted.md#taunted) until the end of their next turn. Additionally, when you use an ability that deals rolled damage against any enemy [taunted](../Browse/Conditions/Taunted.md#taunted) by you, the ability deals extra damage equal to twice your Might score and increases its potency by 1.
...
As a 4th-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
Your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) feature provides additional benefits when you have 8 or more [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
As a 7th-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
When you gain [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) at the start of each of your turns during combat, you gain 1d3 + 1 ferocity instead of 1d3.
...
As a 9th-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.

#### Harbinger of the Primordial Chaos

You can create a temporary source of elemental power as a respite activity. This source of elemental power lasts 24 hours after creation, and can be used to create a portal to Quintessence with your [Primordial Portal](../Browse/Features/Fury/6th-Level Features/Primordial Portal.md#primordialportal) feature. If you do so, the source of elemental power lasts as long as the portal is maintained in your network.
...
> **Power Roll + Might:**
>
> - **≤11:** 3 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 3
> - **12-16:** 5 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 5
> - **17+:** 8 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 7
>
...
As a 10th-level [fury](../Browse/Classes/Fury.md#fury), you gain the following features.
...
Your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) feature provides additional benefits when you have 12 or more [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).
...
You have an epic resource called [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower). Each time you finish a respite, you gain [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) equal to the XP you gain. You can spend [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) on your abilities as if it were [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity).

Additionally, you can spend any amount of [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) as a free maneuver, ending one effect on you for each [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) spent.

You can also spend 3 [primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) to create a portal to Quintessence without needing a source of elemental power.

[Primordial power](../Browse/Features/Fury/10th-Level Features/Primordial Power.md#primordialpower) remains until you spend it.
...
The stormwight [primordial aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordiala-pect) lets you channel your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) into the form of an animal and grants you knowledge of one stormwight kit of your choice. You can master additional stormwight kits through play, changing them out during a respite as with any other kit (see Chapter 6: Kits).
...
Your [primordial aspect](../Browse/Features/Fury/1st-Level Features/Primordial Aspect.md#primordiala-pect) benefits are always available to you, and you gain additional benefits while in the animal or hybrid form granted by your stormwight kit.
...
You wear no armor and wield only your unarmed strikes—which become devastating natural weapons as your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) grows.
...
Each stormwight kit grants a set of benefits for your [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) feature.

#### Boren

With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordialferocity) into the form of a bear, becoming large, durable, and imposing. Boren are tied to the craggy, rocky north, and this aspect is associated with the blizzard's bitter cold.

##### Aspect Benefits

Whenever you use forced movement to push a creature, you can pull that creature instead. Whenever you pull a creature adjacent to you and that creature has M < AVERAGE, you can use a free triggered action to make that creature [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by you.
...
- **[Stability](../Browse/Movement/Stability.md#tability) Bonus:** +2
...
- **≤11:** 2 + M damage; M < WEAK, [grabbed](../Browse/Conditions/Grabbed.md#grabbed)
- **12-16:** 5 + M damage; M < AVERAGE, [grabbed](../Browse/Conditions/Grabbed.md#grabbed)
- **17+:** 11 + M damage; M < STRONG, [grabbed](../Browse/Conditions/Grabbed.md#grabbed)

##### Growing Ferocity

As your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) grows, you gain benefits as noted on the Boren [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Boren Growing Ferocity Table

| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                           | You can have up to two creatures [grabbed](../Browse/Conditions/Grabbed.md#grabbed) at a time. Additionally, whenever you make a strike against a creature you have [grabbed](../Browse/Conditions/Grabbed.md#grabbed), you gain 1 surge.             |
| 4                                                                                           | The first time you [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) a creature on a turn, you gain 1 surge.                                                                                                                                              |
| 6                                                                                           | You gain an edge on the [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) and [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuvers.                                                                            |
| 8 (4th level)                                                                               | The first time you [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) a creature on a turn, you gain 2 surges instead of 1.                                                                                                                                |
| 10 (7th level)                                                                              | You have a double edge on the [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) and [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuvers.                                                                      |
| 12 (10th level)                                                                             | Whenever you use a heroic ability, you gain 10 temporary Stamina. Additionally, whenever you have a creature [grabbed](../Browse/Conditions/Grabbed.md#grabbed), any ability roll made against that creature gains a bonus to its potency equal to your Might score. |

#### Corven

With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordialferocity) into the form of a crow, becoming stealthy and quick. Corven are tied to the mountain passes and the hot winds that flow through them. This aspect is associated with the warm and fast-rising anabatic wind.
...
While you are in your crow form, your size is 1T and you can [fly](../Browse/Movement/Fly.md#fly). You can use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver as a free maneuver, and you can use your allies as cover when you [hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide). You can't use any abilities while in this form except for Aspect of the Wild.

##### Hybrid Form: Crow

While you are in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can [fly](../Browse/Movement/Fly.md#fly).
...
As your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) grows, you gain benefits as noted on the Corven [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Corven Growing Ferocity Table

| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                           | Whenever you use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action, the distance you can shift gains a bonus equal to your Agility score.                                                         |
| 4                                                                                           | The first time you shift on a turn, you gain 1 surge.                                                                                                                                                                                                      |
| 6                                                                                           | You gain an edge on Agility tests, the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#e-capegrab) maneuver, and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.       |
| 8 (4th level)                                                                               | The first time you shift on a turn, you gain 2 surges instead of 1.                                                                                                                                                                                        |
| 10 (7th level)                                                                              | You have a double edge on Agility tests, the [Escape Grab](../Browse/Abilities/Common/Maneuvers/Escape Grab.md#e-capegrab) maneuver, and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver. |
...
With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordialferocity) into the form of a rat, becoming mobile and elusive. Raden are associated with the wild nature of the rat, before cities became their habitat. This aspect is associated with the rat flood—a surge of corrupted water that draws forth hordes of rats.
...
While you are in your rat form, your size is 1T and you can automatically [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) at full speed while moving. You can use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver as a free maneuver, you can use your allies as cover when you [hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide), and you can stay hidden while you move through squares occupied by any creature. Additionally, you gain an edge on tests made to [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) other creatures. You can't use any abilities while in this form except for Aspect of the Wild.

##### Hybrid Form: Rat

While you are in your hybrid form, your size is your choice of 1S or 1M. At 4th level, you can automatically [climb](../Browse/Movement/Climb or Swim.md#climbor-wim) at full speed while moving.
...
As your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) grows, you gain benefits as noted on the Raden [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.
...
With this stormwight kit, you channel your [primordial ferocity](../Browse/Features/Fury/10th-Level Features/Primordial Ferocity.md#primordialferocity) into the form of a wolf, becoming a fleet-footed hunter. Vuken are tied to forests and open steppes, and this aspect is associated with the thunderstorm.

##### Aspect Benefits

Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can then use the [Aid Attack](../Browse/Abilities/Common/Maneuvers/Aid Attack.md#aidattack) maneuver as a free triggered action.
...
- **≤11:** 4 + M damage; A < WEAK, [prone](../Browse/Conditions/Prone.md#prone)
- **12-16:** 7 + M damage; A < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone)
- **17+:** 9 + M damage; A < STRONG, [prone](../Browse/Conditions/Prone.md#prone)

##### Growing Ferocity

As your [ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) grows, you gain benefits as noted on the Vuken [Growing Ferocity](../Browse/Features/Fury/1st-Level Features/Growing Ferocity.md#growingferocity) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Vuken Growing Ferocity Table

| [Ferocity](../Browse/Features/Fury/1st-Level Features/Ferocity.md#ferocity) | Benefit                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                           | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can target one additional creature.                                                                     |
| 4                                                                                           | The first time on a turn that you push a creature or knock a creature [prone](../Browse/Conditions/Prone.md#prone), you gain 1 surge.                                                                           |
| 6                                                                                           | You gain an edge on Agility tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                        |
| 8 (4th level)                                                                               | The first time on a turn that you push a creature or knock a creature [prone](../Browse/Conditions/Prone.md#prone), you gain 2 surges.                                                                          |
| 10 (7th level)                                                                              | You have a double edge on Agility tests and the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver.                                                                                  |
| 12 (10th level)                                                                             | Whenever you use a heroic ability, you gain 10 temporary Stamina. Additionally, whenever you make a power roll that imposes forced movement on a target, the forced movement distance gains a bonus equal to your Agility score. |
...
**As a [null](../Browse/Classes/Null.md#null), you resist the supernatural forces of the universe with composure and confidence. As you strive for perfect order, you are an enemy of the ultimate expression of chaos: the supernatural. Those who break the laws of nature using sorcery or psionics should fear you.**
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ------------------- |
| 1st   | Null Tradition, [Discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline), Null Field, [Inertial Shield](../Browse/Abilities/Null/1st-Level Features/Inertial Shield.md#inertial-hield), [Discipline Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery.md#di-ciplinema-tery), Null Speed, [Psionic Augmentation](../Browse/Features/Talent/1st-Level Features/Psionic Augmentation.md#p-ionicaugmentation), [Psionic Martial Arts](../Browse/Features/Null/1st-Level Features/Psionic Martial Arts.md#p-ionicmartialart), Null Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Two signature, 3, 5           | 5                   |
| 3rd   | [Psionic Leap](../Browse/Features/Null/3rd-Level Features/Psionic Leap.md#p-ionicleap), [Reorder](../Browse/Features/Null/3rd-Level Features/Reorder.md#reorder), 7-Discipline Ability                                                                                                                                                                                                                                                                                                                                                                                                                     | Two signature, 3, 5, 7        | 5                   |
| 4th   | [Characteristic Increase](../Browse/Features/Null/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Discipline Mastery Improvement](../Browse/Features/Null/7th-Level Features/Discipline Mastery Improvement.md#di-ciplinema-teryimprovement), Enhanced Null Field, Perk, [Regenerative Field](../Browse/Features/Null/4th-Level Features/Regenerative Field.md#regenerativefield), Skill                                                                                                                                                                                                              | Two signature, 3, 5, 7        | 5                   |
| 5th   | Tradition Feature, 9-Discipline Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Two signature, 3, 5, 7, 9     | 5                   |
| 6th   | [Elemental Absorption](../Browse/Features/Null/6th-Level Features/Elemental Absorption.md#elementalab-orption), [Elemental Buffer](../Browse/Features/Null/6th-Level Features/Elemental Buffer.md#elementalbuffer), Perk, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                              | Two signature, 3, 5, 7, 9     | 5, 9                |
| 7th   | [Characteristic Increase](../Browse/Features/Null/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Discipline Mastery Improvement](../Browse/Features/Null/7th-Level Features/Discipline Mastery Improvement.md#di-ciplinema-teryimprovement), [Psi Boost](../Browse/Features/Null/7th-Level Features/Psi Boost.md#p-iboo-t), [Improved Body](../Browse/Features/Null/7th-Level Features/Improved Body.md#improvedbody), Skill                                                                                                                                                  | Two signature, 3, 5, 7, 9     | 5, 9                |
| 8th   | Perk, Tradition Feature, 11-Discipline Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Two signature, 3, 5, 7, 9, 11 | 5, 9                |
| 9th   | [I Am the Weapon](../Browse/Features/Null/9th-Level Features/I Am the Weapon.md#iamtheweapon), Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
| 10th  | [Characteristic Increase](../Browse/Features/Null/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Discipline Mastery Improvement](../Browse/Features/Null/7th-Level Features/Discipline Mastery Improvement.md#di-ciplinema-teryimprovement), [Manifold Body](../Browse/Features/Null/10th-Level Features/Manifold Body.md#manifoldbody), [Manifold Resonance](../Browse/Features/Null/10th-Level Features/Manifold Resonance.md#manifoldre-onance), [Order](../Browse/Features/Null/10th-Level Features/Order.md#order), Perk, Skill                               | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |

### 1st-Level Features

As a 1st-level [null](../Browse/Classes/Null.md#null), you gain the following features.
...
As your mastery of your body and tradition grows, it imbues you with a Heroic Resource called [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline).
...
Though you can't gain [discipline outside of combat](../Browse/Features/Null/1st-Level Features/Discipline/Discipline Outside of Combat.md#di-ciplineout-ideofcombat), you can use your heroic abilities and effects that cost discipline without spending it. Whenever you use an ability or effect outside of combat that costs [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited discipline on its effect, you can use it as if you had spent an amount of [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) equal to your Victories. (Such abilities aren't part of the core rules for the [null](../Browse/Classes/Null.md#null), but they might appear in future products.)
...
As you advance in your chosen null tradition, you gain certain benefits in combat, including benefits based on the amount of [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) you have. Benefits based on how much discipline you have last until the end of your turn, even if a benefit would become unavailable to you because of the amount of [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) you spend during your turn.

Some [Discipline Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery.md#di-ciplinema-tery) benefits can be applied only if you are a specific level or higher, with the level of those benefits noted in the tables below.

##### Chronokinetic Mastery

Whenever you use the [Inertial Shield](../Browse/Abilities/Null/1st-Level Features/Inertial Shield.md#inertial-hield) ability, you can use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action as a free triggered action.

Additionally, as your [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) grows, your psionic mastery of your body intensifies, granting benefits from the [Chronokinetic Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery/Chronokinetic Mastery.md#chronokineticma-tery) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Chronokinetic Mastery Table

| [Discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) | Benefit                                                                                                                                                                                                                                                                                                     |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                               | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can use the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action as a free triggered action either before or after the maneuver. |
...
Whenever you use your [Inertial Shield](../Browse/Abilities/Null/1st-Level Features/Inertial Shield.md#inertial-hield) ability, you can then use the [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) maneuver as a free triggered action.

Additionally, as your [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) grows, you strengthen the psionic power suffusing you, granting benefits from the [Cryokinetic Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery/Cryokinetic Mastery.md#cryokineticma-tery) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Cryokinetic Mastery Table

| [Discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) | Benefit                                                                                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                               | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can target one additional creature. Additionally, whenever you deal untyped damage with a psionic ability, you can change it to cold damage instead. |
| 4                                                                                               | The first time on a turn that you [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) a creature or an enemy moves 1 or more squares in the area of your Null Field ability, you gain 1 surge.                                                        |
| 6                                                                                               | You gain an edge on the [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) and [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuvers.                                                                      |
| 8 (4th level)                                                                                   | The first time on a turn that you [grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) a creature or an enemy moves 1 or more squares in the area of your Null Field ability, you gain 2 surges.                                                       |
| 10 (7th level)                                                                                  | You have a double edge on the [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) and [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuvers.                                                                |
| 12 (10th level)                                                                                 | Whenever you force move a target, the forced movement distance gains a bonus equal to your Intuition score. Additionally, whenever you use a heroic ability, you gain 10 temporary Stamina.                                                                                   |

##### Metakinetic Mastery

Whenever you use your [Inertial Shield](../Browse/Abilities/Null/1st-Level Features/Inertial Shield.md#inertial-hield) ability, you can then use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver as a free triggered action.

Additionally, as your [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) grows, your psionic potential is amplified, granting benefits from the [Metakinetic Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery/Metakinetic Mastery.md#metakineticma-tery) table. Benefits are cumulative except where an improved benefit replaces a lesser benefit.

###### Metakinetic Mastery Table

| [Discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) | Benefit                                                                                                                                                                                                        |
| ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                                                                                               | Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, the forced movement distance gains a bonus equal to your Intuition score.                 |
...
The flow of psionic power through you allows you to achieve high velocity. You gain a bonus to speed and to the number of squares you can shift when you take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action equal to your Agility score.

#### Psionic Augmentation

Your training has turned your body into the perfect psionic weapon, shaping pathways in your mind that enhance your physical form. Choose one of the following augmentations. You can change your augmentation by undergoing a psionic meditation as a respite activity. (*Quick Build:* [Speed Augmentation](../Browse/Features/Talent/1st-Level Features/Psionic Augmentation/Speed Augmentation.md#peedaugmentation).)
...
Whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) or [Grab](../Browse/Abilities/Common/Maneuvers/Grab.md#grab) maneuver, you use Intuition instead of Might for the power roll and for determining if you can target creatures larger than you. Additionally, whenever you use the [Knockback](../Browse/Abilities/Common/Maneuvers/Knockback.md#knockback) maneuver, you can choose to slide the target instead of pushing them.
...
As a 2nd-level [null](../Browse/Classes/Null.md#null), you gain the following features.
...
As a 3rd-level [null](../Browse/Classes/Null.md#null), you gain the following features.

#### Psionic Leap

You can long [jump](../Browse/Movement/Jump.md#jump) and high [jump](../Browse/Movement/Jump.md#jump) a distance equal to twice your Agility score without needing to make a test.
...
As a 7th-level [null](../Browse/Classes/Null.md#null), you gain the following features.
...
As an 8th-level [null](../Browse/Classes/Null.md#null), you gain the following features.
...
| Tradition     | Feature                                                                                                                                         |
| ------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Chronokinetic | [Shared Momentum](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Shared Momentum.md#haredmomentum)     |
| Cryokinetic   | [Synaptic Triage](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Synaptic Triage.md#ynaptictriage)     |
| Metakinetic   | [Inertial Dampener](../Browse/Features/Null/8th-Level Features/8th-Level Tradition Feature/Inertial Dampener.md#inertialdampener) |

##### Inertial Dampener

You and each creature or object of your choice in the area of your Null Field ability gain a bonus to [stability](../Browse/Movement/Stability.md#tability) equal to your Intuition score. A creature who attempts to force move a target with this bonus takes psychic damage equal to your Intuition score.

##### Shared Momentum

When you take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action, one ally in the area of your Null Field ability can also take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action as a free triggered action, using your distance for that move action.
...
> **Power Roll + Agility:**
>
> - **≤11:** 9 + A damage; push 5; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 13 + A damage; push 7; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 18 + A damage; push 10; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
>
> **Effect:** The target and each creature or object they collide with from this forced movement takes psychic damage equal to the total number of squares the target was force moved. While the target is [dazed](../Browse/Conditions/Dazed.md#dazed) this way, they see glimpses of creatures from other parts of the timescape.
...
>
> **Effect:** The target takes half the damage, and if the triggering creature has I < AVERAGE, they are [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends). While the triggering creature is [dazed](../Browse/Conditions/Dazed.md#dazed) this way, they take psychic damage equal to your Intuition score whenever they use a main action.

### 9th-Level Features

As a 9th-level [null](../Browse/Classes/Null.md#null), you gain the following features.

#### I Am the Weapon

Your Stamina increases by 21 and you can't be made [bleeding](../Browse/Conditions/Bleeding.md#bleeding) even while dying. You no longer age or have need of food. Additionally, you can use Intuition instead of another characteristic when resisting potencies.
...
Your [Discipline Mastery](../Browse/Features/Null/1st-Level Features/Discipline Mastery.md#di-ciplinema-tery) feature provides additional benefits when you have 12 or more [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline).

#### Manifold Body

When you gain [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline) at the start of each of your turns during combat, you gain 4 discipline instead of 3.
...
Whenever you use an ability, you gain 1 discipline that can be used only to apply a benefit from your [Psi Boost](../Browse/Features/Talent/6th-Level Features/Psi Boost.md#p-iboo-t) feature to that ability. Additionally, you and allies in the area of your Null Field ability ignore banes and double banes on your power rolls.

#### Order

You have an epic resource called order. Each time you finish a respite, you gain order equal to the XP you gain. You can spend order on your abilities as if it were [discipline](../Browse/Features/Null/1st-Level Features/Discipline.md#di-cipline).
...
[Order](../Browse/Features/Null/10th-Level Features/Order.md#order) remains until you spend it.
...
Subtlety is your art, the tip of the blade your brush. You studied at a secret college, specializing in alchemy, illusion, or shadow-magics. Your training and knowledge place you among the elite ranks of assassins, spies, and commandos. But more potent than any weapon or sorcery is your [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight) into your enemies' weaknesses.

**As a [shadow](../Browse/Classes/Shadow.md#hadow), you possess abilities that deal significant damage, enable you to move swiftly across the battlefield and evade hazards, and allow you to fade from notice even in the midst of the most intense combat encounters. You also possess more skills than any other hero.**
...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ----------------- |
| 1st   | [Shadow](../Browse/Classes/Shadow.md#hadow) College, [Insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight), College Features, [College Triggered Action](../Browse/Features/Shadow/1st-Level Features/College Triggered Action.md#collegetriggeredaction), [Hesitation Is Weakness](../Browse/Features/Shadow/1st-Level Features/Hesitation Is Weakness.md#he-itationi-weakne), Kit, Shadow Abilities                                                                                                                                                        | Signature, 3, 5           | -                 |
| 2nd   | College Feature, Perk, College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5           | 5                 |
| 3rd   | [Careful Observation](../Browse/Abilities/Shadow/3rd-Level Features/Careful Observation.md#carefulob-ervation), 7-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7        | 5                 |
| 4th   | [Characteristic Increase](../Browse/Features/Shadow/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Keep It Down](../Browse/Features/Shadow/4th-Level Features/Keep It Down.md#keepitdown), [Night Watch](../Browse/Abilities/Shadow/4th-Level Features/Night Watch.md#nightwatch), Perk, Skill, [Surge of Insight](../Browse/Features/Shadow/4th-Level Features/Surge of Insight.md#urgeofin-ight)                                                                                                                                                    | Signature, 3, 5, 7        | 5                 |
| 5th   | College Feature, 9-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Signature, 3, 5, 7, 9     | 5                 |
| 6th   | Perk, [Umbral Form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbralform), College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Signature, 3, 5, 7, 9     | 5, 9              |
| 7th   | [Characteristic Increase](../Browse/Features/Shadow/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Keen Insight](../Browse/Features/Shadow/7th-Level Features/Keen Insight.md#keenin-ight), Skill, [Careful Observation Improvement](../Browse/Features/Shadow/7th-Level Features/Careful Observation Improvement.md#carefulob-ervationimprovement), [Ventriloquist](../Browse/Features/Shadow/7th-Level Features/Ventriloquist.md#ventriloqui-t)                                                                                                                             | Signature, 3, 5, 7, 9     | 5, 9              |
| 8th   | College Feature, Perk, 11-Insight Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Signature, 3, 5, 7, 9, 11 | 5, 9              |
| 9th   | [Gloom Squad](../Browse/Features/Shadow/9th-Level Features/Gloom Squad.md#gloom-quad), College Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |
| 10th  | [Characteristic Increase](../Browse/Features/Shadow/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Death Pool](../Browse/Features/Shadow/10th-Level Features/Death Pool.md#deathpool), Perk, Skill, [Careful Observation Improvement](../Browse/Features/Shadow/10th-Level Features/Careful Observation Improvement.md#carefulob-ervationimprovement), [Improved Umbral Form](../Browse/Features/Shadow/10th-Level Features/Improved Umbral Form.md#improvedumbralform), [Subterfuge](../Browse/Features/Shadow/10th-Level Features/Subterfuge.md#ubterfuge) | Signature, 3, 5, 7, 9, 11 | 5, 9, 11          |

### 1st-Level Features

As a 1st-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.

#### Shadow College

[Shadow](../Browse/Classes/Shadow.md#hadow) colleges are secret institutions that turn ordinary folk into something else. Finding a college is the first step in a rigorous initiation process that tests the mettle of an applicant. Even those who make the cut often wash out—or are kicked out—as the master shadows who teach stealth, magic, and assassination to their students are often less than gentle in their approach.

You graduated from a [shadow](../Browse/Classes/Shadow.md#hadow) college chosen from the following options, each of which grants you a skill. (*Quick Build:* College of Black Ash.)

- College of Black Ash: The College of Black Ash founded the art of being a [shadow](../Browse/Classes/Shadow.md#hadow). Its graduates are unmatched in mobility, using sorcery to [teleport](../Browse/Movement/Teleport.md#teleport) around the battlefield, manipulate shadows, and summon darkness. You have the Magic skill.
...
Your [shadow](../Browse/Classes/Shadow.md#hadow) college is your subclass, and your choice of college determines many of the features you'll gain as you gain new levels.

#### Insight

By observing your enemy, you learn how to use their weaknesses against them, building up a Heroic Resource called [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight).

##### Insight in Combat

At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight) equal to your Victories. At the start of each of your turns during combat, you gain 1d3 [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight).

Additionally, the first time each combat round that you deal damage incorporating 1 or more surges, you gain 1 [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight).
...
Although you can't gain [insight outside of combat](../Browse/Features/Shadow/1st-Level Features/Insight/Insight Outside of Combat.md#in-ightout-ideofcombat), you can use your heroic abilities and effects that cost insight without spending it. Whenever you use an ability or effect outside of combat that costs [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited insight on its effect, such as Black Ash [Teleport](../Browse/Movement/Teleport.md#teleport), you can use it as if you had spent an amount of [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight) equal to your Victories.
...
>
> **Effect:** You take half the triggering damage, then can shift up to 2 squares after the triggering effect resolves. If you end this shift with concealment or cover, you can use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide) maneuver even if you are observed.
>
...
> **Trigger:** You take damage.
>
> **Effect:** You take half the damage, then can [teleport](../Browse/Movement/Teleport.md#teleport) up to 4 squares after the triggering effect resolves.
>
> **Spend 1+ Insight:** You [teleport](../Browse/Movement/Teleport.md#teleport) 1 additional square for each insight spent.
...
> - **≤11:** 3 + A damage
> - **12-16:** 5 + A damage
> - **17+:** 8 + A damage; I < STRONG, [prone](../Browse/Conditions/Prone.md#prone)
>
...
As a 2nd-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 + A damage; you can [teleport](../Browse/Movement/Teleport.md#teleport) the target 1 square
> - **12-16:** 10 + A damage; you can [teleport](../Browse/Movement/Teleport.md#teleport) the target up to 3 squares
> - **17+:** 14 + A damage; you can [teleport](../Browse/Movement/Teleport.md#teleport) the target up to 5 squares
...
> - **17+:** 7 poison damage
>
> **Effect:** The gas remains in the area until the end of the encounter. Any creature who starts their turn in the area and has M < AVERAGE is [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends).
...
As a 3rd-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, whenever an enemy moves or is force moved adjacent to you or damages you, you can take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#di-engage) move action as a free triggered action.
...
> - **17+:** 18 + A damage
>
> **Effect:** The target is [taunted](../Browse/Conditions/Taunted.md#taunted) by a willing ally within 5 squares of you until the end of the target's next turn.
...
> **Power Roll + Agility:**
>
> - **≤11:** 8 + A damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **12-16:** 12 + A damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **17+:** 16 + A damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
...
> **Power Roll + Agility:**
>
> - **≤11:** 7 + A damage; M < WEAK, [slowed](../Browse/Conditions/Slowed.md#lowed) (save ends)
> - **12-16:** 11 + A damage; M < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)
> - **17+:** 16 + A damage; M < STRONG, [prone](../Browse/Conditions/Prone.md#prone) and can't stand (save ends)

### 4th-Level Features

As a 4th-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.
...
As a 5th-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.

#### 5th-Level College Feature

Your [shadow](../Browse/Classes/Shadow.md#hadow) college grants you a feature, as shown on the 5th-Level College Features table.

###### 5th-Level College Features Table

| College         | Feature                                                                                                                                         |
| --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| Black Ash       | [Trail of Cinders](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Trail of Cinders.md#trailofcinder) |
| Caustic Alchemy | [Volatile Reagents](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Volatile Reagents.md#volatilereagent) |
| Harlequin Mask  | [Harlequin Gambit](../Browse/Features/Shadow/5th-Level Features/5th-Level College Feature/Harlequin Gambit.md#harlequingambit)   |
...
If the creature is the same size as you, you can disguise yourself as them using I'm No Threat without spending [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight). If you do, while I'm No Threat is active, the creature's body is disguised to look like your body. The illusion ends on their body if another creature physically interacts with it. When the illusion would end for either you or the creature's body, it ends for both.
...
Additionally, your [Defensive Roll](../Browse/Abilities/Shadow/1st-Level Features/Defensive Roll.md#defen-iveroll) ability now allows you to shift up to 5 squares, including shifting vertically. If you don't end this shift on solid ground and are not [flying](../Browse/Movement/Fly.md#fly), you fall.
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; P < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 15 + A damage; P < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 21 + A damage; P < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
>
...
As an 8th-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.
...
> **Power Roll + Agility:**
>
> - **≤11:** 11 corruption damage; A < WEAK, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **12-16:** 16 corruption damage; A < AVERAGE, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
> - **17+:** 21 corruption damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#re-trained) (save ends)
...
As a 9th-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.

#### Gloom Squad

At the start of each of your turns, you can forgo gaining insight to create 1d6 clones of yourself in unoccupied adjacent spaces. A clone acts on your turn and uses your statistics, except they have 1 Stamina. They are affected by any conditions and effects on you, and last until the start of your next turn. A clone doesn't have [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight) and can't use the [Careful Observation](../Browse/Abilities/Shadow/3rd-Level Features/Careful Observation.md#carefulob-ervation) ability, the [Umbral Form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbralform) feature, or any triggered actions. On their turn, a clone has a move action, a maneuver, and a main action that they can use only to make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike). While making a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), a clone must choose targets that you or another clone aren't also striking.
...
> **Power Roll + Agility:**
>
> - **≤11:** An enemy takes 6 damage; an ally can [teleport](../Browse/Movement/Teleport.md#teleport) up to 3 squares.
> - **12-16:** An enemy takes 10 damage; an ally can [teleport](../Browse/Movement/Teleport.md#teleport) up to 5 squares.
> - **17+:** An enemy takes 14 damage; an ally can [teleport](../Browse/Movement/Teleport.md#teleport) up to 7 squares.
...
>
> **Effect:** On a critical hit, the target is [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by the demon and pulled through the portal before it closes, never to be seen again.
...
> **Power Roll + Agility:**
>
> - **≤11:** 4 + A fire damage; [vertical](../Browse/Movement/Vertical.md#vertical) push 8
> - **12-16:** 7 + A fire damage; [vertical](../Browse/Movement/Vertical.md#vertical) push 10
> - **17+:** 11 + A fire damage; [vertical](../Browse/Movement/Vertical.md#vertical) push 15
>
...
As a 10th-level [shadow](../Browse/Classes/Shadow.md#hadow), you gain the following features.
...
You can target three creatures simultaneously with your [Careful Observation](../Browse/Abilities/Shadow/3rd-Level Features/Careful Observation.md#carefulob-ervation) ability.

#### Improved Umbral Form

You gain full control over the [shadow](../Browse/Classes/Shadow.md#hadow) creature you become with your [Umbral Form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbralform) feature, and you can end the transformation at will (no action required). Additionally, you are always wreathed in darkness that grants you concealment while in this form, and creatures no longer gain an edge on strikes against you.

While you are in your [umbral form](../Browse/Features/Shadow/6th-Level Features/Umbral Form.md#umbralform), you can spend 1 uninterrupted minute concentrating on a location where you've been before. At the end of that minute, you and each willing creature of your choice within 10 squares of you can [teleport](../Browse/Movement/Teleport.md#teleport) to unoccupied spaces of your choice within that location. Each creature who [teleports](../Browse/Movement/Teleport.md#teleport) this way is invisible for 1 hour or until they use an ability.

#### Subterfuge

You have an epic resource called subterfuge. Each time you finish a respite, you gain subterfuge equal to the XP you gain. You can spend subterfuge on your abilities as if it were [insight](../Browse/Features/Shadow/1st-Level Features/Insight.md#in-ight).
...
[Subterfuge](../Browse/Features/Shadow/10th-Level Features/Subterfuge.md#ubterfuge) remains until you spend it.
...
**As a [tactician](../Browse/Classes/Tactician.md#tactician), you have abilities that heal your allies and grant them increased damage, movement, and attacks, even as you leave your enemies struggling to respond.**
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- | ------------------ |
| 1st   | [Tactical Doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine), [Focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu), Doctrine Feature, [Doctrine Triggered Action](../Browse/Features/Tactician/1st-Level Features/Doctrine Triggered Action.md#doctrinetriggeredaction), [Field Arsenal](../Browse/Features/Tactician/1st-Level Features/Field Arsenal.md#fieldar-enal), [Mark](../Browse/Features/Tactician/1st-Level Features/Mark.md#mark), [Strike Now](../Browse/Abilities/Tactician/1st-Level Features/Strike Now.md#trikenow), [Tactician](../Browse/Classes/Tactician.md#tactician) Abilities | 3, 5           | -                  |
| 2nd   | Perk, Doctrine Feature, Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 3, 5           | 5                  |
| 3rd   | [Out of Position](../Browse/Features/Tactician/3rd-Level Features/Out of Position.md#outofpo-ition), 7-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 3, 5, 7        | 5                  |
| 4th   | [Characteristic Increase](../Browse/Features/Tactician/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), Focus on Their Weakness, [Improved Field Arsenal](../Browse/Features/Tactician/4th-Level Features/Improved Field Arsenal.md#improvedfieldar-enal), Perk, Skill                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 3, 5, 7        | 5                  |
| 5th   | Doctrine Feature, 9-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 3, 5, 7, 9     | 5                  |
| 6th   | [Master of Arms](../Browse/Features/Tactician/6th-Level Features/Master of Arms.md#ma-terofarm), Perk, Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 3, 5, 7, 9     | 5, 9               |
| 7th   | [Characteristic Increase](../Browse/Features/Tactician/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Heightened Focus](../Browse/Features/Tactician/7th-Level Features/Heightened Focus.md#heightenedfocu), [Seize the Initiative](../Browse/Features/Tactician/7th-Level Features/Seize the Initiative.md#eizetheinitiative), Skill, Doctrine Feature                                                                                                                                                                                                                                                                                                                                                               | 3, 5, 7, 9     | 5, 9               |
| 8th   | Perk, Doctrine Feature, 11-Focus Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 3, 5, 7, 9, 11 | 5, 9               |
| 9th   | [Grandmaster of Arms](../Browse/Features/Tactician/9th-Level Features/Grandmaster of Arms.md#grandma-terofarm), Doctrine Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 3, 5, 7, 9, 11 | 5, 9, 11           |
| 10th  | [Characteristic Increase](../Browse/Features/Tactician/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Command](../Browse/Features/Tactician/10th-Level Features/Command.md#command), Perk, Skill, [True Focus](../Browse/Features/Tactician/10th-Level Features/True Focus.md#truefocu), [Warmaster](../Browse/Features/Tactician/10th-Level Features/Warmaster.md#warma-ter)                                                                                                                                                                                                                                                                                                             | 3, 5, 7, 9, 11 | 5, 9, 11           |

### 1st-Level Features

As a 1st-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.

#### Tactical Doctrine

Warfare is as old as civilization—and perhaps even older. As battle became ever more complex, military leaders invented [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine), outlining how combatants should be structured, used, and deployed. Doctrine can be learned at war colleges passing on ancient martial traditions, or directly through blood and sweat on the battlefield. Whatever path brought you to your mastery of historically proven tactics, you choose a [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine) from the following options, each of which grants you a skill. (*Quick Build:* Vanguard and the Intimidate skill.)
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine) is your subclass, and your choice of doctrine determines many of the features you'll gain as you gain new levels.

#### Focus

The ring of steel panics others but brings order to your mind, granting you a Heroic Resource called [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu).
...
Though you can't gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu) outside of combat, you can use your heroic abilities and effects that cost focus without spending it. Whenever you use an ability or effect outside of combat that costs [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu), you can't use that same ability or effect outside of combat again until you earn 1 or more Victories or finish a respite.

When you use an ability outside of combat that lets you spend unlimited focus on its effect, you can use it as if you had spent an amount of [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu) equal to your Victories. (Such abilities aren't part of the core rules for the [tactician](../Browse/Classes/Tactician.md#tactician), but they might appear in future products.)

<!-- -->
> **[Tactician](../Browse/Classes/Tactician.md#tactician) Abilities Explained**
>
> Many of the [tactician](../Browse/Classes/Tactician.md#tactician)'s abilities grant allies extra movement, damage, and actions. But what's happening in the fiction to allow this? The [tactician](../Browse/Classes/Tactician.md#tactician) is an incredible strategist and inspiring leader who is quick to give commands and inspiration that causes their allies to act. The [tactician](../Browse/Classes/Tactician.md#tactician) can quickly read the battlefield, analyze enemies, and then bark orders and encouragement that pushes their allies to greatness. Many of the names of the [tactician](../Browse/Classes/Tactician.md#tactician)'s abilities are the actual commands they give their friends!

#### 1st-Level Doctrine Feature

Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine) grants you a feature, as shown on the 1st-Level Doctrine Features table.

###### 1st-Level Doctrine Features Table

| Doctrine   | Feature                                                                                                                                                 |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Covert Operations](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Covert Operations.md#covertoperation)     |
| Mastermind | [Studied Commander](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Studied Commander.md#tudiedcommander)     |
| Vanguard   | [Commanding Presence](../Browse/Features/Tactician/1st-Level Features/1st-Level Doctrine Feature/Commanding Presence.md#commandingpre-ence) |
...
> | **📏 Ranged 10** | **🎯 One creature** |
>
> **Effect:** The target is marked by you until the end of the encounter, until you are dying, or until you use this ability again. You can willingly end your mark on a creature (no action required), and if another [tactician](../Browse/Classes/Tactician.md#tactician) marks a creature, your mark on that creature ends. When a creature marked by you is reduced to 0 Stamina, you can use a free triggered action to mark a new target within distance.
>
> You can initially mark only one creature using this ability, though other [tactician](../Browse/Classes/Tactician.md#tactician) abilities allow you to mark additional creatures at the same time. The mastermind [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine)'s [Anticipation](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Anticipation.md#anticipation) feature allows you to target additional creatures with this ability starting at 5th level.
>
...
> - If you damage a creature marked by you with a melee ability, the creature is [taunted](../Browse/Conditions/Taunted.md#taunted) by you until the end of their next turn.
>
...
> **Power Roll + Might:**
>
> - **≤11:** 3 + M damage; M < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** 5 + M damage; M < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** 8 + M damage; M < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 4 + M damage; R < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 6 + M damage; R < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 10 + M damage; R < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
...
> | **📏 Ranged 10** | **🎯 Three allies** |
>
> **Effect:** Each target can make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike).
...
As a 2nd-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.
...
Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine) grants you a feature, as shown on the 2nd-Level Doctrine Features table.

###### 2nd-Level Doctrine Features Table

| Doctrine   | Feature                                                                                                                                                   |
| ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Infiltration Tactics](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Infiltration Tactics.md#infiltrationtactic) |
| Mastermind | [Goaded](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Goaded.md#goaded)                               |
| Vanguard   | [Melee Superiority](../Browse/Features/Tactician/2nd-Level Features/2nd-Level Doctrine Feature/Melee Superiority.md#melee-uperiority)       |
...
**Mark Benefit:** When a creature marked by you attempts to move or shift within distance of your melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike), you can use a free triggered action and spend 2 focus to make a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against that creature.
...
>
> **Effect:** Each target is marked by you, and must immediately make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against a creature of your choice within 5 squares of them.
>
> **Mark Benefit:** Until the end of the encounter, whenever you or any ally makes a strike against a creature marked by you, you can spend 2 focus to force that target to make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against a creature of your choice within 5 squares of them.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R damage; R < WEAK, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 3 + R damage; R < AVERAGE, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 4 + R damage; R < STRONG, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** R < WEAK, the target is [frightened](../Browse/Conditions/Frightened.md#frightened) of the triggering ally (save ends)
> - **12-16:** R < AVERAGE, the target is [frightened](../Browse/Conditions/Frightened.md#frightened) of the triggering ally (save ends)
> - **17+:** R < STRONG, the target is [frightened](../Browse/Conditions/Frightened.md#frightened) of the triggering ally (save ends)
...
> | **📏 1 burst** | **🎯 Self and each ally in the area** |
>
> **Effect:** Until the start of your next turn, each target has a bonus to [stability](../Browse/Movement/Stability.md#tability) equal to your Might score. Additionally, each target gains 2 surges.

### 3rd-Level Features

As a 3rd-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.

#### Out of Position

Even before battle begins, your enemies struggle to keep up with your tactics. At the start of an encounter, you can use a free triggered action to use your [Mark](../Browse/Features/Tactician/1st-Level Features/Mark.md#mark) ability against one enemy you have line of effect to, even if you are surprised. You can then slide the marked target up to 3 squares, ignoring [stability](../Browse/Movement/Stability.md#tability). The target can't be moved in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter or until you are dying, whenever you or any ally deals damage to a target marked by you who has R < AVERAGE, the target is [frightened](../Browse/Conditions/Frightened.md#frightened) of the creature who dealt the damage (save ends).
...
As a 4th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.
...
As a 5th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.

#### 5th-Level Doctrine Features

Your [tactical doctrine](../Browse/Features/Tactician/1st-Level Features/Tactical Doctrine.md#tacticaldoctrine) grants you two features, as shown on the 5th-Level Doctrine Features table.

###### 5th-Level Doctrine Features Table

| Doctrine   | Features                                                                                                                                                                                                                                                                                             |
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Insurgent  | [Distracted](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Distracted.md#di-tracted), [Leave No Trace](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Leave No Trace.md#leavenotrace)               |
| Mastermind | [Anticipation](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Anticipation.md#anticipation), [I Predicted That](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/I Predicted That.md#ipredictedthat)       |
| Vanguard   | [Shake It Off](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Shake It Off.md#hakeitoff), [Tactical Offensive](../Browse/Features/Tactician/5th-Level Features/5th-Level Doctrine Features/Tactical Offensive.md#tacticaloffen-ive) |

##### Anticipation

You have learned to be more preemptive on the battlefield, thinking more steps ahead than your opponents. You can target two creatures with your [Mark](../Browse/Features/Tactician/1st-Level Features/Mark.md#mark) ability.

##### Distracted

You have mastered the ability to distract your foes, allowing you and your allies to take advantage of their gaps in attention. Whenever you or any ally attempts to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md#hide), any creature marked by you doesn't count as an observer. Additionally, you and your allies can use other allies as cover for the purpose of hiding.
...
When you use the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action to attack a creature marked by you, you can use a signature or heroic ability with the Melee and Strike keywords instead of a melee [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike).
...
> | **📏 3 burst** | **🎯 Self and each ally in the area** |
>
> **Effect:** Each target gains 2 surges. Additionally, they can spend a Recovery, remove any conditions or effects on them, and stand up if they are [prone](../Browse/Conditions/Prone.md#prone).
...
As a 6th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.

#### Master of Arms

Your expertise with weapons has grown to true mastery. Whenever you use a signature ability from one of your equipped kits or make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) using a weapon from one of your equipped kits, you can negate a bane on the power roll or reduce a double bane to a bane.
...
>
> **Effect:** If a target is force moved into another creature, they must make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) against that creature.
...
> **Power Roll + Might:**
>
> - **≤11:** A < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** A < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** A < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
> **Power Roll + Might:**
>
> - **≤11:** 6 + M damage; one ally within 10 squares can use the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action as a free triggered action, and can use a melee strike signature ability instead of a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) for the [charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge)
> - **12-16:** 9 + M damage; one ally within 10 squares can use the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action as a free triggered action, and can use a melee strike signature ability that gains an edge instead of a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) for the [charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge)
> - **17+:** 13 + M damage; two allies within 10 squares can use the [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge) main action as a free triggered action, and can each use a melee strike signature ability that gains an edge instead of a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) for the [charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge)
>
> **Effect:** If the target is hit with two or more strikes as part of this ability and they have R < STRONG, they are [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends). If the target is reduced to 0 Stamina before one or both allies has made their strike, the ally or allies can pick a different target.

### 7th-Level Features

As a 7th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.
...
When you gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu) at the start of each of your turns during combat, you gain 3 focus instead of 2.
...
As an 8th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.
...
As a 9th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.

#### Grandmaster of Arms

Your expertise with weapons has grown to true mastery. Whenever you use a signature ability from one of your equipped kits or make a [free strike](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-trike) using a weapon from one of your equipped kits, you automatically obtain a tier 3 outcome on the power roll. You can still roll to determine if you score a critical hit.
...
> **Power Roll + Might:**
>
> - **≤11:** R < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** R < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** R < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
...
As a 10th-level [tactician](../Browse/Classes/Tactician.md#tactician), you gain the following features.
...
You have an epic resource called [command](../Browse/Features/Tactician/10th-Level Features/Command.md#command). Each time you finish a respite, you gain [command](../Browse/Features/Tactician/10th-Level Features/Command.md#command) equal to the XP you gain. You can spend [command](../Browse/Features/Tactician/10th-Level Features/Command.md#command) on your abilities as if it were [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu).
...
[Command](../Browse/Features/Tactician/10th-Level Features/Command.md#command) remains until you spend it.
...
When you gain [focus](../Browse/Features/Tactician/1st-Level Features/Focus.md#focu) at the start of each of your turns during combat, you gain 4 focus instead of 3.
...
Arare few people are born with the potential to harness psionic power, but only those who experience an awakening, a significant event that activates a [talent](../Browse/Classes/Talent.md#talent)'s abilities, can tap into the mind's full potential. You are one of those people—a master of psionics and a source of incredible power created through sheer force of will. You can move and change matter, time, gravity, the laws of physics, or another creature's mind.

**As a [talent](../Browse/Classes/Talent.md#talent), you are limited only by the strength of your mind. But the ability to wield multiple powers at once and change reality at will involves a gamble. Every manifestation has a chance of harming you, and [talents](../Browse/Classes/Talent.md#talent) who use too much power too quickly pay a deadly price.**
...
| Level | Features                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Abilities                     | Tradition Abilities |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Talent](../Browse/Classes/Talent.md#talent) Tradition, [Clarity and Strain](../Browse/Features/Talent/1st-Level Features/Clarity and Strain.md#clarityand-train), [Mind Spike](../Browse/Abilities/Talent/1st-Level Features/Mind Spike.md#mind-pike), [Psionic Augmentation](../Browse/Features/Talent/1st-Level Features/Psionic Augmentation.md#p-ionicaugmentation), Talent Ward, [Telepathic Speech](../Browse/Features/Talent/1st-Level Features/Telepathic Speech.md#telepathic-peech), Tradition Features, [Talent](../Browse/Classes/Talent.md#talent) Abilities | Two signature, 3, 5           | -                   |
| 2nd   | Perk, Tradition Feature, Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Two signature, 3, 5           | 5                   |
| 3rd   | [Scan](../Browse/Features/Talent/3rd-Level Features/Scan.md#can), 7-Clarity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Two signature, 3, 5, 7        | 5                   |
| 4th   | [Characteristic Increase](../Browse/Features/Talent/4th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Mind Projection](../Browse/Features/Talent/4th-Level Features/Mind Projection.md#mindprojection), [Mind Recovery](../Browse/Features/Talent/4th-Level Features/Mind Recovery.md#mindrecovery), Perk, Skill [Suspensor Field](../Browse/Features/Talent/4th-Level Features/Suspensor Field.md#u-pen-orfield)                                                                                                                                                                       | Two signature, 3, 5, 7        | 5                   |
| 5th   | Tradition Feature, 9-Clarity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Two signature, 3, 5, 7, 9     | 5                   |
| 6th   | Perk, [Psi Boost](../Browse/Features/Talent/6th-Level Features/Psi Boost.md#p-iboo-t), Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Two signature, 3, 5, 7, 9     | 5, 9                |
| 7th   | [Ancestral Memory](../Browse/Features/Talent/7th-Level Features/Ancestral Memory.md#ance-tralmemory), [Cascading Strain](../Browse/Features/Talent/7th-Level Features/Cascading Strain.md#ca-cading-train), [Characteristic Increase](../Browse/Features/Talent/7th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Lucid Mind](../Browse/Features/Talent/7th-Level Features/Lucid Mind.md#lucidmind), Skill                                                                                                                                                                              | Two signature, 3, 5, 7, 9     | 5, 9                |
| 8th   | Perk, Tradition Feature, 11-Clarity Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Two signature, 3, 5, 7, 9, 11 | 5, 9                |
| 9th   | [Fortress of Perfect Thought](../Browse/Features/Talent/9th-Level Features/Fortress of Perfect Thought.md#fortre-ofperfectthought), Tradition Ability                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |
| 10th  | [Characteristic Increase](../Browse/Features/Talent/10th-Level Features/Characteristic Increase.md#characteri-ticincrea-e), [Clear Mind](../Browse/Features/Talent/10th-Level Features/Clear Mind.md#clearmind), [Omnisensory](../Browse/Features/Talent/10th-Level Features/Omnisensory.md#omni-en-ory), Perk, [Psion](../Browse/Features/Talent/10th-Level Features/Psion.md#p-ion), Skill, [Vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion)                                                                                                            | Two signature, 3, 5, 7, 9, 11 | 5, 9, 11            |

### 1st-Level Features

As a 1st-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
>
> **Strained:** The size of the burst increases by 2, and you are [bleeding](../Browse/Conditions/Bleeding.md#bleeding) until the start of your next turn.
...
> **Power Roll + Reason:**
>
> - **≤11:** 2 + R damage; M < WEAK, [prone](../Browse/Conditions/Prone.md#prone)
> - **12-16:** 4 + R damage; M < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone)
> - **17+:** 6 + R damage; M < STRONG, [prone](../Browse/Conditions/Prone.md#prone)
>
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P psychic damage; I < WEAK, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **12-16:** 6 + P psychic damage; I < AVERAGE, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
> - **17+:** 9 + P psychic damage; I < STRONG, [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends)
...
As a 2nd-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
Your [talent](../Browse/Classes/Talent.md#talent) tradition grants you a feature, as shown on the 2nd-Level Tradition Features table.
...
>
> **Effect:** Until the start of your next turn, each target gains a +5 bonus to speed, they can't be made [dazed](../Browse/Conditions/Dazed.md#dazed), and they can use an additional maneuver on their turn. If a target is already [dazed](../Browse/Conditions/Dazed.md#dazed), that condition ends for them.
>
...
As a 3rd-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.

#### Scan

You can extend your psionic senses beyond their usual range. Once on each of your turns, you can search for hidden creatures as a free maneuver (see Hide and Sneak in Chapter 9: Tests). Additionally, once you establish line of effect to a thinking creature within distance of your [Mind Spike](../Browse/Abilities/Talent/1st-Level Features/Mind Spike.md#mind-pike) ability, you always have line of effect to that creature until they move beyond that distance.
...
> **Power Roll + Presence:**
>
> - **≤11:** 3 + P corruption damage; P < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 5 + P corruption damage; the target is flung through time, and if P < AVERAGE, they are [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 8 + P corruption damage; the target is flung through time, and if P < STRONG, they are [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
...
>
> **Strained:** You take 2d6 damage and permanently grow visibly older (the equivalent of 10 years for a [human](../Browse/Ancestries/Human.md#human)). If you obtain a tier 3 outcome on the power roll, you gain 2 clarity.
...
> - **17+:** 5 damage
>
> **Strained:** You create five orbs, and you are [weakened](../Browse/Conditions/Weakened.md#weakened) while you have any orbs active.
...
As a 4th-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
You can [fly](../Browse/Movement/Fly.md#fly). While [flying](../Browse/Movement/Fly.md#fly), your [stability](../Browse/Movement/Stability.md#tability) is reduced to 0 and can't be increased. If you can already [fly](../Browse/Movement/Fly.md#fly), you have a +2 bonus to speed while [flying](../Browse/Movement/Fly.md#fly) instead.

If you are strained while [flying](../Browse/Movement/Fly.md#fly) and are force moved, the forced movement distance gains a +2 bonus.

### 5th-Level Features

As a 5th-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.

#### 5th-Level Tradition Features

Your [talent](../Browse/Classes/Talent.md#talent) tradition grants you two features, as shown on the 5th-Level Tradition Features table.
...
>
> | **Area, [Charge](../Browse/Abilities/Common/Main Actions/Charge.md#charge), Psionic, Telekinesis** |               **Main action** |
> | -------------------------------------------------------------------------------------------------------------------- | ----------------------------: |
> | **📏 5 x 2 line within 1**                                                                                           | **🎯 Each enemy in the area** |
>
> **Effect:** You [teleport](../Browse/Movement/Teleport.md#teleport) to a square on the opposite side of the area before making the power roll.
>
> **Power Roll + Reason:**
>
> - **≤11:** 12 sonic damage
...
As a 6th-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
> | **📏 Melee 2**                  | **🎯 One enemy** |
>
> **Effect:** The target has damage weakness 5 until the end of your next turn. Whenever the target takes damage while they have this weakness, they are knocked [prone](../Browse/Conditions/Prone.md#prone).
>
> **Strained:** This ability gains the Strike keyword as the vision hurts the target's psyche. You make a power roll, then are [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends).
>
> **Power Roll + Presence:**
>
...
>
> **Effect:** The area is frozen in time until the start of your next turn. Each object in the area is [restrained](../Browse/Conditions/Restrained.md#re-trained) and can't fall until the effect ends. Until the effect ends, creatures in the area who are reduced to 0 Stamina or would die stay alive, and objects in the area that are reduced to 0 Stamina remain undestroyed.
>
> Make a power roll that targets each enemy in the area.
>
> **Power Roll + Presence:**
>
> - **≤11:** P < WEAK, the target is [slowed](../Browse/Conditions/Slowed.md#lowed) until the effect ends
> - **12-16:** P < AVERAGE, the target's speed is 0 until the effect ends
> - **17+:** P < STRONG, the target is [restrained](../Browse/Conditions/Restrained.md#re-trained) until the effect ends
>
> **Strained:** Any creature or object force moved in the area takes 2 corruption damage for each square of the area they enter. Creatures and objects [restrained](../Browse/Conditions/Restrained.md#re-trained) in the area can be force moved. You are [restrained](../Browse/Conditions/Restrained.md#re-trained) until the effect ends.
...
> **Power Roll + Reason:**
>
> - **≤11:** 6 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 5 toward the center of the area
> - **12-16:** 9 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 7 toward the center of the area
> - **17+:** 13 damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 10 toward the center of the area
>
...
> **Power Roll + Reason:**
>
> - **≤11:** Slide 4 + R; M < WEAK, the forced movement is [vertical](../Browse/Movement/Vertical.md#vertical)
...
As an 8th-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
Your [talent](../Browse/Classes/Talent.md#talent) tradition grants you two features, as shown on the 8th-Level Tradition Features table.
...
Your mind can carry your body through tough times. You ignore difficult terrain and don't need to spend additional movement while [prone](../Browse/Conditions/Prone.md#prone).
...
> **Trigger:** The target takes damage.
>
> **Effect:** The target is [teleported](../Browse/Movement/Teleport.md#teleport) to an unoccupied space adjacent to you, taking no damage and suffering no additional effects if this movement would get them out of harm's way.
>
> **Strained:** You can't target yourself, and you take the damage and any additional effects instead of the target.

#### Universal Connection

The range of your [Telepathic Speech](../Browse/Features/Talent/1st-Level Features/Telepathic Speech.md#telepathic-peech) feature increases to anywhere on the same world.
...
> **Power Roll + Presence:**
>
> - **≤11:** 10 + P damage; P < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 14 + P damage; P < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 20 + P damage; P < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) and [slowed](../Browse/Conditions/Slowed.md#lowed) (save ends)
>
...
>
> **Strained:** You and the target both permanently grow visibly younger (the equivalent of 20 [human](../Browse/Ancestries/Human.md#human) years, to the minimum of an 18-year-old). Additionally, you are [weakened](../Browse/Conditions/Weakened.md#weakened) and [slowed](../Browse/Conditions/Slowed.md#lowed) (save ends).
...
- You can't be made [taunted](../Browse/Conditions/Taunted.md#taunted) or [frightened](../Browse/Conditions/Frightened.md#frightened).
...
As a 10th-level [talent](../Browse/Classes/Talent.md#talent), you gain the following features.
...
You have an epic resource called [vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion). Each time you finish a respite, you gain [vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion) equal to the XP you gain. You can spend [vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion) on your abilities as if it were clarity.

Additionally, you can spend [vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion) to use one additional psionic ability on your turn, provided you pay the entire cost of the ability in [vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion). If you choose to use a psionic ability that usually costs no clarity, you must spend 1 vision to use it.

[Vision](../Browse/Features/Talent/10th-Level Features/Vision.md#vi-ion) remains until you spend it.

## Troubadour

The whole world's a stage, and everyone on it, an actor. No one knows this better than the [troubadour](../Browse/Classes/Troubadour.md#troubadour). You find energy in the [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama) of everyday life and know how to draw spectacle forth from even the most mundane of situations. You accent highs and deepen lows in service to whoever might witness your performance.

**As a [troubadour](../Browse/Classes/Troubadour.md#troubadour), you chase [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama). The insurmountable dangers of the world might cause many a hero to cower. But you take to that world stage not intending to die, but to find out if you are truly alive.**
...
As a 1st-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.

#### Troubadour Class Act

Panache, melody, and depiction. Some [troubadours](../Browse/Classes/Troubadour.md#troubadour) have it all, but everyone starts somewhere. Your [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act is your art form, summing up the manner in which the world becomes your stage. As you go about unearthing the drama of everyday life and strife, you choose a [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act from the following options, each of which grants you a skill. (*Quick Build:* Virtuoso.)
...
- **Duelist:** [Drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama) infuses your every movement done in tandem with another. You perform dances of death, putting trust in your opponent to return your passion in kind. You have the Gymnastics skill.
...
Your [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act is your subclass, and your choice of class act determines many of the features you'll gain as you gain new levels.

#### Drama

During battles, you are fueled by the dynamic ups, downs, and upside downs of the fray, from which you derive a Heroic Resource called [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).

##### Drama in Combat

At the start of a combat encounter or some other stressful situation tracked in combat rounds (as determined by the Director), you gain [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama) equal to your Victories. At the start of each of your turns during combat, you gain 1d3 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).

Additionally, you gain [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama) when certain events occur during a combat encounter:

- The first time three or more heroes use an ability on the same turn, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
- The first time any hero is made winded during the encounter, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
...
Your [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act grants you two features, as shown on the 1st-Level Class Act Features table.
...
>
> **Effect:** At the end of each of your turns while this performance is active, you can choose up to a number of targets equal to your Presence score and [teleport](../Browse/Movement/Teleport.md#teleport) those targets to unoccupied spaces in the area. A target can't be [teleported](../Browse/Movement/Teleport.md#teleport) in a way that would harm them (such as over a cliff), leave them dying, or result in them suffering a condition or other negative effect.
...
> **Power Roll + Presence:**
>
> - **≤11:** 2 + P psychic damage; P < WEAK, [bleeding](../Browse/Conditions/Bleeding.md#bleeding) (save ends)
> - **12-16:** 5 + P psychic damage; P < AVERAGE, [bleeding](../Browse/Conditions/Bleeding.md#bleeding) (save ends)
> - **17+:** 7 + P psychic damage; P < STRONG, [bleeding](../Browse/Conditions/Bleeding.md#bleeding) (save ends)
...
> **Power Roll + Presence:**
>
> - **≤11:** Slide 1; I < WEAK, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **12-16:** Slide 1; I < AVERAGE, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
> - **17+:** Slide 2; I < STRONG, [dazed](../Browse/Conditions/Dazed.md#dazed) (save ends)
>
...
> **Power Roll + Agility:**
>
> - **≤11:** 6 + A damage; P < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 10 + A damage; P < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 14 + A damage; P < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
> **Effect:** You can become [bleeding](../Browse/Conditions/Bleeding.md#bleeding) (save ends) to deal an extra 5 corruption damage to the target.
...
As a 3rd-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.

#### 3rd-Level Class Act Feature

Your [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act grants you a feature, as shown on the 3rd-Level Class Act Features table.
...
> | **📏 5 aura**                | **🎯 Self and each ally in the area** |
>
> **Effect:** While this performance is active, each target who starts their turn dying while in the area gains an edge on power rolls and ignores the effects of [bleeding](../Browse/Conditions/Bleeding.md#bleeding) until the end of their turn.
...
> **Power Roll + Presence:**
>
> - **≤11:** 5 fire damage; A < WEAK, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **12-16:** 7 fire damage; A < AVERAGE, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
> - **17+:** 10 fire damage; A < STRONG, [weakened](../Browse/Conditions/Weakened.md#weakened) (save ends)
>
...
As a 4th-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.
...
- Whenever a creature rolls a natural 2 on a power roll, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
- The first time the Director deals damage to a hero using a Villain action or an ability that costs Malice, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
- The first time a hero unwillingly falls 5 or more squares, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
- The first time a hero deals damage with 3 surges, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
- Whenever a hero spends their last Recovery, you gain 2 [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).

Alternatively, you can forgo choosing a new event to choose one event you already have (including an event gained with this feature). Whenever the chosen event grants you [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama), you gain 1 additional [drama](../Browse/Features/Troubadour/1st-Level Features/Drama.md#drama).
...
As a 6th-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.
...
>
> **Effect:** A [prone](../Browse/Conditions/Prone.md#prone) target ignores this ability.
>
> **Power Roll + Presence:**
>
> - **≤11:** 7 sonic damage; P < WEAK, [prone](../Browse/Conditions/Prone.md#prone)
> - **12-16:** 10 sonic damage; P < AVERAGE, [prone](../Browse/Conditions/Prone.md#prone)
> - **17+:** 13 sonic damage; P < STRONG, [prone](../Browse/Conditions/Prone.md#prone)
...
As a 7th-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.
...
As an 8th-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.
...
Your [troubadour](../Browse/Classes/Troubadour.md#troubadour) class act grants you a feature, as shown on the 8th-Level Class Act Features table.
...
As a 9th-level [troubadour](../Browse/Classes/Troubadour.md#troubadour), you gain the following features.
