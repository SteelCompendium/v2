...
Your class provides you with many of your features, most of your abilities—your most potent combat moves and noncombat options and a Heroic Resource that fuels many of those abilities. This book presents nine [classes](https://steelcompendium.io/v2/Browse/Rules/Chapters/Classes) to choose from.

**[Censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor):** A [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor) is a trained warrior devoted to a saint or god. They hunt down the forces of evil using melee weapons and magic granted to them by their divine patron, specializing in confronting the wicked and locking down single enemies during combat.

**[Conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit):** A [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit) is the devoted priest of a saint or god. They wield divine magic that smites enemies with holy energy and supports their allies, and are renowned for their healing abilities.

**[Elementalist](https://steelcompendium.io/v2/Browse/Rules/Classes/Elementalist):** An [elementalist](https://steelcompendium.io/v2/Browse/Rules/Classes/Elementalist) studies the elemental forces of the timescape and controls earth, fire, the void, and more with magic. Many of their abilities cover wide areas of the battlefield, and they have a versatile array of tricks that allow them to both control combat and manipulate the environment around them when the fight is done.

**[Fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury):** Coursing with the ferocity of the Primordial Chaos in their veins, a [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury) is a mobile warrior who gets up close and personal with enemies to dish out lots of damage. Leaping around the battlefield felling foes and breaking down walls is where the [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury) lives.

**[Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null):** Disciplined and calm, the [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) is an unarmed warrior who manifests an aura that quells the supernatural and hinders the offensive prowess of their enemies. They use psionics to make their body stronger than any steel and faster than any steed.

**[Shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow):** Stalking from the darkness, the [shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow) is an expert assassin and thief who fights equally well in melee and at range as they get the drop on their foes. They utilize magic to help them stay mobile on the battlefield and sneak up on their prey.

**[Tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician):** A brilliant strategist and weapons master, the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician) excels at granting allies more movement and actions on the battlefield. They also support allies outside of combat, always inspiring their friends to greatness.

**[Talent](https://steelcompendium.io/v2/Browse/Rules/Classes/Talent):** A [talent](https://steelcompendium.io/v2/Browse/Rules/Classes/Talent) is the master of psionics, manifesting powers that manipulate objects, minds, and time. These heroes can reach far into themselves to use abilities even when they don't have their Heroic Resource to spare—if they're willing to face the cost.

**[Troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour):** A [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) inspires their allies with storytelling and swordplay that is as much an art as it is an act of war. Their quips, songs, poems, and epic tales produce actual magic that harms foes and bolsters allies. They can even use their magic to tweak the campaign's story in real time to better suit their needs.
...
- The [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor)'s wrath
- The [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit)'s piety
- The [elementalist](https://steelcompendium.io/v2/Browse/Rules/Classes/Elementalist)'s essence
- The [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury)'s ferocity
- The [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null)'s discipline
- The [shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow)'s insight
- The [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician)'s focus
- The [talent](https://steelcompendium.io/v2/Browse/Rules/Classes/Talent)'s clarity
- The [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour)'s drama
...
If an ability requires a triggered action or a free triggered action to use, a "Trigger" entry is part of the ability. For example, the trigger for the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician)'s Parry ability is: "A creature deals damage to the target." A [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician) can use their Parry ability only when that specific triggering event occurs.
...
An ability never has both the Melee and Ranged keywords at the same time. For example, if you have the [Cloak and Dagger](https://steelcompendium.io/v2/Browse/Rules/Kits/Cloak%20and%20Dagger) kit, which has a weapon damage bonus to melee abilities and a weapon damage bonus to ranged abilities, only one bonus at a time applies to an ability with both the Melee and Ranged keywords. (See [Chapter 6: Kits](#page-231-0).)
...
Using the [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury)'s Brutal Slam ability as an example again, that ability uses a Might power roll and features the following damage expressions in the three tier outcomes of the power roll:

- **≤11:** 3 + M damage
- **12-16:** 6 + M damage
- **17+:** 9 + M damage

For a [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury) with a Might of 2, the ability's damage breakdown would be:
...
As an example, consider the [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit)'s Judgment's Hammer ability, which has the following power roll:
...
At 1st level, a [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit) uses their Intuition score to determine their potency values, and that score is 2. That gives the [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit) the following potencies:

- Weak: 0
- Average: 1
- Strong: 2

When writing Judgment's Hammer on their character sheet, the [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit)'s player updates the damage and converts the weak, average, and strong potencies into their numerical values, knowing that those values won't change until the character hits 2nd echelon and their Intuition score becomes 3. That produces the following:

**Power Roll + Intuition:**

- **≤11:** 5 holy damage; A < 0, [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone)
- **12-16:** 8 holy damage; A < 1, [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone)
- **17+:** 11 holy damage; A < 2, [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) and can't stand (save ends)

During a game session, the [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit) uses Judgment's Hammer to target a bandit with an Agility score of 0. The ability thus has the following outcomes at each tier:
...
For example, the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician)'s Overwatch ability allows the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician) to spend 1 focus to impose the [slowed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Slowed) condition on a target who has R < AVERAGE. Since spending focus this way has no other effect, if the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician) targets a creature whose high Reason leaves them unaffected, the [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician) doesn't waste any focus. However, if spending this focus had another automatic effect such as dealing extra damage to the target, the 1 focus would be spent even though the potency was resisted.
...
A [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour)'s battle song, a [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury)'s building ferocity, and a [shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow)'s patient insight can all make a hero more effective in a fight. These advantages are represented by surges, with many abilities granting heroes surges during a battle.
...
If an ability's effect allows you to take a main action, a maneuver, a move action, or a triggered action, the cost of doing so is subsumed in the ability's type entry on the first line below the flavor text. You never need to spend additional time to use an ability. For example, the [shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow)'s Black Ash [Teleport](https://steelcompendium.io/v2/Browse/Rules/Movement/Teleport) ability is a maneuver that allows you to [teleport](https://steelcompendium.io/v2/Browse/Rules/Movement/Teleport) and then use the Hide maneuver as its overall effect. Using the Hide maneuver is part of the maneuver to use the ability, so that you don't need to have another maneuver available to do so.
...
For example, the [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null)'s [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability reduces the potencies of enemies within the field by 1. If two allied [nulls](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) each have their [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability active and an enemy cultist is targeted by both abilities, that cultist's potencies are reduced by 1, not by 2.

Different effects that impose the same condition (see [Conditions](#page-91-2) below) don't stack to impose the condition twice. For instance, if a hero is targeted by numerous creatures whose abilities cause a target to become [weakened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Weakened) (imposing a bane on the target's power rolls), the target isn't [weakened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Weakened) twice to impose a double bane on those rolls. A character who is [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) by an enemy can't be [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) again by another enemy. The same holds true for game effects that aren't conditions. For example, if a hero is targeted by multiple abilities or effects that can halve their recovery value, the hero's recovery value is halved only once.
...
When a creature is [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened), any ability roll they make against the source of their fear takes a bane. If that source is a creature, their ability rolls made against the [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened) creature gain an edge. A [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened) creature can't willingly move closer to the source of their fear if they know the location of that source. If a creature gains the [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened) condition from one source while already [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened) by a different source, the new condition replaces the old one.

##### Grabbed

A creature who is [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) has speed 0, can't be force moved except by a creature, object, or effect that has them [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed), can't use the Knockback maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)), and takes a bane on abilities that don't target the creature, object, or effect that has them [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed). If a creature is [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) by another creature and that creature moves, they bring the [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) creature with them. If a creature's size is equal to or less than the size of a creature they have [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed), their speed is halved while they have that creature [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed).

A creature who has another creature [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) can use a maneuver to move the [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) creature into an unoccupied space adjacent to them.

A creature can release a creature they have [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) at any time to end that condition (no action required). A [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) creature can attempt to escape being [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) using the Escape Grab maneuver (see [Chapter 10: Combat](#page-288-0)). If a [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) creature [teleports](https://steelcompendium.io/v2/Browse/Rules/Movement/Teleport), or if either the [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) creature or the creature grabbing them is force moved so that both creatures are not adjacent to each other, that creature is no longer [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed).
...
While a creature is [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone), they are flat on the ground, any strike they make takes a bane, and melee abilities used against them gain an edge. A [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) creature must [crawl](https://steelcompendium.io/v2/Browse/Rules/Movement/Crawl) to move along the ground, which costs 1 additional square of movement for every square crawled. A creature can't [climb](https://steelcompendium.io/v2/Browse/Rules/Movement/Climb%20or%20Swim), [jump](https://steelcompendium.io/v2/Browse/Rules/Movement/Jump), [swim](https://steelcompendium.io/v2/Browse/Rules/Movement/Climb%20or%20Swim), or [fly](https://steelcompendium.io/v2/Browse/Rules/Movement/Fly) while [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone). If they are [climbing](https://steelcompendium.io/v2/Browse/Rules/Movement/Climb%20or%20Swim), [flying](https://steelcompendium.io/v2/Browse/Rules/Movement/Fly), or [jumping](https://steelcompendium.io/v2/Browse/Rules/Movement/Jump) when knocked [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone), they fall.

Unless the ability or effect that imposed the [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) condition says otherwise, a [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) creature can stand up using the Stand Up maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)). A creature adjacent to a willing [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) creature can likewise use the Stand Up maneuver to make that creature stand up.
...
A creature who is [taunted](https://steelcompendium.io/v2/Browse/Rules/Conditions/Taunted) has a double bane on ability rolls for any ability that doesn't target the creature who [taunted](https://steelcompendium.io/v2/Browse/Rules/Conditions/Taunted) them, as long as they have line of effect to that creature. If a creature gains the [taunted](https://steelcompendium.io/v2/Browse/Rules/Conditions/Taunted) condition from one source while already [taunted](https://steelcompendium.io/v2/Browse/Rules/Conditions/Taunted) by a different source, the new condition replaces the old one.
...
For example a 6th-level [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor) has "Signature, 3, 5, 7, 9" in their Abilities column, and "5, 9" in their Order Abilities column (representing the [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor)'s subclass). This means a [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor) of that level has a signature ability and four heroic abilities costing 3, 5, 7, and 9 wrath respectively, plus an additional two subclass heroic abilities costing 5 and 9 wrath.
...
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------- | ------------------- |
| 1st   | [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Tradition, Discipline, [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field, Inertial Shield, Discipline Mastery, [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Speed, Psionic Augmentation, Psionic Martial Arts, [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Abilities | Two signature, 3, 5           | -                   |
...
| 4th   | Characteristic Increase, Discipline Mastery Improvement, Enhanced [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field, Perk, Regenerative Field, Skill                                                                                                                                                                                                   | Two signature, 3, 5, 7        | 5                   |
...
As a 3rd-level [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null), you gain the following features.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability increases by 1. While the area of that ability is enlarged this way, each enemy who has I < AVERAGE and enters the area for the first time in a combat round or starts their turn there is [bleeding](https://steelcompendium.io/v2/Browse/Rules/Conditions/Bleeding) (save ends). Each ally who enters the area for the first time in a combat round or starts their turn there gains temporary Stamina equal to your Intuition score.
...
> | **📏 Self** |  **🎯 Self** |
>
> **Effect:** Until the end of the encounter, the size of your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability increases by 1. While the area of that ability is enlarged this way, you ignore difficult terrain and reduce the potency of enemy effects targeting you by 1 for you. You can also use a free triggered action at the start of each of your turns to end one effect on you that is ended by a saving throw or that ends at the end of your turn. Each ally in the area also gains these benefits.
...
As a 4th-level [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null), you gain the following features.
...
While using your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability, you disrupt magic and psionic power suffusing the area around you. During combat, any temporary supernatural terrain effects of your level or lower are removed when your aura partially or fully overlaps with their location. Permanent supernatural terrain effects of your level or lower are temporarily negated while your aura overlaps with their location, but return when the aura no longer overlaps with them.
...
As a 5th-level [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null), you gain the following features.

#### 5th-Level Tradition Feature

Your [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) tradition grants you a feature, as shown on the 5th-Level Tradition Features table.
...
> **Power Roll + Agility:**
>
> - **≤11:** 10 + A damage; A < WEAK, [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed)
> - **12-16:** 14 + A damage; A < AVERAGE, [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed)
> - **17+:** 18 + A damage; A < STRONG, [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed)
>
> **Effect:** While [grabbed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Grabbed) this way, the target takes a bane on the Escape Grab maneuver. Each time they use that maneuver, they take damage equal to twice your Agility score.
...
> | **📏 Self** | **🎯 Self** |
>
> **Effect:** You [jump](https://steelcompendium.io/v2/Browse/Rules/Movement/Jump) up to your speed without provoking opportunity attacks. Until the end of your next turn, a static afterimage of you remains in the space you left, and any enemy adjacent to your afterimage takes a bane on ability rolls. You can use your abilities from your own space or from the space of your afterimage as if you were still there. Additionally, if your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability is active, your afterimage also projects the aura from that ability, which you control as if you were in the afterimage's space.
...
As a 10th-level [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null), you gain the following features.
...
Your body becomes perfected matter, beyond the whims and chaos of the timescape and the restrictions of the manifolds. Each time you finish a respite, you can shift yourself and any creatures in the area of your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability to any location in the timescape known to you, known to any other creature in the area, or where any supernatural treasure in the area has been before.

Whenever you use an ability, you gain 1 discipline that can be used only to apply a benefit from your Psi Boost feature to that ability. Additionally, you and allies in the area of your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field ability ignore banes and double banes on your power rolls.
...
At the start of a combat encounter, you can spend 1 order to increase the size of your [Null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) Field by 1 until the end of the encounter.
...
The whole world's a stage, and everyone on it, an actor. No one knows this better than the [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour). You find energy in the drama of everyday life and know how to draw spectacle forth from even the most mundane of situations. You accent highs and deepen lows in service to whoever might witness your performance.

**As a [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour), you chase drama. The insurmountable dangers of the world might cause many a hero to cower. But you take to that world stage not intending to die, but to find out if you are truly alive.**
...
| ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------- | ------------------- |
| 1st   | [Troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) Class Act, Drama, Kit, Scene Partner, Routines, Class Act Features, Class Act Triggered Action, [Troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) Abilities | Signature, 3, 5           | -                   |
...
As a 3rd-level [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour), you gain the following features.

#### 3rd-Level Class Act Feature

Your [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) class act grants you a feature, as shown on the 3rd-Level Class Act Features table.
...
> | **📏 5 aura**                | **🎯 Self and each ally in the area** |
>
> **Effect:** While this performance is active, each target who starts their turn dying while in the area gains an edge on power rolls and ignores the effects of [bleeding](https://steelcompendium.io/v2/Browse/Rules/Conditions/Bleeding) until the end of their turn.
...
As a 5th-level [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour), you gain the following features.

#### 5th-Level Class Act Feature

Your [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) class act grants your choice of one of two features.
...
Once on each of your turns, you can use a free maneuver to change one condition affecting a creature within distance of your Dramatic Monologue ability. Choose one of the following conditions on the target: [bleeding](https://steelcompendium.io/v2/Browse/Rules/Conditions/Bleeding), [frightened](https://steelcompendium.io/v2/Browse/Rules/Conditions/Frightened), [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone), [slowed](https://steelcompendium.io/v2/Browse/Rules/Conditions/Slowed), or [taunted](https://steelcompendium.io/v2/Browse/Rules/Conditions/Taunted). You change that condition to another of those conditions, maintaining the duration and origin of the original condition. A target who is no longer [prone](https://steelcompendium.io/v2/Browse/Rules/Conditions/Prone) can stand up.
...
As a 7th-level [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour), you gain the following features.
...
As an 8th-level [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour), you gain the following features.
...
Your [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour) class act grants you a feature, as shown on the 8th-Level Class Act Features table.
