...
Since you don't need to worry about your character covering a wide spread of skills, you're free to choose the skills you think fit your hero best and are the most fun to work with. Maybe you're thinking about an [elementalist](../Browse/Classes/Elementalist.md) who has a gymnastic [background](../Chapters/Background.md) in jumping and tumbling, and who also studied religion and blacksmithing. Having that kind of specific backstory is a big part of cinematic storytelling.
...
**James (playing Korvo, a [shadow](../Browse/Classes/Shadow.md)):** *Let's move to the side of the wall opposite the gate and make our ascent there.*

**Grace (playing Val, a [conduit](../Browse/Classes/Conduit.md)):** *Agreed.*
...
**Alyssa:** *Please. I'm a pro. Since I'm lifting this [polder](../Browse/Ancestries/Polder.md) off the ground, does the Lift skill apply?*

**Director:** *Yes, it does. Roll it up. That's a medium difficulty test.*

Lifting the diminutive [polder](../Browse/Ancestries/Polder.md), Alyssa rolls 2d10-but gets a 2! With her Might score and Lift skill bonus of +2, the total is 6.
...
**Grace:** *Ah, pull the [polder](../Browse/Ancestries/Polder.md) up.*
...
To [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) from a creature, you must have cover or concealment from that creature (see [Chapter 10: Combat](#page-288-0)), who can't observe you attempting to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md). A creature is observing you if they're aware of your specific location before you attempt to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md). This means they can pinpoint you with their senses and point a finger (or paw or tentacle) at you as if to shout, "There they are!" If you duck behind a barrel to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) from a foe, your attempt to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) has a chance of succeeding only if your foe doesn't notice you doing so. If you're being chased by a hungry dragon, you can [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) only if you first move to a location where the dragon can't observe you—for instance, by turning a sharp corner into a tunnel full of giant stalagmites before the dragon does. You then make your [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) attempt.

When you use the [Hide](../Browse/Abilities/Common/Maneuvers/Hide.md) maneuver to [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) during combat while you have cover or concealment from a creature who isn't observing you, you are automatically hidden from them unless the Director deems otherwise. If you [hide](../Browse/Abilities/Common/Maneuvers/Hide.md) outside of combat, the Director might ask you to make a test using the Hide skill to determine how well hidden you are.
...
Val, a [conduit](../Browse/Classes/Conduit.md), offers to scout ahead for the group with an Intuition test, using the Navigate skill to find the best path forward and avoid hazards such as chasms and quicksand. The Director thinks that acting as lookout in a vast desert is an easy task. Val smashes it with a 21-a success with a reward—and the Director decides to get creative. Val's lookout skills grant the next hero to act in the montage test an edge on their test. At the end of the first montage test round, the heroes have 3 successes and 1 failure.
...
Jorn, eager to prove himself after his last failure, asks to make a Might test using the Lead skill, representing tying a rope around his waist to drag his weaker friends over the tallest dunes. The Director likes the idea but doesn't think the Lead skill applies to the task. They tell Jorn that Lift is more appropriate, since the [tactician](../Browse/Classes/Tactician.md) is using his physical skill to aid his friends and not really doing anything interpersonal. Jorn agrees, and the Director sets the test at medium difficulty. Making the test with a bane because of his previous failure, the [tactician](../Browse/Classes/Tactician.md) rolls a 15, which is a success with a consequence. The montage test has 5 successes and 1 failure, but the consequence gives the Director another 2 Malice at the start of the next combat encounter.
...
Val attempts to recall lore about the Khem-hor, wanting to know if she can remember any of their travel from her studies of the history of the region. The Director has her make a hard Reason test with an edge, thanks to Karrel's input on the current state of Khem-hor culture. Val gets a 17, and the Director decides that the [conduit](../Browse/Classes/Conduit.md) recalls a shortcut through a canyon tunnel that leads directly to Ahset, avoiding a vast lake of quicksand. The heroes get their sixth success in the montage test, achieving total success, and earn 2 Victories.
