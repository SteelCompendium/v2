...
The knight in [shining armor](../Browse/Kits/Shining Armor.md#shining-armor). The [warrior priest](../Browse/Kits/Warrior Priest.md#warrior-priest). The [sniper](../Browse/Kits/Sniper.md#sniper). [Censors](../Browse/Classes/Censor.md#censor), [furies](../Browse/Classes/Fury.md#fury), [shadows](../Browse/Classes/Shadow.md#shadow), [tacticians](../Browse/Classes/Tactician.md#tactician), and [troubadours](../Browse/Classes/Troubadour.md#troubadour) can tap into these and many more archetypal concepts using kits. A kit is a combination of weapons, armor, and fighting techniques that lets you personalize your martial hero for battle.
...
When you find a supernatural treasure such as a magic sword, you can use the item as long as it's in one of your kit's equipment categories. A Blade of Quintessence is a medium weapon, so you can use it with the [Ranger](../Browse/Kits/Ranger.md#ranger) or [Shining Armor](../Browse/Kits/Shining Armor.md#shining-armor) kits. However, you can't use it with the [Cloak and Dagger](../Browse/Kits/Cloak and Dagger.md#cloak-and-dagger) or [Stick and Robe](../Browse/Kits/Stick and Robe.md#stick-and-robe) kits because those kits don't include medium weapons, meaning you haven't done the necessary preparations to use the weapon effectively. You can still swing a Blade of Quintessence around as an improvised weapon, but you don't get any of its bonuses or benefits.
...
A kit can grant a bonus to your Stamina, speed, and [stability](../Browse/Movement/Stability.md#stability), as well as the damage and distance of your weapon abilities, including your [free strikes](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike). ([Abilities](#page-83-0) in [Chapter 5: Classes](#page-83-2) has information on abilities, ability keywords, and more.)
...
Your kit's [stability](../Browse/Movement/Stability.md#stability) bonus is added to your [stability](../Browse/Movement/Stability.md#stability).
...
For example, the [Shining Armor](../Browse/Kits/Shining Armor.md#shining-armor) kit has a +2/+2/+2 melee damage bonus, increasing the damage of melee weapon abilities across all tier outcomes. The [Sniper](../Browse/Kits/Sniper.md#sniper) kit has a +0/+0/+4 ranged damage bonus, having no effect on a tier 1 or tier 2 outcome on an ability roll, but increasing the damage of tier 3 outcomes by +4 for your ranged weapon abilities.
...
A kit that has a [disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) bonus increases the number of squares you can shift when you take the [Disengage](../Browse/Abilities/Common/Move Actions/Disengage.md#disengage) move action (see [Chapter 10: Combat](#page-288-0)).

### Kit Signature Ability

Each kit grants a signature ability, **whose distance and damage already includes the kit's bonuses**. For instance, the [Guisarmier](../Browse/Kits/Guisarmier.md#guisarmier) kit's Forward Thrust, Backward Smash ability has a distance of melee 2 and deals 4, 7, or 9 damage depending on the tier outcome, with that distance and damage including the bonuses from the kit.
...
>
> Improvised weapons can be used with weapon abilities you gain from your class. For instance, many melee-focused heroes choose a kit that maximizes their melee capabilities, then make ranged [free strikes](../Browse/Abilities/Common/Main Actions/Free Strike.md#free-strike) with improvised weapons. However, you can't use improvised weapons with weapon abilities gained from your kit, and you add no special bonuses from your kit to a weapon ability used with an improvised weapon.

#### Arcane Archer

The [Arcane Archer](../Browse/Kits/Arcane Archer.md#arcane-archer) kit allows you to combine magic and ranged weapon strikes. Your lack of armor keeps you mobile, and your magic makes your arrows explode to devastate your foes.
...
Who says lightly armored heroes can't also be hard to move? You just need to employ some psionics! The [Battlemind](../Browse/Kits/Battlemind.md#battlemind) kit harnesses the power of your mind to make you harder to move—and to make your foes easier to push around.
...
Providing throwable light weapons and light armor easily concealed by a cloak to confuse your enemies, the [Cloak and Dagger](../Browse/Kits/Cloak and Dagger.md#cloak-and-dagger) kit makes you more mobile while increasing the effectiveness of your short-range strikes.
...
The [Dual Wielder](../Browse/Kits/Dual Wielder.md#dual-wielder) kit is for folks who want to excel at using two weapons at the same time. Your fighting style maximizes the power of each weapon you have in hand, making you a whirling dealer of death.
...
The [Guisarmier](../Browse/Kits/Guisarmier.md#guisarmier) kit is for those who want to use a polearm for extended reach while remaining protected by sturdy armor. This is the kit that allows you to become the ultimate halberd, longspear, or glaive fighter.
...
If you want to be fast in a fight, then [Martial Artist](../Browse/Kits/Martial Artist.md#martial-artist) is the kit for you. Unencumbered by weapons or armor, this fighting style rewards quick, focused unarmed strikes against opponents, and allows you to be the ultimate skirmisher.
...
The [Mountain](../Browse/Kits/Mountain.md#mountain) kit does exactly what it says on the tin. You don heavy armor and raise a heavy weapon to stand strong against your foes, quickly demolishing them when it's your turn to strike.
...
If you want a good balance of protection, speed, and damage, the [Panther](../Browse/Kits/Panther.md#panther) kit is for you. This kit increases your Stamina not by wearing armor, but through the focused battle preparation of body and mind, letting you be fast and mobile while swinging a heavy weapon at your foes.
...
Meant for brawlers and boxers, the [Pugilist](../Browse/Kits/Pugilist.md#pugilist) kit gives you access to a melee fighting style that grants a boost to Stamina and damage while allowing you to float like a butterfly. If you want to be a tough, strong hero who doles out punishment with your fists, then this kit is for you.
...
The [Raider](../Browse/Kits/Raider.md#raider) kit keeps you protected while granting you full mobility, providing a boost to speed and distance that lets you run around the battlefield like a Viking warrior.
...
The [Ranger](../Browse/Kits/Ranger.md#ranger) kit outfits you with medium armor and weapons for every challenge, letting you easily switch between melee and ranged combat. This kit provides a good balance of bonuses to defense and offense to create a hero who is a jack-of-all-trades.
...
- **≤11:** 3 + M or A damage; A < WEAK, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
- **12-16:** 5 + M or A damage; A < AVERAGE, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
- **17+:** 7 + M or A damage; A < STRONG, [slowed](../Browse/Conditions/Slowed.md#slowed) (save ends)
...
The [retiarius](../Browse/Kits/Retiarius.md#retiarius) is often depicted as a lightly armored warrior with a net in one hand and a trident in the other, and this kit gives you the equipment and fighting technique to make that happen. Tie up your foe with a net and then poke them to death!
...
- **≤11:** 4 + M or A damage; A < WEAK, [slowed](../Browse/Conditions/Slowed.md#slowed) (EoT)
- **12-16:** 6 + M or A damage; A < AVERAGE, [slowed](../Browse/Conditions/Slowed.md#slowed) (EoT)
- **17+:** 8 + M or A damage; A < STRONG, [restrained](../Browse/Conditions/Restrained.md#restrained) (EoT)

#### Shining Armor

The [Shining Armor](../Browse/Kits/Shining Armor.md#shining-armor) kit provides the most protection a kit can afford, providing you with the sword, shield, and armor necessary to play the prototypical knight.
...
**Effect:** The target is [taunted](../Browse/Conditions/Taunted.md#taunted) until the end of their next turn.

#### Sniper

The [Sniper](../Browse/Kits/Sniper.md#sniper) kit gives you the tools and techniques to take down enemies from afar. This kit can help you become the archer who lurks behind trees or down tunnels, picking off enemies with a bow or crossbow as they approach.
...
The [Spellsword](../Browse/Kits/Spellsword.md#spellsword) kit combines melee strikes and a little bit of magic, letting you create a warrior who doesn't have to choose between the incantation and the blade.
...
Armed with a simple reach weapon, often a quarterstaff, a character using the [Stick and Robe](../Browse/Kits/Stick and Robe.md#stick-and-robe) kit is highly mobile thanks to their light armor. This allows your hero to make maximum use of their weapon's length.
...
If you want to be mobile and deal a lot of damage with melee strikes, then you should reach for the [Swashbuckler](../Browse/Kits/Swashbuckler.md#swashbuckler) kit. This is a great kit for heroes who want to be master duelists.
...
- **17+:** 9 + M or A damage; push 3; M < STRONG, [prone](../Browse/Conditions/Prone.md#prone)

#### Warrior Priest

The [Warrior Priest](../Browse/Kits/Warrior Priest.md#warrior-priest) kit imbues the power of the gods into your weapon, making it a smiting instrument. You wade into the fray without fear, thanks to the power of the divine... and the heavy armor you wear.
...
The [Whirlwind](../Browse/Kits/Whirlwind.md#whirlwind) kit makes effective use of whips, granting you mobility, damage, and reach. If you want to be a fast-moving warrior who lashes foes with a chain or whip, then this is the kit for you.
...
- **≤11:** 4 + M or A damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 1
- **12-16:** 7 + M or A damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 2
- **17+:** 10 + M or A damage; [vertical](../Browse/Movement/Vertical.md#vertical) pull 3
