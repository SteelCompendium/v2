...
A kit that has a [disengage](../../Browse/Abilities/Common/Move%20Actions/Disengage) bonus increases the number of squares you can shift when you take the [Disengage](../../Browse/Abilities/Common/Move%20Actions/Disengage) move action (see [Chapter 10: Combat](#page-288-0)).
...
| Kit                                                                               | Armor          | Weapon             | Stamina per Echelon | Speed | [Stability](../../Browse/Movement/Stability) | Melee Damage | Ranged Damage | Melee Distance | Ranged Distance | [Disengage](../../Browse/Abilities/Common/Move%20Actions/Disengage) |
| --------------------------------------------------------------------------------- | -------------- | ------------------ | ------------------- | ----- | ------------------------------------------------------------------- | ------------ | ------------- | -------------- | --------------- | ------------------------------------------------------------------------------------------ |
