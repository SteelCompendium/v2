...
**Effect:** Only a beastheart's companion or an animal can wear this item. While wearing it, the creature grows feathered wings if they don't already have wings and can [fly](../../Browse/movement/fly.md). If the creature can already fly, they gain a +3 bonus to their speed while flying.
...
**1st Level:** Only a beastheart can wear this armor. While you wear this armor, you gain a +6 bonus to Stamina and a +1 bonus to stability. The first time on a turn that you or your companion would move into a creature's space, whoever is moving can push that creature 1 square before continuing their movement. This [forced movement](../../Browse/movement/forced-movement.md) ignores stability if the creature's stability is lower than the pusher's stability.

**5th Level:** The armor's bonus to Stamina increases to +12, and its bonus to stability increases to +2. Additionally, when a creature is [force moved](../../Browse/movement/forced-movement.md) into you or your companion, whoever was collided with takes no damage.
...
**5th Level:** The shield's bonus to Stamina increases to +6. Additionally, your companion can use 2 squares of movement to [teleport](../../Browse/movement/teleport.md) from their current location and leap out of the shield, landing in a space adjacent to you.
...
**1st Level:** Only a beastheart can wear this armor. While you wear this armor, you gain a +6 bonus to Stamina, and when a creature starts their turn either [grabbed](../../Browse/condition/grabbed.md) by or grabbing you or your companion, they are [bleeding](../../Browse/condition/bleeding.md) until the end of their next turn.
...
**9th Level:** The armor's bonus to Stamina increases to +21, and whenever you or your companion pulls a creature with thorned vines using the armor, the target also takes 5 damage and is [grabbed](../../Browse/condition/grabbed.md) by whoever force moved them.
...
**5th Level:** The weapon's extra damage increases to 2. Additionally, whenever you or your companion uses the Charge main action and obtains a tier 3 outcome with an ability, whoever used the action can either knock the target [prone](../../Browse/condition/prone.md), push them 2 squares or increase the distance of a push made as part of the charge, or deal extra damage equal to their own Might score.
...
**5th Level:** The weapon's extra damage increases to 2. Additionally, whenever you or your companion grabs a creature or a creature grabs either of you, the creature is [bleeding](../../Browse/condition/bleeding.md) (save ends).
