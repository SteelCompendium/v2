...
**Skills:** You gain the [Animal Handling](../../Browse/skill/handle-animals.md) skill. Then choose any two skills from the exploration or intrigue skill groups. (*Quick Build:* [Animal Handling](../../Browse/skill/handle-animals.md), [Navigate](../../Browse/skill/navigate.md), [Track](../../Browse/skill/track.md).)
