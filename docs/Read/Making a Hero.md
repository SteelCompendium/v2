...
- The Director should tell the players if any options are limited or rare in their campaign. For example, some Directors don't want psionics to appear in their game worlds, so they might decide that heroes can't be [nulls](https://steelcompendium.io/v2/Browse/Rules/Classes/Null) or [talents](https://steelcompendium.io/v2/Browse/Rules/Classes/Talent). Another campaign might be grounded in more typical medieval fantasy and not have any [memonek](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Memonek) or [time raiders](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Time%20Raider), or those [ancestries](https://steelcompendium.io/v2/Browse/Rules/Chapters/Ancestries) might be exceedingly rare. In the latter case, players should know that their [memonek](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Memonek) or [time raider](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Time%20Raider) heroes are likely to get a lot of questions from curious NPCs.
...
Choose your hero's humanoid ancestry from among the range of [ancestries](https://steelcompendium.io/v2/Browse/Rules/Chapters/Ancestries) available in the game—[devil](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Devil), [dragon knight](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Dragon%20Knight), [dwarf](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Dwarf), [wode elf](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Wode%20Elf), [high elf](https://steelcompendium.io/v2/Browse/Rules/Ancestries/High%20Elf), [hakaan](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Hakaan), [human](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Human), [memonek](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Memonek), [orc](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Orc), [polder](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Polder), [revenant](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Revenant), or [time raider](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Time%20Raider). Future supplements will introduce additional [ancestries](https://steelcompendium.io/v2/Browse/Rules/Chapters/Ancestries) you can choose from. See [Chapter 3: Ancestries](#page-35-0) for more information.
...
Choose your hero's class. This choice has the biggest impact on how your hero interacts with the rules of the game, particularly the rules for combat. Your class provides your starting characteristic scores that determine your character's physical and mental acumen, as well as the Stamina and Recoveries that determine your physical hardiness. A class also provides your character with skills, several abilities—the unique features that define what your hero can do—and other features and benefits. You can be a [censor](https://steelcompendium.io/v2/Browse/Rules/Classes/Censor), [conduit](https://steelcompendium.io/v2/Browse/Rules/Classes/Conduit), [elementalist](https://steelcompendium.io/v2/Browse/Rules/Classes/Elementalist), [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury), [null](https://steelcompendium.io/v2/Browse/Rules/Classes/Null), [shadow](https://steelcompendium.io/v2/Browse/Rules/Classes/Shadow), [tactician](https://steelcompendium.io/v2/Browse/Rules/Classes/Tactician), [talent](https://steelcompendium.io/v2/Browse/Rules/Classes/Talent), or [troubadour](https://steelcompendium.io/v2/Browse/Rules/Classes/Troubadour). See Chapter 5: [Classes](https://steelcompendium.io/v2/Browse/Rules/Chapters/Classes) for more information on each class, as well as the different types of abilities—signature abilities, heroic abilities, and more—that heroes of a specific class have access to.
...
You can also make free strikes on your turn to represent using weapons your hero isn't otherwise themed to use. A [wode elf](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Wode%20Elf) master archer can stab a too-close enemy with a dagger as a free strike, and a greataxe-wielding [orc](https://steelcompendium.io/v2/Browse/Rules/Ancestries/Orc) [fury](https://steelcompendium.io/v2/Browse/Rules/Classes/Fury) can use a free strike to hurl a handaxe at a [flying](https://steelcompendium.io/v2/Browse/Rules/Movement/Fly) enemy staying annoyingly out of melee range.

See Free Strikes in Chapter 10: Combat for more information on using free strikes, and see Abilities in Chapter 5: [Classes](https://steelcompendium.io/v2/Browse/Rules/Chapters/Classes) for information on the ability format and how to read it.
...
Your character's heroic advancement is marked by level. Each time you gain a new level in your class, your Stamina increases, and you gain new features or abilities according to your class's advancement, as detailed in Chapter 5: [Classes](https://steelcompendium.io/v2/Browse/Rules/Chapters/Classes).
