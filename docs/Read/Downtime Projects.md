...
If you want events to be a surprise for you as much as for the other players, then once during any respite when one or more heroes makes a project roll, roll a d6. On a 6, an event occurs. This is a good option if you enjoy coming up with story on the [fly](../../Browse/Movement/Fly) during play.
...
| 9   | Before the roll, the proposed road touches on a supernatural intersection—a crossing place between multiple worlds that draws interest from a powerful [devil](../../Browse/Ancestries/Devil). The completion of the project becomes the personal interest of this being, who offers to increase progress—but demands a future favor from the hero. If the deal is accepted, each project roll for the project is doubled until its completion. |
...
**Nettlebloom:** Whenever you are [grabbed](../../Browse/Conditions/Grabbed) by an adjacent creature, your armor sprouts toxic nettles. While that creature has you [grabbed](../../Browse/Conditions/Grabbed), they are [weakened](../../Browse/Conditions/Weakened).
...
**Levitating:** On your turn, you can treat up to 5 consecutive squares of movement as [flying](../../Browse/Movement/Fly) movement. If you are still in midair at the end of your turn, you fall [prone](../../Browse/Conditions/Prone).
...
**Devil's Bargain:** You can [fly](../../Browse/Movement/Fly). Additionally, if an effect would make you [prone](../../Browse/Conditions/Prone) while [flying](../../Browse/Movement/Fly), you can choose to not go [prone](../../Browse/Conditions/Prone) by losing Stamina equal to the distance you would have fallen from becoming [prone](../../Browse/Conditions/Prone).
...
**Leyline Walker:** Once per turn as a move action, you can spend any amount of your movement to instead [teleport](../../Browse/Movement/Teleport) that distance.
...
On your turn, you can [teleport](../../Browse/Movement/Teleport) to the imprint's space as a free maneuver. When you are targeted by an ability, you can use a free triggered action to [teleport](../../Browse/Movement/Teleport) to your imprint, and the power roll for the ability is an automatic tier 1 result.

**Unbending:** You can't be subjected to forced movement unless you choose to be. Effects that ignore [Stability](../../Browse/Movement/Stability) also ignore this enhancement.
...
**Displacing I:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, you can [teleport](../../Browse/Movement/Teleport) that creature up to 2 squares after the ability's effects resolve. If the creature started on a horizontal surface, they must end on a horizontal surface.
...
**Rat Form:** As a maneuver, you transform into a rat. Your equipment transforms with you. As a rat, you have speed 5 and can automatically [climb](../../Browse/Movement/Climb%20or%20Swim) at full speed while moving, your size is 1T, and you can see in the dark. You can speak and keep your skills while in rat form, but your Might is −5 and you lose all your regular abilities, features, and benefits. You can revert to your natural form as a maneuver, and do so automatically if you take any damage.
...
**Celerity:** Immediately after using a magic or psionic ability that requires a main action, you can shift up to 3 squares, or you can use the [Escape Grab](../../Browse/Abilities/Common/Maneuvers/Escape%20Grab) maneuver as a free maneuver (see [Maneuvers](#page-287-0) in [Chapter 10: Combat](#page-288-0)).

**Celestine:** As a main action, you conjure up to three stars, which [hover](../../Browse/Movement/Hover) in unoccupied squares of your choice within 5 squares of you. The stars remain in place, and disappear if you create more stars. When an enemy enters any star's space, the star detonates and is destroyed, and the enemy takes 10 fire damage. If you have line of effect to the enemy, you can also slide them 1 square. Otherwise, the enemy slides 1 square in a random direction.

**Displacing II:** When you use the implement's Displacing I enhancement, you can [teleport](../../Browse/Movement/Teleport) the creature up to 4 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.
...
**Anathema:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, that creature is also [weakened](../../Browse/Conditions/Weakened) (save ends). If the creature is within 10 squares when this [weakened](../../Browse/Conditions/Weakened) effect ends, you can use a free triggered action to make a [free strike](../../Browse/Abilities/Common/Main%20Actions/Free%20Strike) against them.

**Displacing III:** When you use the implement's Displacing I enhancement, you can [teleport](../../Browse/Movement/Teleport) the creature up to 5 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.

**Erupting II:** The fire damage dealt by the implement's Erupting I enhancement increases to 6.

**Forceful III:** Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares and that movement can be [vertical](../../Browse/Movement/Vertical). This replaces the benefit of Forceful II.
...
>
> **Chilling II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 cold damage and is [slowed](../../Browse/Conditions/Slowed) (save ends). This replaces the benefit of Chilling I.
>
...
>
> **Terrifying II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 4 psychic damage and is [frightened](../../Browse/Conditions/Frightened) (save ends). This replaces the benefit of Terrifying I.
>
> **Thundering II:** Whenever you deal rolled damage to a creature using this weapon, you can push that creature up to 3 squares after the other effects of the ability resolve. If you obtained a tier 3 outcome, the creature is also knocked [prone](../../Browse/Conditions/Prone) after being pushed. This replaces the benefit of Thundering I.
>
...
**Chilling III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 9 cold damage and is [slowed](../../Browse/Conditions/Slowed) (save ends). This replaces the benefit of Chilling II.

**Disrupting III:** Whenever you damage an undead using this weapon and leave that undead with 50 Stamina or less, they immediately drop to 0 Stamina. If you instead leave the undead with 100 Stamina or less, they are [frightened](../../Browse/Conditions/Frightened) (save ends). This replaces the benefit of Disrupting II.

**Draining:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [weakened](../../Browse/Conditions/Weakened) (save ends). Each time you weaken a creature with this weapon, you gain 1 surge.

**Imprisoning:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [restrained](../../Browse/Conditions/Restrained) (save ends). While [restrained](../../Browse/Conditions/Restrained) in this way, the creature can't use magic or psionic abilities.
...
> - **17+:** 16 fire damage
>
> **Terrifying III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 psychic damage and is [frightened](../../Browse/Conditions/Frightened) (save ends). This replaces the benefit of Terrifying II.
>
> **Thundering III:** Whenever you deal rolled damage to a creature using this weapon, you can [vertical](../../Browse/Movement/Vertical) push that creature up to 5 squares and knock them [prone](../../Browse/Conditions/Prone) after the other effects of the ability resolve. If the creature takes or deals damage as a result of this movement, they also take 5 thunder damage. This replaces the benefit of Thundering II.
>
...
>
> **Windcutting:** Whenever you use a melee signature ability that usually targets one creature, you can take a bane on the ability to target each enemy in a cube 3 within distance. If your signature ability would usually cause its target to become [grabbed](../../Browse/Conditions/Grabbed) or [restrained](../../Browse/Conditions/Restrained), each target in the area is instead [slowed](../../Browse/Conditions/Slowed) until the end of their next turn.
...
| Vengeance III  | The true name of a [devil](../../Browse/Ancestries/Devil) who hunts other [devils](../../Browse/Ancestries/Devil) | Kalliak                 |
...
| 29-30  | After the roll, the project draws the attention of a [devil](../../Browse/Ancestries/Devil), who tries to subtly change the project source from the Seven Cities of Hell. If the hero doesn't notice, the [devil](../../Browse/Ancestries/Devil) is summoned the next time the hero makes a project roll, with goals of the Director's determination.                                                                                                             |
...
| 65-66  | After the roll, a physical project source or a component of the project creates an unstable portal to another world related to the nature of the project. Tiny [devils](../../Browse/Ancestries/Devil), elementals, or other creatures start clawing their way out of the item and causing mischief.                                                                                                                                                                                     |
...
| 7   | After the roll, a saint blesses the hero's work. The hero feels supernaturally rejuvenated, increasing their Recoveries by 1 until the end of their next respite. If the character is a [conduit](../../Browse/Classes/Conduit), they also gain an automatic breakthrough on the project.                                                                                                                 |
...
| 2   | While fishing, the hero reels in a note in a bottle. The note is written in Anjali and binds the reader into a deal with a powerful [devil](../../Browse/Ancestries/Devil) if read out loud. This gives the [devil](../../Browse/Ancestries/Devil) ownership of the reader's soul in exchange for rolling an additional d10 on all future Fishing project rolls.                                                                                                                                                                                                                                                                                                                                                                        |
...
| 10  | While fishing, the hero notes what appears to be an underwater cavern. If the cavern is explored, it reveals a treasure of the Director's choice guarded by a [revenant](../../Browse/Ancestries/Revenant) knight fulfilling their duty until their captain returns.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
