...
**Nettlebloom:** Whenever you are [grabbed](../Browse/Conditions/Grabbed.md#grabbed) by an adjacent creature, your armor sprouts toxic nettles. While that creature has you [grabbed](../Browse/Conditions/Grabbed.md#grabbed), they are [weakened](../Browse/Conditions/Weakened.md#weakened).
...
**Levitating:** On your turn, you can treat up to 5 consecutive squares of movement as [flying](../Browse/Movement/Fly.md#fly) movement. If you are still in midair at the end of your turn, you fall [prone](../Browse/Conditions/Prone.md#prone).
...
**Devil's Bargain:** You can [fly](../Browse/Movement/Fly.md#fly). Additionally, if an effect would make you [prone](../Browse/Conditions/Prone.md#prone) while [flying](../Browse/Movement/Fly.md#fly), you can choose to not go [prone](../Browse/Conditions/Prone.md#prone) by losing Stamina equal to the distance you would have fallen from becoming [prone](../Browse/Conditions/Prone.md#prone).
...
**Leyline Walker:** Once per turn as a move action, you can spend any amount of your movement to instead [teleport](../Browse/Movement/Teleport.md#teleport) that distance.
...
**Displacing I:** Whenever you damage a creature using a magic or psionic ability and obtain a tier 3 outcome, you can [teleport](../Browse/Movement/Teleport.md#teleport) that creature up to 2 squares after the ability's effects resolve. If the creature started on a horizontal surface, they must end on a horizontal surface.
...
**Displacing II:** When you use the implement's Displacing I enhancement, you can [teleport](../Browse/Movement/Teleport.md#teleport) the creature up to 4 squares. Additionally, the creature takes a bane on their next power roll made before the end of their next turn.
...
**Forceful III:** Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares and that movement can be [vertical](../Browse/Movement/Vertical.md#vertical). This replaces the benefit of Forceful II.
...
**Wingbane:** Whenever you damage a [flying](../Browse/Movement/Fly.md#fly) creature using this weapon, that creature is also [bleeding](../Browse/Conditions/Bleeding.md#bleeding) (save ends). While [bleeding](../Browse/Conditions/Bleeding.md#bleeding) in this way, the creature takes 1 damage per square they [fly](../Browse/Movement/Fly.md#fly). If the creature starts and ends their turn on the same solid surface, the [bleeding](../Browse/Conditions/Bleeding.md#bleeding) condition ends.

###### 1st-Level Weapon Enhancements Table

| Enhancement   | Item Prerequisite                                                            | Project Source Language |
| ------------- | ---------------------------------------------------------------------------- | ----------------------- |
| Blood Bargain | The blood of a [devil](../Browse/Ancestries/Devil.md#devil) | Anjali                  |
...
>
> **Terrifying II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 4 psychic damage and is [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends). This replaces the benefit of Terrifying I.
>
> **Thundering II:** Whenever you deal rolled damage to a creature using this weapon, you can push that creature up to 3 squares after the other effects of the ability resolve. If you obtained a tier 3 outcome, the creature is also knocked [prone](../Browse/Conditions/Prone.md#prone) after being pushed. This replaces the benefit of Thundering I.
>
...
> - **17+:** 16 fire damage
>
> **Terrifying III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 psychic damage and is [frightened](../Browse/Conditions/Frightened.md#frightened) (save ends). This replaces the benefit of Terrifying II.
>
> **Thundering III:** Whenever you deal rolled damage to a creature using this weapon, you can [vertical](../Browse/Movement/Vertical.md#vertical) push that creature up to 5 squares and knock them [prone](../Browse/Conditions/Prone.md#prone) after the other effects of the ability resolve. If the creature takes or deals damage as a result of this movement, they also take 5 thunder damage. This replaces the benefit of Thundering II.
>
...
| Vengeance III  | The true name of a [devil](../Browse/Ancestries/Devil.md#devil) who hunts other [devils](../Browse/Ancestries/Devil.md#devil) | Kalliak                 |
...
| 29-30  | After the roll, the project draws the attention of a [devil](../Browse/Ancestries/Devil.md#devil), who tries to subtly change the project source from the Seven Cities of Hell. If the hero doesn't notice, the [devil](../Browse/Ancestries/Devil.md#devil) is summoned the next time the hero makes a project roll, with goals of the Director's determination.                                                                                                             |
...
| 65-66  | After the roll, a physical project source or a component of the project creates an unstable portal to another world related to the nature of the project. Tiny [devils](../Browse/Ancestries/Devil.md#devil), elementals, or other creatures start clawing their way out of the item and causing mischief.                                                                                                                                                                                     |
...
| 2   | While fishing, the hero reels in a note in a bottle. The note is written in Anjali and binds the reader into a deal with a powerful [devil](../Browse/Ancestries/Devil.md#devil) if read out loud. This gives the [devil](../Browse/Ancestries/Devil.md#devil) ownership of the reader's soul in exchange for rolling an additional d10 on all future Fishing project rolls.                                                                                                                                                                                                                                                                                                                                                                        |
...
| 10  | While fishing, the hero notes what appears to be an underwater cavern. If the cavern is explored, it reveals a treasure of the Director's choice guarded by a [revenant](../Browse/Ancestries/Revenant.md#revenant) knight fulfilling their duty until their captain returns.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
