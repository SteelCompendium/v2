...
| 9   | Before the roll, the proposed road touches on a supernatural intersection—a crossing place between multiple worlds that draws interest from a powerful [devil](../Browse/Ancestries/Devil.md). The completion of the project becomes the personal interest of this being, who offers to increase progress—but demands a future favor from the hero. If the deal is accepted, each project roll for the project is doubled until its completion. |
...
**Nettlebloom:** Whenever you are [grabbed](../Browse/Conditions/Grabbed.md) by an adjacent creature, your armor sprouts toxic nettles. While that creature has you [grabbed](../Browse/Conditions/Grabbed.md), they are [weakened](../Browse/Conditions/Weakened.md).
...
**Levitating:** On your turn, you can treat up to 5 consecutive squares of movement as [flying](../Browse/Movement/Fly.md) movement. If you are still in midair at the end of your turn, you fall [prone](../Browse/Conditions/Prone.md).
...
**Devil's Bargain:** You can [fly](../Browse/Movement/Fly.md). Additionally, if an effect would make you [prone](../Browse/Conditions/Prone.md) while [flying](../Browse/Movement/Fly.md), you can choose to not go [prone](../Browse/Conditions/Prone.md) by losing Stamina equal to the distance you would have fallen from becoming [prone](../Browse/Conditions/Prone.md).
...
On your turn, you can [teleport](../Browse/Movement/Teleport.md) to the imprint's space as a free maneuver. When you are targeted by an ability, you can use a free triggered action to [teleport](../Browse/Movement/Teleport.md) to your imprint, and the power roll for the ability is an automatic tier 1 result.

**Unbending:** You can't be subjected to forced movement unless you choose to be. Effects that ignore [Stability](../Browse/Movement/Stability.md) also ignore this enhancement.
...
An implement imbued with an enhancement grants you special benefits while it is wielded. Additionally, when an implement receives its 1st-level enhancement, it grants your magic or psionic abilities that deal rolled damage a +1 damage bonus. A 5th-level enhancement increases the bonus to +2, and a 9th-level enhancement increases it to +3. [Censors](../Browse/Classes/Censor.md), [conduits](../Browse/Classes/Conduit.md), [elementalists](../Browse/Classes/Elementalist.md), [nulls](../Browse/Classes/Null.md), [talents](../Browse/Classes/Talent.md), and [troubadours](../Browse/Classes/Troubadour.md) benefit from using implements more than the other [classes](../Chapters/Classes.md) in this book.
...
**Forceful III:** Whenever you use a magic or psionic ability to push or pull a creature, you can move that creature an additional 3 squares and that movement can be [vertical](../Browse/Movement/Vertical.md). This replaces the benefit of Forceful II.
...
>
> **Chilling II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 cold damage and is [slowed](../Browse/Conditions/Slowed.md) (save ends). This replaces the benefit of Chilling I.
>
...
>
> **Terrifying II:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 4 psychic damage and is [frightened](../Browse/Conditions/Frightened.md) (save ends). This replaces the benefit of Terrifying I.
>
> **Thundering II:** Whenever you deal rolled damage to a creature using this weapon, you can push that creature up to 3 squares after the other effects of the ability resolve. If you obtained a tier 3 outcome, the creature is also knocked [prone](../Browse/Conditions/Prone.md) after being pushed. This replaces the benefit of Thundering I.
>
...
**Chilling III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 9 cold damage and is [slowed](../Browse/Conditions/Slowed.md) (save ends). This replaces the benefit of Chilling II.

**Disrupting III:** Whenever you damage an undead using this weapon and leave that undead with 50 Stamina or less, they immediately drop to 0 Stamina. If you instead leave the undead with 100 Stamina or less, they are [frightened](../Browse/Conditions/Frightened.md) (save ends). This replaces the benefit of Disrupting II.

**Draining:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [weakened](../Browse/Conditions/Weakened.md) (save ends). Each time you weaken a creature with this weapon, you gain 1 surge.

**Imprisoning:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature is also [restrained](../Browse/Conditions/Restrained.md) (save ends). While [restrained](../Browse/Conditions/Restrained.md) in this way, the creature can't use magic or psionic abilities.
...
> - **17+:** 16 fire damage
>
> **Terrifying III:** Whenever you damage a creature with an ability using this weapon and obtain a tier 3 outcome, that creature takes 6 psychic damage and is [frightened](../Browse/Conditions/Frightened.md) (save ends). This replaces the benefit of Terrifying II.
>
> **Thundering III:** Whenever you deal rolled damage to a creature using this weapon, you can [vertical](../Browse/Movement/Vertical.md) push that creature up to 5 squares and knock them [prone](../Browse/Conditions/Prone.md) after the other effects of the ability resolve. If the creature takes or deals damage as a result of this movement, they also take 5 thunder damage. This replaces the benefit of Thundering II.
>
...
>
> **Windcutting:** Whenever you use a melee signature ability that usually targets one creature, you can take a bane on the ability to target each enemy in a cube 3 within distance. If your signature ability would usually cause its target to become [grabbed](../Browse/Conditions/Grabbed.md) or [restrained](../Browse/Conditions/Restrained.md), each target in the area is instead [slowed](../Browse/Conditions/Slowed.md) until the end of their next turn.
...
| Vengeance III  | The true name of a [devil](../Browse/Ancestries/Devil.md) who hunts other [devils](../Browse/Ancestries/Devil.md) | Kalliak                 |
...
| 29-30  | After the roll, the project draws the attention of a [devil](../Browse/Ancestries/Devil.md), who tries to subtly change the project source from the Seven Cities of Hell. If the hero doesn't notice, the [devil](../Browse/Ancestries/Devil.md) is summoned the next time the hero makes a project roll, with goals of the Director's determination.                                                                                                             |
...
| 65-66  | After the roll, a physical project source or a component of the project creates an unstable portal to another world related to the nature of the project. Tiny [devils](../Browse/Ancestries/Devil.md), elementals, or other creatures start clawing their way out of the item and causing mischief.                                                                                                                                                                                     |
...
| 7   | After the roll, a saint blesses the hero's work. The hero feels supernaturally rejuvenated, increasing their Recoveries by 1 until the end of their next respite. If the character is a [conduit](../Browse/Classes/Conduit.md), they also gain an automatic breakthrough on the project.                                                                                                                 |
...
| 2   | While fishing, the hero reels in a note in a bottle. The note is written in Anjali and binds the reader into a deal with a powerful [devil](../Browse/Ancestries/Devil.md) if read out loud. This gives the [devil](../Browse/Ancestries/Devil.md) ownership of the reader's soul in exchange for rolling an additional d10 on all future Fishing project rolls.                                                                                                                                                                                                                                                                                                                                                                        |
...
| 10  | While fishing, the hero notes what appears to be an underwater cavern. If the cavern is explored, it reveals a treasure of the Director's choice guarded by a [revenant](../Browse/Ancestries/Revenant.md) knight fulfilling their duty until their captain returns.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
